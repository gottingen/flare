...
if(cuDNN_INCLUDE_DIRS)
  ...
  macro(fly_find_cudnn_libs cudnn_lib_name_infix)
  ...
  fly_find_cudnn_libs("") # gets base cudnn shared library
  if(cuDNN_VERSION_MAJOR VERSION_GREATER 8 OR cuDNN_VERSION_MAJOR VERSION_EQUAL 8)
    fly_find_cudnn_libs("_adv_infer")
    fly_find_cudnn_libs("_adv_train")
    fly_find_cudnn_libs("_cnn_infer")
    fly_find_cudnn_libs("_cnn_train")
    fly_find_cudnn_libs("_ops_infer")
    fly_find_cudnn_libs("_ops_train")
  endif()
endif()
