...
fly_err fly_alloc_device_v2(void **ptr, const dim_t bytes) {
    CALL(fly_alloc_device_v2, ptr, bytes);
}
...
fly_err fly_free_device_v2(void *ptr) { CALL(fly_free_device_v2, ptr); }
