...
/**
 * An internal wrapper around an fly_memory_manager which calls function pointers
 * on a fly_memory_manager via calls to a MemoryManagerBase
 */
class MemoryManagerFunctionWrapper final
    : public flare::common::MemoryManagerBase {
    fly_memory_manager handle_;

   public:
    MemoryManagerFunctionWrapper(fly_memory_manager handle);
...
struct MemoryManager {
    ...
    fly_memory_manager_initialize_fn initialize_fn;
    fly_memory_manager_shutdown_fn shutdown_fn;
    fly_memory_manager_alloc_fn alloc_fn;
    fly_memory_manager_allocated_fn allocated_fn;
    fly_memory_manager_unlock_fn unlock_fn;
    fly_memory_manager_print_info_fn print_info_fn;
    fly_memory_manager_user_lock_fn user_lock_fn;
    fly_memory_manager_user_unlock_fn user_unlock_fn;
    fly_memory_manager_is_user_locked_fn is_user_locked_fn;
    fly_memory_manager_get_memory_pressure_fn get_memory_pressure_fn;
    fly_memory_manager_signal_memory_cleanup_fn signal_memory_cleanup_fn;
    fly_memory_manager_add_memory_management_fn add_memory_management_fn;
    fly_memory_manager_remove_memory_management_fn remove_memory_management_fn;
    fly_memory_manager_jit_tree_exceeds_memory_pressure_fn
        jit_tree_exceeds_memory_pressure_fn;
    // A generic payload on which data can be stored on the fly_memory_manager
