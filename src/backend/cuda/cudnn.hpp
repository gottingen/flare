...
// clang-format off
DEFINE_HANDLER(cudnnHandle_t, flare::cuda::getCudnnPlugin().cudnnCreate, flare::cuda::getCudnnPlugin().cudnnDestroy);

DEFINE_HANDLER(cudnnTensorDescriptor_t, flare::cuda::getCudnnPlugin().cudnnCreateTensorDescriptor, flare::cuda::getCudnnPlugin().cudnnDestroyTensorDescriptor);

DEFINE_HANDLER(cudnnFilterDescriptor_t, flare::cuda::getCudnnPlugin().cudnnCreateFilterDescriptor, flare::cuda::getCudnnPlugin().cudnnDestroyFilterDescriptor);

DEFINE_HANDLER(cudnnConvolutionDescriptor_t, flare::cuda::getCudnnPlugin().cudnnCreateConvolutionDescriptor, flare::cuda::getCudnnPlugin().cudnnDestroyConvolutionDescriptor);
// clang-format on
