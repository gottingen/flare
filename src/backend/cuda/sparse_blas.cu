...
cusparseOperation_t toCusparseTranspose(fly_mat_prop opt) {
    cusparseOperation_t out = CUSPARSE_OPERATION_NON_TRANSPOSE;
    switch (opt) {
        case FLY_MAT_NONE: out = CUSPARSE_OPERATION_NON_TRANSPOSE; break;
        case FLY_MAT_TRANS: out = CUSPARSE_OPERATION_TRANSPOSE; break;
        case FLY_MAT_CTRANS: out = CUSPARSE_OPERATION_CONJUGATE_TRANSPOSE; break;
...
#define FLY_CUSPARSE_SPMV_CSR_ALG1 CUSPARSE_CSRMV_ALG1
#define FLY_CUSPARSE_SPMV_ALG_DEFAULT CUSPARSE_MV_ALG_DEFAULT
#define FLY_CUSPARSE_SPMM_CSR_ALG1 CUSPARSE_CSRMM_ALG1
#define FLY_CUSPARSE_SPMM_CSR_ALG1 CUSPARSE_CSRMM_ALG1
#elif CUSPARSE_VERSION < 11400
#define FLY_CUSPARSE_SPMV_CSR_ALG1 CUSPARSE_CSRMV_ALG1
#define FLY_CUSPARSE_SPMV_ALG_DEFAULT CUSPARSE_MV_ALG_DEFAULT
#define FLY_CUSPARSE_SPMM_CSR_ALG1 CUSPARSE_SPMM_CSR_ALG1
#define FLY_CUSPARSE_SPMM_CSR_ALG1 CUSPARSE_SPMM_CSR_ALG1
#else
#define FLY_CUSPARSE_SPMV_CSR_ALG1 CUSPARSE_SPMV_CSR_ALG1
#define FLY_CUSPARSE_SPMV_ALG_DEFAULT CUSPARSE_SPMV_ALG_DEFAULT
#define FLY_CUSPARSE_SPMM_CSR_ALG1 CUSPARSE_SPMM_CSR_ALG1
#define FLY_CUSPARSE_SPMM_CSR_ALG1 CUSPARSE_SPMM_CSR_ALG1
#endif
...
size_t spmvBufferSize(cusparseOperation_t opA, const T *alpha,
    ...
    CUSPARSE_CHECK(_.cusparseSpMV_bufferSize(
        ...
        FLY_CUSPARSE_SPMV_CSR_ALG1, &retVal));
    return retVal;
}
...
void spmv(cusparseOperation_t opA, const T *alpha,
    ...
    CUSPARSE_CHECK(_.cusparseSpMV(sparseHandle(), opA, alpha, matA, vecX, beta,
                                  ...
                                  FLY_CUSPARSE_SPMV_ALG_DEFAULT, buffer));
}
...
size_t spmmBufferSize(cusparseOperation_t opA, cusparseOperation_t opB,
    ...
    CUSPARSE_CHECK(_.cusparseSpMM_bufferSize(
        ...
        getComputeType<T>(), FLY_CUSPARSE_SPMM_CSR_ALG1, &retVal));
    return retVal;
}
...
void spmm(cusparseOperation_t opA, cusparseOperation_t opB, const T *alpha,
    ...
    CUSPARSE_CHECK(_.cusparseSpMM(sparseHandle(), opA, opB, alpha, matA, matB,
                                  ...
                                  FLY_CUSPARSE_SPMM_CSR_ALG1, buffer));
}
