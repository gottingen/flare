...
// template<>
//__device__ void boxMullerTransform<flare::common::half, __half>(
//    flare::common::half *const out1, flare::common::half *const out2,
...
static void writeOut128Bytes(flare::common::half *out, const uint &index,
                             const uint groupSz, const uint &r1, const uint &r2,
                             const uint &r3, const uint &r4) {
...
static void boxMullerWriteOut128Bytes(flare::common::half *out,
...
static void partialWriteOut128Bytes(flare::common::half *out,
                                    const uint &index, const uint groupSz,
                                    const uint &r1, const uint &r2,
                                    const uint &r3, const uint &r4,
                                    const uint &elements) {
...
// Normalized writes with boundary checking
static void partialBoxMullerWriteOut128Bytes(flare::common::half *out,
                                             const uint &index,
                                             const uint groupSz, const uint &r1,
                                             const uint &r2, const uint &r3,
                                             const uint &r4,
                                             const uint &elements) {
    //    flare::common::half n[8];
