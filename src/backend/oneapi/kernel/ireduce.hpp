...
template<typename T, fly_op_t op, uint dim, bool is_first, uint DIMY>
...
template<typename T, fly_op_t op, int dim, bool is_first>
...
template<typename T, fly_op_t op, int dim>
...
template<typename T, fly_op_t op, bool is_first, uint DIMX>
...
template<typename T, fly_op_t op, bool is_first>
