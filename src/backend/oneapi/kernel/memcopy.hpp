...
template<>
inline char convertType<compute_t<flare::common::half>, char>(
    compute_t<flare::common::half> value) {
    return (char)((short)value);
}

template<>
inline compute_t<flare::common::half>
convertType<char, compute_t<flare::common::half>>(char value) {
    return compute_t<flare::common::half>(value);
}

template<>
unsigned char inline convertType<compute_t<flare::common::half>,
                                 unsigned char>(
    compute_t<flare::common::half> value) {
...
template<>
inline compute_t<flare::common::half>
convertType<unsigned char, compute_t<flare::common::half>>(
    unsigned char value) {
    return compute_t<flare::common::half>(value);
}
...
OTHER_SPECIALIZATIONS(flare::common::half)
