...
template<typename T, fly_interp_type method>
struct resize_op {
    void operator()(T *outPtr, const T *inPtr, const fly::dim4 &odims,
                    const fly::dim4 &idims, const fly::dim4 &ostrides,
                    const fly::dim4 &istrides, const dim_t x, const dim_t y) {
        UNUSED(outPtr);
        UNUSED(inPtr);
        UNUSED(odims);
        UNUSED(idims);
...
template<typename T>
struct resize_op<T, FLY_INTERP_NEAREST> {
    void operator()(T *outPtr, const T *inPtr, const fly::dim4 &odims,
                    const fly::dim4 &idims, const fly::dim4 &ostrides,
                    const fly::dim4 &istrides, const dim_t x, const dim_t y) {
        // Compute Indices
...
template<typename T>
struct resize_op<T, FLY_INTERP_BILINEAR> {
    void operator()(T *outPtr, const T *inPtr, const fly::dim4 &odims,
                    const fly::dim4 &idims, const fly::dim4 &ostrides,
                    const fly::dim4 &istrides, const dim_t x, const dim_t y) {
        // Compute Indices
...
template<typename T>
struct resize_op<T, FLY_INTERP_LOWER> {
    void operator()(T *outPtr, const T *inPtr, const fly::dim4 &odims,
                    const fly::dim4 &idims, const fly::dim4 &ostrides,
                    const fly::dim4 &istrides, const dim_t x, const dim_t y) {
        // Compute Indices
