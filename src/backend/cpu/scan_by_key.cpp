...
INSTANTIATE_SCAN_BY_KEY_ALL_OP(fly_add_t)
INSTANTIATE_SCAN_BY_KEY_ALL_OP(fly_mul_t)
INSTANTIATE_SCAN_BY_KEY_ALL_OP(fly_min_t)
INSTANTIATE_SCAN_BY_KEY_ALL_OP(fly_max_t)
}  // namespace cpu
}  // namespace flare
