...
unsigned fast(Array<float> &x_out, Array<float> &y_out, Array<float> &score_out,
    ...
    Array<float> x_total     = createEmptyArray<float>(fly::dim4());
    Array<float> y_total     = createEmptyArray<float>(fly::dim4());
    Array<float> score_total = createEmptyArray<float>(fly::dim4());
