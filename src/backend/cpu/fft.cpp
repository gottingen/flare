...
void fft_inplace(Array<T> &in, const int rank, const bool direction) {
    auto func = [=](Param<T> in, const fly::dim4 iDataDims) {
...
Array<Tc> fft_r2c(const Array<Tr> &in, const int rank) {
    ...
    auto func = [=](Param<Tc> out, const fly::dim4 oDataDims, CParam<Tr> in,
                    const fly::dim4 iDataDims) {
...
Array<Tr> fft_c2r(const Array<Tc> &in, const dim4 &odims, const int rank) {
    ...
    auto func = [=](Param<Tr> out, const fly::dim4 oDataDims, CParam<Tc> in,
                    const fly::dim4 iDataDims, const fly::dim4 odims) {
