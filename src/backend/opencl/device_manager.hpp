...
#ifndef FLY_OPENCL_MEM_DEBUG
#define FLY_OPENCL_MEM_DEBUG 0
#endif
...
class DeviceManager {
    friend flare::common::MemoryManagerBase& memoryManager();

    friend void setMemoryManager(
        std::unique_ptr<flare::common::MemoryManagerBase> mgr);
    ...
    friend flare::common::MemoryManagerBase& pinnedMemoryManager();
    ...
    friend flycl::platform getActivePlatformVendor();
   ...
   private:
    ...
    std::vector<std::pair<std::unique_ptr<cl::Platform>, flycl::platform>>
        mPlatforms;
