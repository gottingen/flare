...
static inline bool operator==(flare::opencl::cfloat lhs,
                              flare::opencl::cfloat rhs) noexcept {
...
static inline bool operator==(flare::opencl::cdouble lhs,
                              flare::opencl::cdouble rhs) noexcept {
    return (lhs.s[0] == rhs.s[0]) && (lhs.s[1] == rhs.s[1]);
}
static inline bool operator!=(flare::opencl::cdouble lhs,
                              flare::opencl::cdouble rhs) noexcept {
