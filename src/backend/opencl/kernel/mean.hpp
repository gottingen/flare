...
void meanDimLauncher(Param out, Param owt, Param in, Param inWeight,
    ...
    common::Transform<uint, Tw, fly_add_t> transform_weight;
    ...
    std::vector<std::string> options = {
        ...
        DefineKeyValue(init_To, toNumStr(common::Binary<To, fly_add_t>::init())),
...
To meanAll(Param in) {
    ...
    if (in_elements > 4096 || !is_linear) {
        ...
        common::Transform<Ti, compute_t<To>, fly_add_t> transform;
        common::Transform<uint, compute_t<Tw>, fly_add_t> transform_weight;
