...
auto genCompileOptions(const int order, const int xdim, const int ydim = -1) {
    constexpr bool isComplex =
        static_cast<fly_dtype>(dtype_traits<Ty>::fly_type) == c32 ||
        static_cast<fly_dtype>(dtype_traits<Ty>::fly_type) == c64;
...
void approx1(Param yo, const Param yi, const Param xo, const int xdim,
             ...
             const fly_interp_type method, const int order) {
...
void approx2(Param zo, const Param zi, const Param xo, const int xdim,
             ...
             const float offGrid, const fly_interp_type method,
             const int order) {
    using cl::EnqueueArgs;
    using cl::NDRange;
    using std::string;
