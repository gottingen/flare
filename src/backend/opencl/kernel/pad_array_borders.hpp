...
void padBorders(Param out, const Param in, dim4 const& lBPadding,
                const fly_border_type borderType) {
    ...
    vector<string> compileOpts = {
        ...
        DefineKeyValue(FLY_BORDER_TYPE, (int)borderType),
        DefineKeyValue(FLY_PAD_SYM, (int)FLY_PAD_SYM),
        DefineKeyValue(FLY_PAD_PERIODIC, (int)FLY_PAD_PERIODIC),
        DefineKeyValue(FLY_PAD_CLAMP_TO_EDGE, (int)FLY_PAD_CLAMP_TO_EDGE),
    };
