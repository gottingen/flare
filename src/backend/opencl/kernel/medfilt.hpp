...
void medfilt1(Param out, const Param in, const unsigned w_wid,
    ...
    std::array<std::string, 7> options = {
        ...
        DefineKeyValue(FLY_PAD_ZERO, static_cast<int>(FLY_PAD_ZERO)),
        DefineKeyValue(FLY_PAD_SYM, static_cast<int>(FLY_PAD_SYM)),
...
template<typename T>
void medfilt2(Param out, const Param in, const fly_border_type pad,
