...
template<typename T>
static Kernel getRandomEngineKernel(const fly_random_engine_type type,
                                    const int kerIdx,
    ...
    switch (type) {
        ...
        case FLY_RANDOM_ENGINE_THREEFRY_2X32_16:
            ...
            break;
        case FLY_RANDOM_ENGINE_MERSENNE_GP11213:
    ...
    if (type != FLY_RANDOM_ENGINE_MERSENNE_GP11213) {
...
void randomDistribution(cl::Buffer out, const size_t elements, cl::Buffer state,
    ...
    auto randomEngineOp = getRandomEngineKernel<T>(
        FLY_RANDOM_ENGINE_MERSENNE_GP11213, kerIdx, elementsPerBlock);
