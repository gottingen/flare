...
template<typename T>
Array<T> createStridedArray(const fly::dim4 &dims, const fly::dim4 &strides,
...
class Array {
    ...
    explicit Array(const fly::dim4 &dims, const T *const in_data);
    explicit Array(const fly::dim4 &dims, cl_mem mem, size_t offset, bool copy);
...
#undef INFO_IS_FUNC
   ...
   public:
    ...
    friend Array<T> createDeviceDataArray<T>(const fly::dim4 &dims, void *data,
                                             bool copy);
    friend Array<T> createStridedArray<T>(const fly::dim4 &dims,
                                          const fly::dim4 &strides, dim_t offset,
