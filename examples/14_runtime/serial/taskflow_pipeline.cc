...
void make_taskflow1(flare::rt::Taskflow& tf) {
...
void make_taskflow2(flare::rt::Taskflow& tf) {
...
void make_taskflow3(flare::rt::Taskflow& tf) {
...
int main() {
  ...
  flare::rt::Taskflow taskflow("taskflow processing pipeline");
  ...
  std::array<flare::rt::Taskflow, num_pipes> taskflows;
