...
using mesh_type = flare::View<double***, flare::LayoutRight>;
...
using xz_plane_type   = flare::View<double**, flare::LayoutStride>;
using yz_plane_type   = flare::View<double**, flare::LayoutRight>;
using xy_plane_type   = flare::View<double**, flare::LayoutStride>;
using inner_mesh_type = flare::View<double***, flare::LayoutStride>;
