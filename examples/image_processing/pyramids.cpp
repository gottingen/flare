...
void pyramids_demo() {
    fly::Window wnd_rgb("Image Pyramids - RGB Images");
    fly::Window wnd_gray("Image Pyramids - Grayscale Images");
    ...
    array img_gray = colorSpace(img_rgb, FLY_GRAY, FLY_RGB);
...
int main(int argc, char** argv) {
    ...
    try {
        ...
        fly::info();
        printf("** Flare Image Pyramids Demo **\n\n");
        pyramids_demo();
