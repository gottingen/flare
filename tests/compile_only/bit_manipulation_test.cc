...
template<class UInt>
constexpr auto test_rotl(UInt x) -> decltype(flare::rotl(x, 0)) {
    using flare::rotl;
...
template<class UInt>
constexpr auto test_rotr(UInt x) -> decltype(flare::rotr(x, 0)) {
    using flare::rotr;
...
template<class UInt>
constexpr auto test_countl_zero(UInt x) -> decltype(flare::countl_zero(x)) {
    using flare::countl_zero;
...
template<class UInt>
constexpr auto test_countl_one(UInt x) -> decltype(flare::countl_one(x)) {
    using flare::countl_one;
...
template<class UInt>
constexpr auto test_countr_zero(UInt x) -> decltype(flare::countr_zero(x)) {
    using flare::countr_zero;
...
template<class UInt>
constexpr auto test_countr_one(UInt x) -> decltype(flare::countr_one(x)) {
    using flare::countr_one;
...
template<class UInt>
constexpr auto test_popcount(UInt x) -> decltype(flare::popcount(x)) {
    using flare::popcount;
...
-> decltype(flare::has_single_bit(x)) {
    using flare::has_single_bit;
...
template<class UInt>
constexpr auto test_bit_floor(UInt x) -> decltype(flare::bit_floor(x)) {
    using flare::bit_floor;
...
template<class UInt>
constexpr auto test_bit_ceil(UInt x) -> decltype(flare::bit_ceil(x)) {
    using flare::bit_ceil;
...
template<class UInt>
constexpr auto test_bit_width(UInt x) -> decltype(flare::bit_width(x)) {
    using flare::bit_width;
...
template<class T>
constexpr auto test_byteswap(T x) -> decltype(flare::byteswap(x)) {
    using flare::byteswap;
...
constexpr auto test_bit_cast() -> typename std::is_same<
        decltype(flare::bit_cast<To>(std::declval<From const &>())),
        To>::value_type {
    static_assert(
            std::is_same_v<
                    decltype(flare::bit_cast<To>(std::declval<From const &>())), To>);
    return true;
}
