...
void cuda_for_each_index() {
  ...
  for(int n=0; n<=1234567; n = (n<=100) ? n+1 : n*2 + 1) {
    ...
    taskflow.emplace([n](){
      ...
      flare::rt::cuda_for_each_index(policy,
