...
namespace Test {
    ...
    using Matrix2D = flare::View<ValueType **, MemSpace>;
    using Matrix3D = flare::View<ValueType ***, MemSpace>;
    using Vector = flare::View<ValueType *, MemSpace>;
    ...
    TEST_CASE("cuda, reduceRangePolicyViewSizeLimit") {
        detail::ReduceViewSizeLimitTester reduceViewSizeLimitTester;

        reduceViewSizeLimitTester.run_test_range();
    }

    TEST_CASE("cuda, reduceMDRangePolicyViewSizeLimit") {
        detail::ReduceViewSizeLimitTester reduceViewSizeLimitTester;
