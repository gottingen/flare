...
namespace Test {
    ...
    size_t allocation_count(const flare::Tensor<T, P...> &tensor) {
        ...
        const int memory_span_layout =
                flare::Tensor<int *, flare::LayoutRight>::required_allocation_size(
...
/*--------------------------------------------------------------------------*/
    ...
    struct TestTensorOperator {
        ...
        using tensor_type = flare::Tensor<T *[D], execution_space>;

        const tensor_type v1;
        const tensor_type v2;

        TestTensorOperator() : v1("v1", N), v2("v2", N) {}
...
/*--------------------------------------------------------------------------*/
    ...
    template<class DataType, class DeviceType>
    struct TestTensorOperator_LeftAndRight<DataType, DeviceType, 8> {
        using execution_space = typename DeviceType::execution_space;
    ...
    struct TestTensorMirror {
        ...
        void static test_mirror_view() {
            ...
            auto a_d = flare::create_mirror_tensor(DeviceType(), a_h);
        ...
        void static test_mirror_copy() {
            flare::Tensor<double *, Layout, flare::HostSpace> a_org("A", 10);
            a_org(5) = 42.0;
            flare::Tensor<double *, Layout, flare::HostSpace, MemoryTraits> a_h = a_org;
        ...
        static void test_allocated() {
            ...
            d1 = dynamic_tensor("d1", N);
            dynamic_tensor d2(d1);
            dynamic_tensor d3("d3", N);
            ...
            u1 = unmanaged_tensor(d1.data(), N);
            unmanaged_tensor u2(u1);
            unmanaged_tensor u3(d1.data(), N);
        ...
        void static test_mirror_no_initialize() {
            ...
            auto a_d = flare::create_mirror_tensor(flare::WithoutInitializing,
                                                 DeviceType(), a_h);
...
/*--------------------------------------------------------------------------*/
    ...
    public:
        ...
        using DTensor4_unmanaged =
                flare::Tensor<T ****, device, flare::MemoryUnmanaged>;
        using host = typename DTensor0::host_mirror_space;

        static void run_test_tensor_operator_a() {
            {
                TestTensorOperator<T, device> f;
                flare::parallel_for(int(N0), f);
                flare::fence();
            }
            TestTensorOperator_LeftAndRight<int[2][3][4][2][3][4], device> f6;
            f6.testit();
            TestTensorOperator_LeftAndRight<int[2][3][4][2][3], device> f5;
            f5.testit();
            TestTensorOperator_LeftAndRight<int[2][3][4][2], device> f4;
            f4.testit();
            TestTensorOperator_LeftAndRight<int[2][3][4], device> f3;
            f3.testit();
            TestTensorOperator_LeftAndRight<int[2][3], device> f2;
            f2.testit();
            TestTensorOperator_LeftAndRight<int[2], device> f1;
            f1.testit();
        }

        static void run_test_tensor_operator_b() {
            TestTensorOperator_LeftAndRight<int[2][3][4][2][3][4][2], device> f7;
            f7.testit();
        }

        static void run_test_tensor_operator_c() {
            TestTensorOperator_LeftAndRight<int[2][3][4][2][3][4][2][3], device> f8;
            f8.testit();
        }

        static void run_test_mirror() {
            using tensor_type = flare::Tensor<int, host>;
            using mirror_type = typename tensor_type::HostMirror;

            static_assert(std::is_same<typename tensor_type::memory_space,
            ...
            TestTensorMirror<flare::LayoutLeft, device>::testit();
            TestTensorMirror<flare::LayoutRight, device>::testit();
        }
        ...
        static void run_test_contruction_from_layout() {
            using hTensor0 = typename DTensor0::HostMirror;
            using hTensor1 = typename DTensor1::HostMirror;
            using hTensor2 = typename DTensor2::HostMirror;
            using hTensor3 = typename DTensor3::HostMirror;
            using hTensor4 = typename DTensor4::HostMirror;

            hTensor0 hv_0("DTensor0::HostMirror");
            hTensor1 hv_1("DTensor1::HostMirror", N0);
            hTensor2 hv_2("DTensor2::HostMirror", N0);
            hTensor3 hv_3("DTensor3::HostMirror", N0);
            hTensor4 hv_4("DTensor4::HostMirror", N0);

            DTensor0 dv_0_1(nullptr, 0);
            DTensor0 dv_0_2(hv_0.label(), hv_0.layout());

            DTensor1 dv_1_1(nullptr, 0);
            DTensor1 dv_1_2(hv_1.label(), hv_1.layout());

            DTensor2 dv_2_1(nullptr, 0);
            DTensor2 dv_2_2(hv_2.label(), hv_2.layout());

            DTensor3 dv_3_1(nullptr, 0);
            DTensor3 dv_3_2(hv_3.label(), hv_3.layout());

            DTensor4 dv_4_1(nullptr, 0);
            DTensor4 dv_4_2(hv_4.label(), hv_4.layout());
        }

        static void run_test_contruction_from_layout_2() {
            using DTensor3_0 = flare::Tensor<T ***, device>;
            using DTensor3_1 = flare::Tensor<T **[N1], device>;
            using DTensor3_2 = flare::Tensor<T *[N1][N2], device>;
            using DTensor3_3 = flare::Tensor<T[N0][N1][N2], device>;

            DTensor3_0 v_0("v_0", N0, N1, N2);
            DTensor3_1 v_1("v_1", N0, N1);
            DTensor3_2 v_2("v_2", N0);
            DTensor3_3 v_3("v_2");

            DTensor3_1 v_1_a("v_1", N0, N1, N2);
            DTensor3_2 v_2_a("v_2", N0, N1, N2);
            DTensor3_3 v_3_a("v_2", N0, N1, N2);

            {
                DTensor3_0 dv_1(v_0.label(), v_0.layout());
                DTensor3_0 dv_2(v_1.label(), v_1.layout());
                DTensor3_0 dv_3(v_2.label(), v_2.layout());
                DTensor3_0 dv_4(v_3.label(), v_3.layout());
                DTensor3_0 dv_5(v_1_a.label(), v_1_a.layout());
                DTensor3_0 dv_6(v_2_a.label(), v_2_a.layout());
                DTensor3_0 dv_7(v_3_a.label(), v_3_a.layout());
            }

            {
                DTensor3_1 dv_1(v_0.label(), v_0.layout());
                DTensor3_1 dv_2(v_1.label(), v_1.layout());
                DTensor3_1 dv_3(v_2.label(), v_2.layout());
                DTensor3_1 dv_4(v_3.label(), v_3.layout());
                DTensor3_1 dv_5(v_1_a.label(), v_1_a.layout());
                DTensor3_1 dv_6(v_2_a.label(), v_2_a.layout());
                DTensor3_1 dv_7(v_3_a.label(), v_3_a.layout());
            }

            {
                DTensor3_2 dv_1(v_0.label(), v_0.layout());
                DTensor3_2 dv_2(v_1.label(), v_1.layout());
                DTensor3_2 dv_3(v_2.label(), v_2.layout());
                DTensor3_2 dv_4(v_3.label(), v_3.layout());
                DTensor3_2 dv_5(v_1_a.label(), v_1_a.layout());
                DTensor3_2 dv_6(v_2_a.label(), v_2_a.layout());
                DTensor3_2 dv_7(v_3_a.label(), v_3_a.layout());
            }

            {
                DTensor3_3 dv_1(v_0.label(), v_0.layout());
                DTensor3_3 dv_2(v_1.label(), v_1.layout());
                DTensor3_3 dv_3(v_2.label(), v_2.layout());
                DTensor3_3 dv_4(v_3.label(), v_3.layout());
                DTensor3_3 dv_5(v_1_a.label(), v_1_a.layout());
                DTensor3_3 dv_6(v_2_a.label(), v_2_a.layout());
                DTensor3_3 dv_7(v_3_a.label(), v_3_a.layout());
            }
        }
...
#pragma GCC diagnostic pop
#endif
            REQUIRE_EQ(dx.use_count(), 1);
            dx = reinterpret_cast<typename DTensor4::uniform_type &>(
                    dx);  // conversion assignment operator
            REQUIRE_EQ(dx.use_count(), 1);

            DTensor4_unmanaged unmanaged_from_ptr_dx = DTensor4_unmanaged(
                    dx.data(), dx.extent(0), dx.extent(1), dx.extent(2), dx.extent(3));

            {
                // Destruction of this tensor should be harmless.

                const_DTensor4 unmanaged_from_ptr_const_dx(dx.data(), dx.extent(0));
            }

            const_DTensor4 const_dx = dx;
            REQUIRE_EQ(dx.use_count(), 2);

            {
                const_DTensor4 const_dx2;
                const_dx2 = const_dx;
                ...
                const_DTensor4 const_dx3(dx);
                REQUIRE_EQ(dx.use_count(), 3);

                DTensor4_unmanaged dx4_unmanaged(dx);
                REQUIRE_EQ(dx.use_count(), 3);
            }
            ...
            // Testing with asynchronous deep copy with respect to device
            {
                ...
                flare::deep_copy(typename hTensor4::execution_space(), dx, hx);
                flare::deep_copy(typename hTensor4::execution_space(), dy, dx);
                flare::deep_copy(typename hTensor4::execution_space(), hy, dy);
                typename hTensor4::execution_space().fence();
                ...
                flare::deep_copy(typename hTensor4::execution_space(), dx, T(0));
                flare::deep_copy(typename hTensor4::execution_space(), hx, dx);
                typename hTensor4::execution_space().fence();
            ...
            // Testing with asynchronous deep copy with respect to host.
            {
                ...
                flare::deep_copy(typename DTensor4::execution_space(), dx, hx);
                flare::deep_copy(typename DTensor4::execution_space(), dy, dx);
                flare::deep_copy(typename DTensor4::execution_space(), hy, dy);
                typename DTensor4::execution_space().fence();
                ...
                flare::deep_copy(typename DTensor4::execution_space(), dx, T(0));
                flare::deep_copy(typename DTensor4::execution_space(), hx, dx);
                typename DTensor4::execution_space().fence();
        ...
        static void run_test_deep_copy_empty() {
            ...
            {
                flare::Tensor<double *, flare::LayoutLeft> dll("dll", 10);
                flare::Tensor<double *, flare::LayoutRight, flare::HostSpace> hlr("hlr",
                                                                                10);
                flare::deep_copy(dll, hlr);
                flare::deep_copy(hlr, dll);
            }

            // Check Deep Copy of two empty 1D tensors
            {
                flare::Tensor<double *> d;
                flare::Tensor<double *, flare::HostSpace> h;
                flare::deep_copy(d, h);
                flare::deep_copy(h, d);
            }

            // Check Deep Copy of two empty 2D tensors
            {
                flare::Tensor<double *[3], flare::LayoutRight> d;
                flare::Tensor<double *[3], flare::LayoutRight, flare::HostSpace> h;
                flare::deep_copy(d, h);
                flare::deep_copy(h, d);
            }
        }
        ...
        static void check_auto_conversion_to_const(
                const flare::Tensor<const DataType, device> &arg_const,
                const flare::Tensor<DataType, device> &arg) {
            REQUIRE_EQ(arg_const, arg);
        }

        static void run_test_const() {
            using typeX = flare::Tensor<DataType, device>;
            using const_typeX = flare::Tensor<const DataType, device>;
            using const_typeR =
                    flare::Tensor<const DataType, device, flare::MemoryRandomAccess>;
        ...
        static void run_test_subtensor() {
            using sTensor = flare::Tensor<const T, device>;
            ...
            sTensor s0 = d0;
            sTensor s1 = flare::subtensor(d1, 1);
            sTensor s2 = flare::subtensor(d2, 1, 1);
            sTensor s3 = flare::subtensor(d3, 1, 1, 1);
            sTensor s4 = flare::subtensor(d4, 1, 1, 1, 1);
        }
        ...
        static void run_test_vector() {
            ...
            using vector_type = flare::Tensor<T *, flare::LayoutLeft, host>;
            using multivector_type = flare::Tensor<T **, flare::LayoutLeft, host>;

            using vector_right_type = flare::Tensor<T *, flare::LayoutRight, host>;
            using multivector_right_type =
                    flare::Tensor<T **, flare::LayoutRight, host>;

            using const_vector_right_type =
                    flare::Tensor<const T *, flare::LayoutRight, host>;
            using const_vector_type = flare::Tensor<const T *, flare::LayoutLeft, host>;
            using const_multivector_type =
                    flare::Tensor<const T **, flare::LayoutLeft, host>;

            multivector_type mv = multivector_type("mv", Length, Count);
            multivector_right_type mv_right =
                    multivector_right_type("mv", Length, Count);

            vector_type v1 = flare::subtensor(mv, flare::ALL(), 0);
            vector_type v2 = flare::subtensor(mv, flare::ALL(), 1);
            vector_type v3 = flare::subtensor(mv, flare::ALL(), 2);

            vector_type rv1 = flare::subtensor(mv_right, 0, flare::ALL());
            vector_type rv2 = flare::subtensor(mv_right, 1, flare::ALL());
            vector_type rv3 = flare::subtensor(mv_right, 2, flare::ALL());

            multivector_type mv1 =
                    flare::subtensor(mv, std::make_pair(1, 998), std::make_pair(2, 5));

            multivector_right_type mvr1 =
                    flare::subtensor(mv_right, std::make_pair(1, 998), std::make_pair(2, 5));

            const_vector_type cv1 = flare::subtensor(mv, flare::ALL(), 0);
            const_vector_type cv2 = flare::subtensor(mv, flare::ALL(), 1);
            const_vector_type cv3 = flare::subtensor(mv, flare::ALL(), 2);

            vector_right_type vr1 = flare::subtensor(mv, flare::ALL(), 0);
            vector_right_type vr2 = flare::subtensor(mv, flare::ALL(), 1);
            vector_right_type vr3 = flare::subtensor(mv, flare::ALL(), 2);

            const_vector_right_type cvr1 = flare::subtensor(mv, flare::ALL(), 0);
            const_vector_right_type cvr2 = flare::subtensor(mv, flare::ALL(), 1);
            const_vector_right_type cvr3 = flare::subtensor(mv, flare::ALL(), 2);
...
// This test doesn't behave as expected on Windows with CUDA
            ...
            if (std::is_same<typename DTensor1::memory_space,
                             flare::CudaUVMSpace>::value)
              return;
#endif
            auto alloc_size = std::numeric_limits<size_t>::max() - 42;
            try {
                auto should_always_fail = DTensor1("hello_world_failure", alloc_size);
