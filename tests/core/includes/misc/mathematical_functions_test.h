...
template<>
struct math_unary_function_return_type<float> {
    using type = float;
};
template<>
struct math_unary_function_return_type<double> {
    using type = double;
};
...
// Integral types
template<>
struct math_unary_function_return_type<bool> {
    using type = double;
};
template<>
struct math_unary_function_return_type<short> {
    using type = double;
};
template<>
struct math_unary_function_return_type<unsigned short> {
    using type = double;
};
template<>
struct math_unary_function_return_type<int> {
    using type = double;
};
template<>
struct math_unary_function_return_type<unsigned int> {
    using type = double;
};
template<>
struct math_unary_function_return_type<long> {
    using type = double;
};
template<>
struct math_unary_function_return_type<unsigned long> {
    using type = double;
};
template<>
struct math_unary_function_return_type<long long> {
    using type = double;
};
template<>
struct math_unary_function_return_type<unsigned long long> {
    using type = double;
};
template<class T>
...
#endif // defined(FLARE_BHALF_T_IS_FLOAT) && !FLARE_BHALF_T_IS_FLOAT
template<>
struct math_binary_function_return_type<float, float> {
    using type = float;
};
template<>
struct math_binary_function_return_type<float, double> {
    using type = double;
};
template<>
struct math_binary_function_return_type<float, bool> {
    using type = double;
};
template<>
struct math_binary_function_return_type<float, short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<float, int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<float, long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<float, long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<float, unsigned short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<float, unsigned int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<float, unsigned long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<float, unsigned long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<double, float> {
    using type = double;
};
template<>
struct math_binary_function_return_type<double, double> {
    using type = double;
};
template<>
struct math_binary_function_return_type<double, bool> {
    using type = double;
};
template<>
struct math_binary_function_return_type<double, short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<double, int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<double, long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<double, long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<double, unsigned short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<double, unsigned int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<double, unsigned long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<double, unsigned long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<short, float> {
    using type = double;
};
template<>
struct math_binary_function_return_type<short, double> {
    using type = double;
};
template<>
struct math_binary_function_return_type<short, bool> {
    using type = double;
};
template<>
struct math_binary_function_return_type<short, short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<short, int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<short, long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<short, long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<short, unsigned short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<short, unsigned int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<short, unsigned long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<short, unsigned long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<int, float> {
    using type = double;
};
template<>
struct math_binary_function_return_type<int, double> {
    using type = double;
};
template<>
struct math_binary_function_return_type<int, bool> {
    using type = double;
};
template<>
struct math_binary_function_return_type<int, short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<int, int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<int, long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<int, long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<int, unsigned short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<int, unsigned int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<int, unsigned long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<int, unsigned long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long, float> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long, double> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long, bool> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long, short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long, int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long, long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long, long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long, unsigned short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long, unsigned int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long, unsigned long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long, unsigned long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long long, float> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long long, double> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long long, bool> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long long, short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long long, int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long long, long> {
...
template<>
struct math_binary_function_return_type<long long, long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long long, unsigned short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long long, unsigned int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long long, unsigned long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<long long, unsigned long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned short, float> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned short, double> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned short, bool> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned short, short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned short, int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned short, long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned short, long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned short, unsigned short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned short, unsigned int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned short, unsigned long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned short, unsigned long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned int, float> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned int, double> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned int, bool> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned int, short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned int, int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned int, long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned int, long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned int, unsigned short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned int, unsigned int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned int, unsigned long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned int, unsigned long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long, float> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long, double> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long, bool> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long, short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long, int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long, long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long, long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long, unsigned short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long, unsigned int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long, unsigned long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long, unsigned long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long long, float> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long long, double> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long long, bool> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long long, short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long long, int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long long, long> {
...
template<>
struct math_binary_function_return_type<unsigned long long, long long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long long, unsigned short> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long long, unsigned int> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long long, unsigned long> {
    using type = double;
};
template<>
struct math_binary_function_return_type<unsigned long long, unsigned long long> {
    using type = double;
};
#ifdef MATHEMATICAL_FUNCTIONS_HAVE_LONG_DOUBLE_OVERLOADS
...
private:
    template<class T>
    FLARE_FUNCTION double eps(T) const {
        return DBL_EPSILON;
    }
    ...
    template<class T>
    FLARE_FUNCTION std::enable_if_t<std::is_signed<T>::value, T> absolute(
            T val) const {
...
public:
    template<class FPT>
    FLARE_FUNCTION bool compare_near_zero(FPT const &fpv, double ulp) const {
        auto abs_tol = eps(fpv) * ulp;

        bool ar = absolute(fpv) < abs_tol;
        if (!ar) {
            flare::printf("absolute value exceeds tolerance [|%e| > %e]\n",
                          (double) fpv, abs_tol);
        }
    ...
    FLARE_FUNCTION bool compare(Lhs const &lhs, Rhs const &rhs,
                                double ulp) const {
        if (lhs == 0) {
            ...
            if (!ar) {
                flare::printf("relative difference exceeds tolerance [%e > %e]\n",
...
#define DEFINE_UNARY_FUNCTION_EVAL(FUNC, ULP_FACTOR)                    \
  struct MathUnaryFunction_##FUNC {                                     \
    template <typename T>                                               \
    static FLARE_FUNCTION auto eval(T x) {                             \
      static_assert(                                                    \
          std::is_same<decltype(flare::FUNC((T)0)),                    \
    ...
    static FLARE_FUNCTION double ulp_factor() { return ULP_FACTOR; }   \
  };                                                                    \
...
#ifndef FLARE_MATHEMATICAL_FUNCTIONS_SKIP_3
...
#ifndef FLARE_MATHEMATICAL_FUNCTIONS_SKIP_1
...
#ifndef FLARE_MATHEMATICAL_FUNCTIONS_SKIP_2
...
#define DEFINE_BINARY_FUNCTION_EVAL(FUNC, ULP_FACTOR)                          \
  struct MathBinaryFunction_##FUNC {                                           \
    ...
    static FLARE_FUNCTION auto eval(T x, U y) {                               \
      static_assert(                                                           \
          std::is_same<decltype(flare::FUNC((T)0, (U)0)),                     \
                       math_binary_function_return_type_t<T, U>>::value);      \
      return flare::FUNC(x, y);                                               \
    }                                                                          \
    template <typename T, typename U>                                          \
    static auto eval_std(T x, U y) {                                           \
      constexpr bool const x_is_half =                                         \
          (KE::detail::is_float16<T>::value || KE::detail::is_bfloat16<T>::value); \
      constexpr bool const y_is_half =                                         \
          (KE::detail::is_float16<U>::value || KE::detail::is_bfloat16<U>::value); \
...
#define DEFINE_TERNARY_FUNCTION_EVAL(FUNC, ULP_FACTOR)                        \
  struct MathTernaryFunction_##FUNC {                                         \
    ...
    static FLARE_FUNCTION auto eval(T x, U y, V z) {                         \
      static_assert(                                                          \
          std::is_same<decltype(flare::FUNC((T)0, (U)0, (V)0)),              \
                       math_ternary_function_return_type_t<T, U, V>>::value); \
      return flare::FUNC(x, y, z);                                           \
    }                                                                         \
    template <typename T, typename U, typename V>                             \
...
struct TestMathUnaryFunction : FloatingPointComparison {
    ...
    FLARE_FUNCTION void operator()(int i, int &e) const {
        ...
        if (!ar) {
            ++e;
            flare::printf("value at %f which is %f was expected to be %f\n",
...
void do_test_math_unary_function(const Arg (&x)[N]) {
    ...
    if constexpr (!std::is_same_v<Space, flare::DefaultHostExecutionSpace>)
        (void) std::initializer_list<int>{
                (TestMathUnaryFunction<flare::DefaultHostExecutionSpace, Func, Arg, N>(
                        x),
                        0)...};
}
...
void do_test_half_math_unary_function(const Arg (&x)[N]) {
    ...
    if constexpr (!std::is_same_v<Space, flare::DefaultHostExecutionSpace>)
        (void) std::initializer_list<int>{(
                                                  TestMathUnaryFunction<flare::DefaultHostExecutionSpace, Func, Half, N>(
                                                          y),
                                                          0)...};
}
...
struct TestMathBinaryFunction : FloatingPointComparison {
    ...
    FLARE_FUNCTION void operator()(int, int &e) const {
        ...
        if (!ar) {
            ++e;
            flare::printf("value at %f, %f which is %f was expected to be %f\n",
...
struct TestMathTernaryFunction : FloatingPointComparison {
    ...
    FLARE_FUNCTION void operator()(int, int &e) const {
        ...
        if (!ar) {
            ++e;
            flare::printf("value at %f, %f, %f which is %f was expected to be %f\n",
...
TEST_CASE("TEST_CATEGORY, mathematical_functions_trigonometric_functions") {
...
TEST_CASE("TEST_CATEGORY, mathematical_functions_power_functions") {
...
#if !(defined(FLARE_ARCH_POWER8) || defined(FLARE_ARCH_POWER9))
...
TEST_CASE("TEST_CATEGORY, mathematical_functions_fma") {
...
#ifndef FLARE_MATHEMATICAL_FUNCTIONS_SKIP_3
TEST_CASE("TEST_CATEGORY, mathematical_functions_exponential_functions") {
...
#if (defined(FLARE_ARCH_AMD_GFX906) || defined(FLARE_ARCH_AMD_GFX908) || \
     defined(FLARE_ARCH_AMD_GFX90A) || defined(FLARE_ARCH_AMD_GFX942))
...
TEST_CASE("TEST_CATEGORY, mathematical_functions_hyperbolic_functions") {
...
TEST_CASE("TEST_CATEGORY, mathematical_functions_non_standard") {
...
TEST_CASE("TEST_CATEGORY, mathematical_functions_error_and_gamma_functions") {
...
TEST_CASE("TEST_CATEGORY,mathematical_functions_nearest_interger_floating_point_operations") {
...
TEST_CASE("TEST_CATEGORY,mathematical_functions_floating_point_manipulation_functions") {
...
struct TestAbsoluteValueFunction {
  ...
  FLARE_FUNCTION void operator()(int, int& e) const {
    ...
    if (abs(-0.) != 0. || !isinf(abs(-INFINITY)) || !isnan(abs(-NAN))) {
      ++e;
      flare::printf("failed abs(floating_point) special values\n");
    }
...
TEST_CASE("TEST_CATEGORY, mathematical_functions_absolute_value") {
...
TEST_CASE("TEST_CATEGORY, mathematical_functions_floating_point_absolute_value") {
...
struct TestFloatingPointRemainderFunction : FloatingPointComparison {
  ...
  FLARE_FUNCTION void operator()(int, int& e) const {
    ...
    if (!compare(fmod(6.2f, 4.f), 2.2f, 1) &&
      ...
      ++e;
      FLARE_IMPL_DO_NOT_USE_PRINTF("failed fmod(float)\n");
    }
    if (!compare(
        ...
        !compare(
            ...
            -static_cast<KE::half_t>(2.2f), 1)) {
      ++e;
      FLARE_IMPL_DO_NOT_USE_PRINTF("failed fmod(KE::half_t)\n");
    }
    if (!compare(
        ...
        !compare(fmod(static_cast<KE::bhalf_t>(-6.2f),
                 ...
                 -static_cast<KE::bhalf_t>(2.2f), 1)) {
      ++e;
      FLARE_IMPL_DO_NOT_USE_PRINTF("failed fmod(KE::bhalf_t)\n");
    }
    if (!compare(fmod(6.2, 4.), 2.2, 1) && !compare(fmod(-6.2, 4.), -2.2, 1)) {
      ++e;
      FLARE_IMPL_DO_NOT_USE_PRINTF("failed fmod(double)\n");
    }
#ifdef MATHEMATICAL_FUNCTIONS_HAVE_LONG_DOUBLE_OVERLOADS
    if (!compare(fmod(6.2l, 4.l), 2.2l, 1) &&
        !compare(fmod(-6.2l, 4.l), -2.2l, 1)) {
      ++e;
      FLARE_IMPL_DO_NOT_USE_PRINTF("failed fmod(long double)\n");
    }
#endif
    // special values
    using flare::isinf;
...
TEST_CASE("TEST_CATEGORY, mathematical_functions_remainder_function") {
...
struct TestIEEEFloatingPointRemainderFunction : FloatingPointComparison {
  ...
  FLARE_FUNCTION void operator()(int, int& e) const {
    using flare::remainder;
    if (!compare(remainder(6.2f, 4.f), 2.2f, 2) &&
        !compare(remainder(-6.2f, 4.f), 2.2f, 1)) {
      ++e;
      FLARE_IMPL_DO_NOT_USE_PRINTF("failed remainder(float)\n");
    }
    if (!compare(remainder(static_cast<KE::half_t>(6.2f),
        ...
        !compare(remainder(static_cast<KE::half_t>(-6.2f),
                 ...
                 -static_cast<KE::half_t>(2.2f), 1)) {
      ++e;
      FLARE_IMPL_DO_NOT_USE_PRINTF("failed remainder(KE::half_t)\n");
    }
    if (!compare(remainder(static_cast<KE::bhalf_t>(6.2f),
        ...
        !compare(remainder(static_cast<KE::bhalf_t>(-6.2f),
                 ...
                 -static_cast<KE::bhalf_t>(2.2f), 1)) {
      ++e;
      FLARE_IMPL_DO_NOT_USE_PRINTF("failed remainder(KE::bhalf_t)\n");
    }
    if (!compare(remainder(6.2, 4.), 2.2, 2) &&
        !compare(remainder(-6.2, 4.), 2.2, 1)) {
      ++e;
      FLARE_IMPL_DO_NOT_USE_PRINTF("failed remainder(double)\n");
    }
#ifdef MATHEMATICAL_FUNCTIONS_HAVE_LONG_DOUBLE_OVERLOADS
    if (!compare(remainder(6.2l, 4.l), 2.2l, 1) &&
        !compare(remainder(-6.2l, 4.l), -2.2l, 1)) {
      ++e;
      FLARE_IMPL_DO_NOT_USE_PRINTF("failed remainder(long double)\n");
    }
#endif
    // special values
    using flare::isinf;
...
TEST_CASE("TEST_CATEGORY, mathematical_functions_ieee_remainder_function") {
...
struct TestIsNaN {
  ...
  FLARE_FUNCTION void operator()(int, int& e) const {
    ...
    if (isnan(1) || isnan(INT_MAX)) {
      ++e;
      flare::printf("failed isnan(integral)\n");
    }
    ...
    if (isnan(static_cast<KE::bhalf_t>(2.f))
      ...
      ++e;
      FLARE_IMPL_DO_NOT_USE_PRINTF("failed isnan(KE::bhalf_t)\n");
    }
    if (isnan(3.)
#ifndef FLARE_COMPILER_NVHPC  // FIXME_NVHPC 23.7
        || !isnan(quiet_NaN<double>::value) ||
        !isnan(signaling_NaN<double>::value)
#endif
    ) {
      ++e;
      flare::printf("failed isnan(double)\n");
    }
#ifdef MATHEMATICAL_FUNCTIONS_HAVE_LONG_DOUBLE_OVERLOADS
    if (isnan(4.l) || !isnan(quiet_NaN<long double>::value) ||
        !isnan(signaling_NaN<long double>::value)) {
      ++e;
      flare::printf("failed isnan(long double)\n");
    }
#endif
    // special values
    if (isnan(INFINITY) || !isnan(NAN)) {
      ++e;
      flare::printf("failed isnan(floating_point) special values\n");
    }
...
TEST_CASE("TEST_CATEGORY, mathematical_functions_isnan") {
