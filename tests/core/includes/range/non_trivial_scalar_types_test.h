...
struct reduction_identity<Test::my_complex> {
  ...
  FLARE_FORCEINLINE_FUNCTION static Test::my_complex sum() {
    return Test::my_complex(t_red_ident::sum());
  }
  FLARE_FORCEINLINE_FUNCTION static Test::my_complex prod() {
...
struct reduction_identity<Test::array_reduce<scalar_t, N>> {
  ...
  FLARE_FORCEINLINE_FUNCTION static Test::array_reduce<scalar_t, N> sum() {
    return Test::array_reduce<scalar_t, N>(t_red_ident::sum());
  }
  FLARE_FORCEINLINE_FUNCTION static Test::array_reduce<scalar_t, N> prod() {
...
struct reduction_identity<Test::point_t> {
  FLARE_FORCEINLINE_FUNCTION constexpr static uint8_t sum() noexcept {
    return 0;
  }
  FLARE_FORCEINLINE_FUNCTION constexpr static uint8_t prod() noexcept {
    return 1;
  }
  FLARE_FORCEINLINE_FUNCTION constexpr static uint8_t max() noexcept {
    return 0xff;
  }
  FLARE_FORCEINLINE_FUNCTION constexpr static uint8_t min() noexcept {
    return 0x0;
  }
};
}  // namespace flare
