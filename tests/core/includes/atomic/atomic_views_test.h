...
class TestAtomicViewAPI {
 public:
  ...
  using dView4_unmanaged = flare::View<T****, device, flare::MemoryUnmanaged>;
  using host             = typename dView0::host_mirror_space;

  using aView0 = flare::View<T, device, flare::MemoryTraits<flare::Atomic> >;
  using aView1 =
      flare::View<T*, device, flare::MemoryTraits<flare::Atomic> >;
  using aView2 =
      flare::View<T * [N1], device, flare::MemoryTraits<flare::Atomic> >;
  using aView3 =
      flare::View<T * [N1][N2], device, flare::MemoryTraits<flare::Atomic> >;
  using aView4       = flare::View<T * [N1][N2][N3], device,
                              flare::MemoryTraits<flare::Atomic> >;
  using const_aView4 = flare::View<const T * [N1][N2][N3], device,
                                    flare::MemoryTraits<flare::Atomic> >;
  ...
  static void check_auto_conversion_to_const(
      const flare::View<const DataType, device,
  ...
  static void run_test_const() {
    using typeX =
        flare::View<DataType, device, flare::MemoryTraits<flare::Atomic> >;
...
struct InitFunctor_Seq {
  using view_type = flare::View<T*, execution_space>;
...
struct PlusEqualAtomicViewFunctor {
  using atomic_view_type =
      flare::View<T*, execution_space, flare::MemoryTraits<flare::Atomic> >;
  using view_type = flare::View<T*, execution_space>;
...
T PlusEqualAtomicView(const int64_t input_length) {
  ...
  host_view_type h_result_view = flare::create_mirror_view(result_view);
  flare::deep_copy(h_result_view, result_view);
...
struct DivEqualAtomicViewFunctor {
  using atomic_view_type =
      flare::View<T, execution_space, flare::MemoryTraits<flare::Atomic> >;
  using view_type        = flare::View<T*, execution_space>;
  using scalar_view_type = flare::View<T, execution_space>;
...
T DivEqualAtomicView(const int64_t input_length, const int64_t remainder) {
  ...
  flare::deep_copy(result_view, 12121212121);
  ...
  host_scalar_view_type h_result_view = flare::create_mirror_view(result_view);
  flare::deep_copy(h_result_view, result_view);
...
struct RSEqualAtomicViewFunctor {
  using atomic_view_type = flare::View<T****, execution_space,
                                        flare::MemoryTraits<flare::Atomic> >;
  using view_type        = flare::View<T*, execution_space>;
  using result_view_type = flare::View<T****, execution_space>;
...
T RSEqualAtomicView(const int64_t input_length, const int64_t value,
  ...
  flare::deep_copy(result_view, h_result_view);
...
TEST_CASE("TEST_CATEGORY, atomic_views_integral") {
...
TEST_CASE("TEST_CATEGORY, atomic_views_nonintegral") {
  const int64_t length = 1000000;
  {
    // Non-Integral Types.
    REQUIRE((
...
TEST_CASE("TEST_CATEGORY, atomic_view_api") {
