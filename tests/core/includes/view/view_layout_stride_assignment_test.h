...
TEST_CASE("TEST_CATEGORY, view_layoutstride_left_to_layoutleft_assignment") {
  ...
  {  // Assignment of rank-1 LayoutLeft = LayoutStride
    ...
    flare::View<double*, flare::LayoutStride, exec_space> src("LayoutStride",
                                                                layout);

    flare::View<double*, flare::LayoutStride, exec_space>::HostMirror h_src =
        flare::create_mirror_view(src);
    ...
    flare::View<double*, flare::LayoutLeft, exec_space> dst = src;

    flare::View<double*, flare::LayoutLeft, exec_space>::HostMirror h_dst =
        flare::create_mirror_view(dst);
  ...
  {  // Assignment of rank-3 LayoutLeft = LayoutStride
    ...
    flare::LayoutStride layout =
        flare::LayoutStride::order_dimensions(ndims, order, dims);
    flare::View<double***, flare::LayoutStride, exec_space> src(
        "LayoutStride", layout);

    flare::View<double***, flare::LayoutStride, exec_space>::HostMirror
        h_src = flare::create_mirror_view(src);
  ...
  {  // Assignment of rank-5 LayoutLeft = LayoutStride
    ...
    flare::View<double*****, flare::LayoutLeft, exec_space>::HostMirror
        h_dst = flare::create_mirror_view(dst);
...
TEST_CASE("TEST_CATEGORY, view_layoutstride_right_to_layoutright_assignment") {
  ...
  {  // Assignment of rank-1 LayoutRight = LayoutStride
    ...
    flare::View<double*, flare::LayoutRight, exec_space> dst = src;

    flare::View<double*, flare::LayoutRight, exec_space>::HostMirror h_dst =
        flare::create_mirror_view(dst);
  ...
  {  // Assignment of rank-4 LayoutRight = LayoutStride
    ...
    flare::View<double****, flare::LayoutRight, exec_space>::HostMirror
        h_dst = flare::create_mirror_view(dst);
...
TEST_CASE("TEST_CATEGORY_DEATH, view_layoutstride_right_to_layoutleft_assignment") {
  ...
  {  // Assignment of rank-1 LayoutLeft = LayoutStride (LayoutRight compatible)
    ...
    flare::View<double*, flare::LayoutLeft, exec_space> dst;
...
TEST_CASE("TEST_CATEGORY_DEATH, view_layoutstride_left_to_layoutright_assignment") {
  ...
  {  // Assignment of rank-1 LayoutRight = LayoutStride (LayoutLeft compatible)
    ...
    flare::View<double*, flare::LayoutRight, exec_space> dst;
...
#include <view/irregular_layout_test.h>
