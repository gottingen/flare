...
#include <flare/core/tensor/view_layout_tiled.h>
    ...
    namespace {
        ...
        struct TestViewLayoutTiled {
            ...
            static void test_view_layout_tiled_2d(const int N0, const int N1) {
                ...
                {
                    using ViewType =
                            typename flare::View<Scalar **, LayoutLL_2D_2x4, ExecSpace>;
                    ViewType v("v", N0, N1);

                    typename ViewType::HostMirror hv = flare::create_mirror_view(v);
                    ...
                    for (int tj = 0; tj < NT1; ++tj) {
                        for (int ti = 0; ti < NT0; ++ti) {
                            auto tile_subview = flare::tile_subview(hv, ti, tj);
                            for (int j = 0; j < T1; ++j) {
                                for (int i = 0; i < T0; ++i) {
                    ...
                    REQUIRE_EQ(counter_subview, long(0));
                ...
                {
                    using ViewType =
                            typename flare::View<Scalar **, LayoutRL_2D_2x4, ExecSpace>;
                    flare::View<Scalar **, LayoutRL_2D_2x4, ExecSpace> v("v", N0, N1);
                ...
                {
                    using ViewType =
                            typename flare::View<Scalar **, LayoutLR_2D_2x4, ExecSpace>;
                    flare::View<Scalar **, LayoutLR_2D_2x4, ExecSpace> v("v", N0, N1);
                ...
                {
                    using ViewType =
                            typename flare::View<Scalar **, LayoutRR_2D_2x4, ExecSpace>;
                    flare::View<Scalar **, LayoutRR_2D_2x4, ExecSpace> v("v", N0, N1);
            ...
            static void test_view_layout_tiled_3d(const int N0, const int N1,
                ...
                // Create LL View
                {
                    using ViewType = flare::View<Scalar ***, LayoutLL_3D_2x4x4, ExecSpace>;
                    flare::View<Scalar ***, LayoutLL_3D_2x4x4, ExecSpace> dv("dv", N0, N1,
                                                                             N2);

                    typename ViewType::HostMirror v = flare::create_mirror_view(dv);
                    ...
                    for (int tk = 0; tk < NT2; ++tk) {
                        for (int tj = 0; tj < NT1; ++tj) {
                            for (int ti = 0; ti < NT0; ++ti) {
                                auto tile_subview = flare::tile_subview(v, ti, tj, tk);
                                for (int k = 0; k < T2; ++k) {
                                    for (int j = 0; j < T1; ++j) {
                                        for (int i = 0; i < T0; ++i) {
                ...
                // Create RL View
                {
                    using ViewType = flare::View<Scalar ***, LayoutRL_3D_2x4x4, ExecSpace>;
                    flare::View<Scalar ***, LayoutRL_3D_2x4x4, ExecSpace> dv("dv", N0, N1,
                                                                             N2);
                ...
                // Create LR View
                {
                    using ViewType = flare::View<Scalar ***, LayoutLR_3D_2x4x4, ExecSpace>;
                    flare::View<Scalar ***, LayoutLR_3D_2x4x4, ExecSpace> dv("dv", N0, N1,
                                                                             N2);
                ...
                // Create RR View
                {
                    using ViewType = flare::View<Scalar ***, LayoutRR_3D_2x4x4, ExecSpace>;
                    flare::View<Scalar ***, LayoutRR_3D_2x4x4, ExecSpace> dv("dv", N0, N1,
                                                                             N2);
            ...
            static void test_view_layout_tiled_4d(const int N0, const int N1,
                ...
                // Create LL View
                {
                    using ViewType = flare::View<Scalar ****, LayoutLL_4D_2x4x4x2, ExecSpace>;
                    flare::View<Scalar ****, LayoutLL_4D_2x4x4x2, ExecSpace> dv("dv", N0, N1,
                                                                                N2, N3);
                    ...
                    for (int tl = 0; tl < NT3; ++tl) {
                        for (int tk = 0; tk < NT2; ++tk) {
                            for (int tj = 0; tj < NT1; ++tj) {
                                for (int ti = 0; ti < NT0; ++ti) {
                                    auto tile_subview = flare::tile_subview(v, ti, tj, tk, tl);
                                    for (int l = 0; l < T3; ++l) {
                                        for (int k = 0; k < T2; ++k) {
                                            for (int j = 0; j < T1; ++j) {
                                                for (int i = 0; i < T0; ++i) {
                ...
                // Create RL View
                {
                    using ViewType = flare::View<Scalar ****, LayoutRL_4D_2x4x4x2, ExecSpace>;
                    flare::View<Scalar ****, LayoutRL_4D_2x4x4x2, ExecSpace> dv("dv", N0, N1,
                                                                                N2, N3);
                ...
                // Create LR View
                {
                    using ViewType = flare::View<Scalar ****, LayoutLR_4D_2x4x4x2, ExecSpace>;
                    flare::View<Scalar ****, LayoutLR_4D_2x4x4x2, ExecSpace> dv("dv", N0, N1,
                                                                                N2, N3);
                ...
                // Create RR View
                {
                    using ViewType = flare::View<Scalar ****, LayoutRR_4D_2x4x4x2, ExecSpace>;
                    flare::View<Scalar ****, LayoutRR_4D_2x4x4x2, ExecSpace> dv("dv", N0, N1,
                                                                                N2, N3);
            ...
            static void test_view_layout_tiled_subtile_2d(const int N0, const int N1) {
                ...
                // Create LL View
                {
                    flare::View<Scalar **, LayoutLL_2D_2x4, flare::HostSpace> v("v", N0, N1);
                    for (int tj = 0; tj < NT1; ++tj) {
                        for (int ti = 0; ti < NT0; ++ti) {
                            for (int j = 0; j < T1; ++j) {
                                for (int i = 0; i < T0; ++i) {
                    ...
                    for (int tj = 0; tj < NT1; ++tj) {
                        for (int ti = 0; ti < NT0; ++ti) {
                            auto tile_subview = flare::tile_subview(v, ti, tj);
                            for (int j = 0; j < T1; ++j) {
                                for (int i = 0; i < T0; ++i) {
                ...
                // Create RL View
                {
                    flare::View<Scalar **, LayoutRL_2D_2x4, flare::HostSpace> v("v", N0, N1);
                    for (int ti = 0; ti < NT0; ++ti) {
                        for (int tj = 0; tj < NT1; ++tj) {
                            for (int j = 0; j < T1; ++j) {
                                for (int i = 0; i < T0; ++i) {
                ...
                // Create LR View
                {
                    flare::View<Scalar **, LayoutLR_2D_2x4, flare::HostSpace> v("v", N0, N1);
                    for (int tj = 0; tj < NT1; ++tj) {
                        for (int ti = 0; ti < NT0; ++ti) {
                            for (int i = 0; i < T0; ++i) {
                                for (int j = 0; j < T1; ++j) {
                ...
                // Create RR View
                {
                    flare::View<Scalar **, LayoutRR_2D_2x4, flare::HostSpace> v("v", N0, N1);
                    for (int ti = 0; ti < NT0; ++ti) {
                        for (int tj = 0; tj < NT1; ++tj) {
                            for (int i = 0; i < T0; ++i) {
                                for (int j = 0; j < T1; ++j) {
                        ...
                        for (int tj = 0; tj < NT1; ++tj) {
                            ...
                            for (int i = 0; i < T0; ++i) {
                                for (int j = 0; j < T1; ++j) {
                                    ...
                                    std::cout << "subview_tile output = " << tile_subview(i, j)
                                              << std::endl;
                                    std::cout << "subview tile rank = " << flare::rank(tile_subview)
                                              << std::endl;
#endif
                                }
                            }
            ...
            static void test_view_layout_tiled_subtile_3d(const int N0, const int N1,
                ...
                // Create LL View
                {
                    flare::View<Scalar ***, LayoutLL_3D_2x4x4, flare::HostSpace> v("v", N0,
                                                                                   N1, N2);
                    for (int tk = 0; tk < NT2; ++tk) {
                        for (int tj = 0; tj < NT1; ++tj) {
                            for (int ti = 0; ti < NT0; ++ti) {
                                    ...
                                    for (int j = 0; j < T1; ++j) {
                                        for (int i = 0; i < T0; ++i) {
                                            ...
                                            std::cout << "subview_tile output = " << tile_subview(i, j, k)
                                                      << std::endl;
                                            std::cout
                                                << "subview tile rank = " << flare::rank(tile_subview)
                                                << std::endl;
#endif
                                        }
                                    }
                ...
                // Create RL View
                {
                    flare::View<Scalar ***, LayoutRL_3D_2x4x4, flare::HostSpace> v("v", N0,
                                                                                   N1, N2);
                    for (int ti = 0; ti < NT0; ++ti) {
                        for (int tj = 0; tj < NT1; ++tj) {
                            for (int tk = 0; tk < NT2; ++tk) {
                ...
                // Create LR View
                {
                    flare::View<Scalar ***, LayoutLR_3D_2x4x4, flare::HostSpace> v("v", N0,
                                                                                   N1, N2);
                    for (int tk = 0; tk < NT2; ++tk) {
                        for (int tj = 0; tj < NT1; ++tj) {
                            for (int ti = 0; ti < NT0; ++ti) {
                ...
                // Create RR View
                {
                    flare::View<Scalar ***, LayoutRR_3D_2x4x4, flare::HostSpace> v("v", N0,
                                                                                   N1, N2);
                    for (int ti = 0; ti < NT0; ++ti) {
                        for (int tj = 0; tj < NT1; ++tj) {
                            for (int tk = 0; tk < NT2; ++tk) {
            ...
            static void test_view_layout_tiled_subtile_4d(const int N0, const int N1,
                ...
                // Create LL View
                {
                    flare::View<Scalar ****, LayoutLL_4D_2x4x4x2, flare::HostSpace> v(
                            "v", N0, N1, N2, N3);
                    for (int tl = 0; tl < NT3; ++tl) {
                        for (int tk = 0; tk < NT2; ++tk) {
                            for (int tj = 0; tj < NT1; ++tj) {
                                            ...
                                            for (int j = 0; j < T1; ++j) {
                                                for (int i = 0; i < T0; ++i) {
                                                    ...
                                                    std::cout << "subview tile rank = "
                                                              << flare::rank(tile_subview) << std::endl;
#endif
                                                }
                                            }
                                        }
                ...
                // Create RL View
                {
                    flare::View<Scalar ****, LayoutRL_4D_2x4x4x2, flare::HostSpace> v(
                            "v", N0, N1, N2, N3);
                    for (int ti = 0; ti < NT0; ++ti) {
                        for (int tj = 0; tj < NT1; ++tj) {
                            for (int tk = 0; tk < NT2; ++tk) {
                ...
                // Create LR View
                {
                    flare::View<Scalar ****, LayoutLR_4D_2x4x4x2, flare::HostSpace> v(
                            "v", N0, N1, N2, N3);
                    for (int tl = 0; tl < NT3; ++tl) {
                        for (int tk = 0; tk < NT2; ++tk) {
                            for (int tj = 0; tj < NT1; ++tj) {
                ...
                // Create RR View
                {
                    flare::View<Scalar ****, LayoutRR_4D_2x4x4x2, flare::HostSpace> v(
                            "v", N0, N1, N2, N3);
                    for (int ti = 0; ti < NT0; ++ti) {
                        for (int tj = 0; tj < NT1; ++tj) {
                            for (int tk = 0; tk < NT2; ++tk) {
