...
TEST_CASE("TEST_CATEGORY, view_copy_tests") {
  int N = 10000;
  int M = 10;

  flare::View<int**, flare::LayoutRight, TEST_EXECSPACE> defaulted;
  flare::View<int**, flare::LayoutRight, TEST_EXECSPACE> a("A", N, M);
  flare::View<int**, flare::LayoutRight, TEST_EXECSPACE> b("B", N, M);
  auto h_a  = flare::create_mirror(a);
  auto h_b  = flare::create_mirror(b);
  auto m_a  = flare::create_mirror_view(a);
  auto s_a  = flare::subview(a, flare::ALL, 1);
  auto s_b  = flare::subview(b, flare::ALL, 1);
  auto hs_a = flare::subview(h_a, flare::ALL, 1);
  auto hs_b = flare::subview(h_b, flare::ALL, 1);
