...
TEST_CASE("TEST_CATEGORY, view_copy_tests_rank_0") {
  flare::View<int, TEST_EXECSPACE> defaulted;
  flare::View<int, TEST_EXECSPACE> a("A");
  flare::View<int, TEST_EXECSPACE> b("B");
  auto h_a  = flare::create_mirror(a);
  auto h_b  = flare::create_mirror(b);
  auto m_a  = flare::create_mirror_view(a);
...
TEST_CASE("TEST_CATEGORY, view_copy_degenerated") {
  flare::View<int*, TEST_EXECSPACE, flare::MemoryTraits<flare::Unmanaged>>
      v_um_def_1;
  flare::View<int*, TEST_EXECSPACE, flare::MemoryTraits<flare::Unmanaged>>
  v_um_1(reinterpret_cast<int*>(-1), 0);
  flare::View<int*, TEST_EXECSPACE> v_m_def_1;
  flare::View<int*, TEST_EXECSPACE> v_m_1("v_m_1", 0);

  flare::View<int*, TEST_EXECSPACE, flare::MemoryTraits<flare::Unmanaged>>
      v_um_def_2;
  flare::View<int*, TEST_EXECSPACE, flare::MemoryTraits<flare::Unmanaged>>
  v_um_2(reinterpret_cast<int*>(-1), 0);
  flare::View<int*, TEST_EXECSPACE> v_m_def_2;
  flare::View<int*, TEST_EXECSPACE> v_m_2("v_m_2", 0);
