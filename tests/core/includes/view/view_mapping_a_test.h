...
void test_view_mapping() {
  ...
  using dim_0        = flare::detail::ViewDimension<>;
  using dim_s2       = flare::detail::ViewDimension<2>;
  using dim_s2_s3    = flare::detail::ViewDimension<2, 3>;
  using dim_s2_s3_s4 = flare::detail::ViewDimension<2, 3, 4>;

  using dim_s0       = flare::detail::ViewDimension<0>;
  using dim_s0_s3    = flare::detail::ViewDimension<0, 3>;
  using dim_s0_s3_s4 = flare::detail::ViewDimension<0, 3, 4>;

  using dim_s0_s0    = flare::detail::ViewDimension<0, 0>;
  using dim_s0_s0_s4 = flare::detail::ViewDimension<0, 0, 4>;

  using dim_s0_s0_s0          = flare::detail::ViewDimension<0, 0, 0>;
  using dim_s0_s0_s0_s0       = flare::detail::ViewDimension<0, 0, 0, 0>;
  using dim_s0_s0_s0_s0_s0    = flare::detail::ViewDimension<0, 0, 0, 0, 0>;
  using dim_s0_s0_s0_s0_s0_s0 = flare::detail::ViewDimension<0, 0, 0, 0, 0, 0>;
  using dim_s0_s0_s0_s0_s0_s0_s0 =
      flare::detail::ViewDimension<0, 0, 0, 0, 0, 0, 0>;
  using dim_s0_s0_s0_s0_s0_s0_s0_s0 =
      flare::detail::ViewDimension<0, 0, 0, 0, 0, 0, 0, 0>;
...
// Fully static dimensions should not be larger than an int.
  ...
  using stride_s0_s0_s0 =
      flare::detail::ViewOffset<dim_s0_s0_s0, flare::LayoutStride>;

  //----------------------------------------
  // Static dimension.
  {
    using left_s2_s3_s4 =
        flare::detail::ViewOffset<dim_s2_s3_s4, flare::LayoutLeft>;
  ...
  {
    using left_s0_s0_s4 =
        flare::detail::ViewOffset<dim_s0_s0_s4, flare::LayoutLeft>;
  ...
  // Static dimension.
  {
    using right_s2_s3_s4 =
        flare::detail::ViewOffset<dim_s2_s3_s4, flare::LayoutRight>;
  ...
  // Small dimension is unpadded.
  {
    using right_s0_s0_s4 =
        flare::detail::ViewOffset<dim_s0_s0_s4, flare::LayoutRight>;
  ...
  // Subview.
  {
    ...
    using SubviewExtents = flare::detail::SubviewExtents<4, 3>;
    ...
    flare::detail::ViewDimension<N0, N1, N2, N3> dim;

    SubviewExtents tmp(dim, N0 / 2, flare::ALL,
...

  {
    ...
    flare::detail::SubviewExtents<3, 3> sub(
...

  {
    ...
    static_assert(std::is_same<typename a_const_int_r1::dimension,
                               flare::detail::ViewDimension<0> >::value,
                  "");
    ...
    static_assert(std::is_same<typename a_const_int_r3::dimension,
                               flare::detail::ViewDimension<0, 0, 4> >::value,
                  "");
...

  {
    ...
    using T = flare::View<int*, Space>;
    using C = flare::View<const int*, Space>;
  ...
  {
    using traits_t =
        flare::ViewTraits<int***, flare::LayoutStride, ExecSpace>;
    using dims_t   = flare::detail::ViewDimension<0, 0, 0>;
    using offset_t = flare::detail::ViewOffset<dims_t, flare::LayoutStride>;
    ...
    flare::detail::ViewMapping<traits_t, void> v(
        flare::detail::ViewCtorProp<int*>(nullptr), stride);
  }

  {
    using V           = flare::View<int**, Space>;
    using M           = typename V::HostMirror;
    using layout_type = typename flare::View<int**, Space>::array_layout;
    ...
    M c = flare::create_mirror_view(a);
    M d;
  ...
  {
    using V = flare::View<int**, flare::LayoutStride, Space>;
    using M = typename V::HostMirror;
    using layout_type =
        typename flare::View<int**, flare::LayoutStride, Space>::array_layout;
  ...
  {
    using V = flare::View<int*, Space>;
    using U = flare::View<int*, Space, flare::MemoryUnmanaged>;
...
TEST_CASE("TEST_CATEGORY, view_mapping") { test_view_mapping<TEST_EXECSPACE>(); }
/*--------------------------------------------------------------------------*/
...
struct TestViewMapOperator {
  ...
  void run() {
    ...
    int64_t error_count;
    flare::RangePolicy<typename ViewType::execution_space> range(0,
                                                                  v.extent(0));
...
void test_view_mapping_operator() {
  ...
  {
    TestViewMapOperator<flare::View<int, flare::LayoutLeft, ExecSpace> > f;
    f.run();
  }
  {
    TestViewMapOperator<flare::View<int*, flare::LayoutLeft, ExecSpace> > f;
  ...
  {
    TestViewMapOperator<flare::View<int****, flare::LayoutLeft, ExecSpace> >
        f;
    f.run();
  }
  {
  ...
  {
    TestViewMapOperator<
        flare::View<int*******, flare::LayoutLeft, ExecSpace> >
        f;
    f.run();
  }

  {
    TestViewMapOperator<flare::View<int, flare::LayoutRight, ExecSpace> > f;
    f.run();
  }
  {
    TestViewMapOperator<flare::View<int*, flare::LayoutRight, ExecSpace> > f;
  ...
  {
    TestViewMapOperator<flare::View<int***, flare::LayoutRight, ExecSpace> >
        f;
    f.run();
  }
  {
  ...
  {
    TestViewMapOperator<
        flare::View<int******, flare::LayoutRight, ExecSpace> >
        f;
    f.run();
  }
  {
