...
struct ViewOffset<Dimension, flare::LayoutSelective, void> {
 public:
...
struct TestLayout {
  ...
  using ViewVectorType =
      flare::View<InnerClass*, Layout, typename ExecutionSpace::memory_space>;
  using SubViewVectorType = flare::View<InnerClass*, SubLayout,
  ...
  void validate_results() {
    auto a_h = flare::create_mirror_view(a);
