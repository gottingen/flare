...
struct TestViewMappingAtomic {
  ...
  using T      = flare::View<int *, ExecSpace>;
  using T_atom = flare::View<int *, ExecSpace, mem_trait>;
  ...
  void run() {
    ...
    typename T_atom::HostMirror x_host = flare::create_mirror_view(x);
...
struct MappingClassValueType {
  ...
  MappingClassValueType() {
    ...
    FLARE_IF_ON_HOST((printf("TestViewMappingClassValue construct on Host\n");))
#endif
  }
  FLARE_INLINE_FUNCTION
  ~MappingClassValueType() {
    ...
    FLARE_IF_ON_HOST((printf("TestViewMappingClassValue destruct on Host\n");))
#endif
  }
};
...
void test_view_mapping_class_value() {
  ...
  ExecSpace().fence();
  {
    flare::View<MappingClassValueType, ExecSpace> a("a");
    ExecSpace().fence();
  }
  ExecSpace().fence();
}
...
TEST_CASE("TEST_CATEGORY, view_mapping_assignable") {
  ...
  {  // Assignment of rank-0 Left = Right
    using dst_traits = flare::ViewTraits<int, flare::LayoutLeft, exec_space>;
    using src_traits = flare::ViewTraits<int, flare::LayoutRight, exec_space>;
    using mapping    = flare::detail::ViewMapping<dst_traits, src_traits, void>;
    static_assert(mapping::is_assignable, "");

    flare::View<int, flare::LayoutRight, exec_space> src;
    flare::View<int, flare::LayoutLeft, exec_space> dst(src);
    dst = src;
  }

  {  // Assignment of rank-0 Right = Left
    using dst_traits = flare::ViewTraits<int, flare::LayoutRight, exec_space>;
    using src_traits = flare::ViewTraits<int, flare::LayoutLeft, exec_space>;
    using mapping    = flare::detail::ViewMapping<dst_traits, src_traits, void>;
    static_assert(mapping::is_assignable, "");

    flare::View<int, flare::LayoutLeft, exec_space> src;
    flare::View<int, flare::LayoutRight, exec_space> dst(src);
    dst = src;
  }

  {  // Assignment of rank-1 Left = Right
    using dst_traits =
        flare::ViewTraits<int *, flare::LayoutLeft, exec_space>;
    using src_traits =
        flare::ViewTraits<int *, flare::LayoutRight, exec_space>;
    using mapping = flare::detail::ViewMapping<dst_traits, src_traits, void>;
    static_assert(mapping::is_assignable, "");
...
TEST_CASE("TEST_CATEGORY, view_mapping_trivially_copyable") {
  ...
  using dst_traits = flare::ViewTraits<int *, exec_space>;
