...
namespace flare::simd {
    ...
    struct test_int_min_max<batch<T>, 2>
    {
        void run()
        {
            ...
            auto r1 = flare::simd::max(a, c);
            auto r3 = flare::simd::min(a, c);
            ...
            auto r4 = a < b; // test lt
            BB e4 = { 1, 0 };
            CHECK_UNARY(flare::simd::all(r4 == e4));
        }
    };
    ...
    struct test_int_min_max<batch<T>, 16>
    {
        void run()
        {
            ...
            auto r1 = flare::simd::max(a, b);
            auto r3 = flare::simd::min(a, b);
            auto r4 = a < b; // test lt
            auto r5 = a == c;
            auto r6 = a != c;
            ...
            CHECK_UNARY(flare::simd::all(r5 == e5));
            CHECK_UNARY(flare::simd::all(r6 == !e5));
        }
    };
...
struct batch_int_test
{
    ...
    {
        flare::simd::test_int_min_max<batch_type> t;
        t.run();
    }
    ...
    void test_less_than_underflow() const
    {
        ...
        {
            CHECK_FALSE(flare::simd::any(test_negative_compare < 1));
        }
        else
        {
            CHECK_UNARY(flare::simd::all(test_negative_compare < 1));
        }
    }
