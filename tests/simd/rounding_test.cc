...
namespace detail
{
    inline flare::simd::as_integer_t<float> nearbyint_as_int(float a)
    {
        return std::lroundf(a);
    }

    inline flare::simd::as_integer_t<double> nearbyint_as_int(double a)
    {
...
struct rounding_test
{
    ...
    using int_value_type = flare::simd::as_integer_t<value_type>;
    using int_batch_type = flare::simd::batch<int_value_type, arch_type>;
