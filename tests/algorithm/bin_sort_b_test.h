...
namespace Test {
    namespace BinSortSetB {
        ...
        auto create_deep_copyable_compatible_view_with_same_extent(
                flare::View<ValueType *, Props...> view) {
            using view_type = flare::View<ValueType *, Props...>;
        ...
        auto create_rank1_dev_and_host_views_of_keys(const ExecutionSpace &exec,
            ...
            auto keys_h = flare::create_mirror_view(keys);
        ...
        auto create_strided_view(std::size_t numRows, std::size_t /*numCols*/) {
            ...
            using v_t = flare::View<ValueType *, flare::LayoutStride, ExecutionSpace>;
            v_t v("v", layout);
            return v;
        }
        ...
        template<class ExecutionSpace, class KeyType, class ValueType, int ValuesViewRank>
        void
        test_on_view_with_stride(std::size_t numRows, std::size_t indB, std::size_t indE, std::size_t numCols = 1) {
            ExecutionSpace exec;
            flare::DefaultHostExecutionSpace defaultHostExeSpace;
            namespace KE = flare::experimental;
            ...
            // 3. create sorter
            flare::BinSort<KeyViewType, BinOp> sorter(keys, indB, indE, binner, false);
        ...
        void run_for_rank1() {
            ...
            test_on_view_with_stride<ExecutionSpace, KeyType, ValueType, rank>(4, 0, 4);
            // nontrivial cases
            /*
            for (std::size_t N: {311, 710017}) {
                ...
                test_on_view_with_stride<ExecutionSpace, KeyType, ValueType, rank>(N, 0,N - 4);
                test_on_view_with_stride<ExecutionSpace, KeyType, ValueType, rank>(N, 4,N - 3);
            }
             */
        }
        ...
        void run_for_rank2() {
            ...
            // trivial case
            test_on_view_with_stride<ExecutionSpace, KeyType, ValueType, rank>(1, 0, 1, 1);
