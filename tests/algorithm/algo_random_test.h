...
#ifndef FLARE_ALGORITHMS_RANDOM_TEST_H_
#define FLARE_ALGORITHMS_RANDOM_TEST_H_
...
#define HIST_DIM1D (HIST_DIM3D * HIST_DIM3D * HIST_DIM3D)
        ...
        struct test_random_functor {
            ...
            // dimension, in the Tensor types below.
            using type_1d =
                    flare::Tensor<int[HIST_DIM1D + 1], typename GeneratorPool::device_type>;
            type_1d density_1d;
            using type_3d =
                    flare::Tensor<int[HIST_DIM3D + 1][HIST_DIM3D + 1][HIST_DIM3D + 1],
        ...
        struct test_histogram1d_functor {
            ...
            // implementations might violate this upper bound, due to rounding
            // error.  Just in case, we leave an extra space at the end of each
            // dimension, in the Tensor type below.
            using type_1d = flare::Tensor<int[HIST_DIM1D + 1], memory_space>;
            type_1d density_1d;
            double mean;
...
//
        ...
        struct generate_random_stream {
            using TensorType = flare::Tensor<uint64_t **, ExecutionSpace>;

            TensorType vals;
            GeneratorPool rand_pool;
            int samples;

            generate_random_stream(TensorType vals_, GeneratorPool rand_pool_, int samples_)
...
// generated by a Random pool, it only tests for complete duplicates.
        ...
        void test_duplicate_stream() {
            ...
            Pool rand_pool(42);
            TensorType vals_d("Vals", n_streams, samples);
            ...
            auto vals_h =
                    flare::create_mirror_tensor_and_copy(flare::HostSpace{}, vals_d);
    ...
    TEST_CASE("TEST_CATEGORY, Random_XorShift64") {
        ...
        AlgoRandomImpl::test_random<flare::Random_XorShift64_Pool<
                ...
                num_draws);
        AlgoRandomImpl::TestDynRankTensor<
...
#endif  // FLARE_ALGORITHMS_RANDOM_TEST_H_
