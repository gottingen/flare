...
We both value and encourage the community to provide feedback about using Flare and the issues they are facing.
...
- [New features](https://github.com/arrayfire/arrayfire/issues?q=is%3Aopen+is%3Aissue+label%3Afeature)
    - You can refer to [this](https://github.com/arrayfire/arrayfire/wiki/How-to-Add-a-New-Function-to-Flare) wiki page to get started on how to add a new function to the library.
...
##Flare Based Projects##

You can also contribute to Flare by helping out projects that use Flare! For our part, in addition to the Flare library we are also in the process of adding native bindings for numerous language. We currently support
