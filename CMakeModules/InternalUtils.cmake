...
function(flare_set_default_cxx_flags target)
    ...
    PRIVATE
      ...
      $<$<BOOL:${CMAKE_SYCL_COMPILER}>:
        $<$<COMPILE_LANGUAGE:SYCL>:
                ...
                -Werror=reorder-ctor
                #-fp-model precise
                $<$<BOOL:${FLY_WITH_FAST_MATH}>: -ffast-math -fno-errno-math -fno-trapping-math -fno-signed-zeros -mno-ieee-fp>
                $<$<NOT:$<BOOL:${FLY_WITH_FAST_MATH}>>: $<IF:$<PLATFORM_ID:Windows>,/fp=precise,-fp-model=precise>>
  ...
  target_compile_definitions(${target}
    PRIVATE
      ...
      $<$<BOOL:${FLY_WITH_LOGGING}>:           FLY_WITH_LOGGING>
      $<$<BOOL:${FLY_CACHE_KERNELS_TO_DISK}>:  FLY_CACHE_KERNELS_TO_DISK>
      $<$<BOOL:${FLY_WITH_FAST_MATH}>:         FLY_WITH_FAST_MATH>
  )
endfunction()

function(__fly_deprecate_var var access value)
  if(access STREQUAL "READ_ACCESS")
    message(DEPRECATION "Variable ${var} is deprecated. Use FLY_${var} instead.")
  endif()
endfunction()

function(fly_deprecate var newvar)
  if(DEFINED ${var})
  ...
  variable_watch(${var} __fly_deprecate_var)
endfunction()
