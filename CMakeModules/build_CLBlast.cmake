...
if(TARGET clblast OR FLY_WITH_EXTERNAL_PACKAGES_ONLY)
  if(TARGET clblast)
  ...
  file(COPY ${PROJECT_SOURCE_DIR}/3rd/CLBlast-1.6.2 DESTINATION ${PROJECT_BINARY_DIR}/extern)
  include(ExternalProject)
  find_program(GIT git)

  set(clblast_source_dir ${PROJECT_BINARY_DIR}/extern/CLBlast-1.6.2)
  set(clblast_build_dir ${PROJECT_BINARY_DIR}/extern/CLBlast-build)
  ...
  set(CLBlast_location ${clblast_build_dir}/pkg/lib/${CLBlast_libname})
  ...
  ExternalProject_Add(
      ...
      BINARY_DIR "${clblast_build_dir}"
      PREFIX "${prefix}"
      INSTALL_DIR "${clblast_build_dir}/pkg"
  ...
  set(CLBLAST_INCLUDE_DIRS "${clblast_build_dir}/pkg/include")
