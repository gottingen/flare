...
auto find_end(const ExecutionSpace& ex,
  ...
  return detail::find_end_exespace_impl("flare::find_end_view_api_default", ex,
...
auto find_end(const std::string& label, const ExecutionSpace& ex,
  ...
  namespace KE = ::flare::experimental;
  return detail::find_end_exespace_impl(label, ex, KE::begin(view), KE::end(view),
                                      KE::begin(s_view), KE::end(s_view));
}
...
FLARE_FUNCTION auto find_end(
  ...
  namespace KE = ::flare::experimental;
  return detail::find_end_team_impl(teamHandle, KE::begin(view), KE::end(view),
                                  KE::begin(s_view), KE::end(s_view));
}
