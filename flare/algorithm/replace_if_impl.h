...
#ifndef FLARE_ALGORITHM_REPLACE_IF_IMPL_H_
#define FLARE_ALGORITHM_REPLACE_IF_IMPL_H_
...
void replace_if_exespace_impl(const std::string& label,
  ...
  ex.fence("flare::replace_if: fence after operation");
}

template <class TeamHandleType, class IteratorType, class PredicateType,
          class ValueType>
FLARE_FUNCTION void replace_if_team_impl(const TeamHandleType& teamHandle,
...
#endif  // FLARE_ALGORITHM_REPLACE_IF_IMPL_H_
