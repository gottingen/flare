...
#ifndef FLARE_ALGORITHM_SEARCH_IMPL_H_
#define FLARE_ALGORITHM_SEARCH_IMPL_H_
...
template <class TeamHandleType, class IteratorType1, class IteratorType2>
FLARE_FUNCTION IteratorType1 search_team_impl(const TeamHandleType& teamHandle,
                                               IteratorType1 first,
                                               IteratorType1 last,
                                               IteratorType2 s_first,
                                               IteratorType2 s_last) {
...
#endif  // FLARE_ALGORITHM_SEARCH_IMPL_H_
