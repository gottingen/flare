...
#ifndef FLARE_ALGORITHM_ALL_OF_H_
#define FLARE_ALGORITHM_ALL_OF_H_
...
bool all_of(const ExecutionSpace& ex, InputIterator first, InputIterator last,
            Predicate predicate) {
  return detail::all_of_exespace_impl("flare::all_of_iterator_api_default", ex,
...
bool all_of(const std::string& label, const ExecutionSpace& ex,
  ...
  return detail::all_of_exespace_impl(label, ex, first, last, predicate);
}
...
bool all_of(const ExecutionSpace& ex,
  ...
  return detail::all_of_exespace_impl("flare::all_of_tensor_api_default", ex,
...
bool all_of(const std::string& label, const ExecutionSpace& ex,
  ...
  namespace KE = ::flare::experimental;
  return detail::all_of_exespace_impl(label, ex, KE::cbegin(v), KE::cend(v),
                                    std::move(predicate));
}
...
FLARE_FUNCTION bool all_of(const TeamHandleType& teamHandle,
                            InputIterator first, InputIterator last,
                            Predicate predicate) {
  return detail::all_of_team_impl(teamHandle, first, last, predicate);
}
...
FLARE_FUNCTION bool all_of(const TeamHandleType& teamHandle,
  ...
  namespace KE = ::flare::experimental;
  return detail::all_of_team_impl(teamHandle, KE::cbegin(v), KE::cend(v),
                                std::move(predicate));
}
...
#endif  // FLARE_ALGORITHM_ALL_OF_H_
