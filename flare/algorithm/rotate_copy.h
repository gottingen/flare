...
#ifndef FLARE_ALGORITHM_ROTATE_COPY_H_
#define FLARE_ALGORITHM_ROTATE_COPY_H_

#include <flare/algorithm/rotate_copy_impl.h>
...
OutputIterator rotate_copy(const ExecutionSpace& ex, InputIterator first,
  ...
  return detail::rotate_copy_exespace_impl(
      "flare::rotate_copy_iterator_api_default", ex, first, n_first, last,
      d_first);
}
...
OutputIterator rotate_copy(const std::string& label, const ExecutionSpace& ex,
  ...
  return detail::rotate_copy_exespace_impl(label, ex, first, n_first, last,
                                         d_first);
}
...
auto rotate_copy(const std::string& label, const ExecutionSpace& ex,
  ...
  return detail::rotate_copy_exespace_impl(label, ex, cbegin(source),
...
FLARE_FUNCTION OutputIterator rotate_copy(const TeamHandleType& teamHandle,
                                           InputIterator first,
                                           InputIterator n_first,
                                           InputIterator last,
                                           OutputIterator d_first) {
  return detail::rotate_copy_team_impl(teamHandle, first, n_first, last, d_first);
}
...
FLARE_FUNCTION auto rotate_copy(
  ...
  return detail::rotate_copy_team_impl(teamHandle, cbegin(source),
...
#endif  // FLARE_ALGORITHM_ROTATE_COPY_H_
