...
#ifndef FLARE_ALGORITHM_COPY_N_H_
#define FLARE_ALGORITHM_COPY_N_H_
...
OutputIterator copy_n(const ExecutionSpace& ex, InputIterator first, Size count,
  ...
  return detail::copy_n_impl("flare::copy_n_iterator_api_default", ex, first,
                           count, result);
}
...
OutputIterator copy_n(const std::string& label, const ExecutionSpace& ex,
  ...
  return detail::copy_n_impl(label, ex, first, count, result);
}
...
auto copy_n(const std::string& label, const ExecutionSpace& ex,
  ...
  namespace KE = ::flare::experimental;
  return detail::copy_n_impl(label, ex, KE::cbegin(source), count,
                           KE::begin(dest));
}
...
#endif  // FLARE_ALGORITHM_COPY_N_H_
