...
#ifndef FLARE_ALGORITHM_MIN_ELEMENT_H_
#define FLARE_ALGORITHM_MIN_ELEMENT_H_
...
auto min_element(const ExecutionSpace& ex, IteratorType first,
  ...
  return detail::min_or_max_element_exespace_impl<MinFirstLoc>(
      "flare::min_element_iterator_api_default", ex, first, last);
}
...
auto min_element(const std::string& label, const ExecutionSpace& ex,
  ...
  return detail::min_or_max_element_exespace_impl<MinFirstLoc>(label, ex, first,
                                                             last);
}
...
FLARE_FUNCTION auto min_element(const TeamHandleType& teamHandle,
                                 IteratorType first, IteratorType last) {
  return detail::min_or_max_element_team_impl<MinFirstLoc>(teamHandle, first,
                                                         last);
}
...
#endif  // FLARE_ALGORITHM_MIN_ELEMENT_H_
