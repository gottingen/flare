...
#ifndef FLARE_ALGORITHM_MAX_ELEMENT_H_
#define FLARE_ALGORITHM_MAX_ELEMENT_H_
...
auto max_element(const ExecutionSpace& ex, IteratorType first,
  ...
  return detail::min_or_max_element_exespace_impl<MaxFirstLoc>(
      "flare::max_element_iterator_api_default", ex, first, last);
}
...
auto max_element(const std::string& label, const ExecutionSpace& ex,
  ...
  return detail::min_or_max_element_exespace_impl<MaxFirstLoc>(label, ex, first,
                                                             last);
}
...
FLARE_FUNCTION auto max_element(const TeamHandleType& teamHandle,
                                 IteratorType first, IteratorType last) {
  return detail::min_or_max_element_team_impl<MaxFirstLoc>(teamHandle, first,
                                                         last);
}
...
#endif  // FLARE_ALGORITHM_MAX_ELEMENT_H_
