...
/// \file dyn_rank_view.h
/// \brief Declaration and definition of flare::DynRankView.
///
/// This header file declares and defines flare::DynRankView and its
/// related nonmember functions.

#ifndef FLARE_DYN_RANK_VIEW_H_
#define FLARE_DYN_RANK_VIEW_H_
...
struct DynRankDimTraits {
  ...
  FLARE_INLINE_FUNCTION static size_t computeRank(
      const flare::detail::ViewCtorProp<P...>& /* prop */,
      const Layout& layout) {
  ...
  createLayout(const flare::detail::ViewCtorProp<P...>& /* prop */,
...
// ViewMapping; additional checks for extra arguments beyond rank are 0
template <unsigned, typename iType0, class MapType>
FLARE_INLINE_FUNCTION bool dyn_rank_view_verify_operator_bounds(
...
template <typename MemorySpace, typename iType0, typename iType1, class MapType,
          class... Args>
FLARE_INLINE_FUNCTION void dyn_rank_view_verify_operator_bounds(
  ...
  if (!dyn_rank_view_verify_operator_bounds<0>(rank, map, args...)) {
    ...
    FLARE_IF_ON_DEVICE(
        ((void)tracker; flare::abort("DynRankView bounds error");))
  }
}
...
class ViewMapping<
                      ...
                      (std::is_same<typename DstTraits::array_layout,
                       ...
                       ((std::is_same<typename DstTraits::array_layout,
                        ...
                        (std::is_same<typename SrcTraits::array_layout,
                         ...
                         std::is_same<typename SrcTraits::array_layout,
                                      flare::LayoutStride>::value)))),
                     flare::detail::ViewToDynRankViewTag>> {
 private:
  enum {
 ...
 public:
  ...
  FLARE_INLINE_FUNCTION static void assign(
      flare::DynRankView<DT, DP...>& dst, const flare::View<ST, SP...>& src) {
    static_assert(
        is_assignable_value_type,
...
/* \class DynRankView
 * \brief Container that creates a flare view with rank determined at runtime.
...
struct is_dyn_rank_view<flare::DynRankView<D, P...>> : public std::true_type {
};
...
#define FLARE_IMPL_VIEW_OPERATOR_VERIFY(ARG)                             \
  flare::detail::runtime_check_memory_access_violation<                    \
      typename traits::memory_space>(                                     \
      "flare::DynRankView ERROR: attempt to access inaccessible memory " \
      "space");                                                           \
  flare::detail::dyn_rank_view_verify_operator_bounds<                     \
      typename traits::memory_space>                                      \
      ARG;
...
#define FLARE_IMPL_VIEW_OPERATOR_VERIFY(ARG)                             \
 ...
 public:
  ...
  reference_type operator()() const {
    FLARE_IMPL_VIEW_OPERATOR_VERIFY((0, this->rank(), m_track, m_map))
  ...
  operator[](const iType& i0) const {
    ...
    // elements in the allocation FLARE_IMPL_VIEW_OPERATOR_VERIFY( (1 ,
  ...
  operator[](const iType& i0) const {
    ...
    using tmp_view_type = flare::View<
  ...
  FLARE_INLINE_FUNCTION
      std::enable_if_t<(std::is_void<typename traits::specialize>::value &&
                       ...
                       reference_type>
      operator()(const iType& i0) const {
    FLARE_IMPL_VIEW_OPERATOR_VERIFY((1, this->rank(), m_track, m_map, i0))
  ...
  operator()(const iType0& i0, const iType1& i1) const {
    FLARE_IMPL_VIEW_OPERATOR_VERIFY((2, this->rank(), m_track, m_map, i0, i1))
  ...
  operator()(const iType0& i0, const iType1& i1, const iType2& i2) const {
    FLARE_IMPL_VIEW_OPERATOR_VERIFY(
...
#undef FLARE_IMPL_VIEW_OPERATOR_VERIFY
  ...
  FLARE_INLINE_FUNCTION DynRankView(const DynRankView<RT, RP...>& rhs)
  ...
  template <class RT, class... RP>
  FLARE_INLINE_FUNCTION DynRankView& operator=(
  ...
  template <class RT, class... RP>
  FLARE_INLINE_FUNCTION DynRankView(const View<RT, RP...>& rhs)
      : m_track(), m_map(), m_rank(View<RT, RP...>::rank()) {
    using SrcTraits = typename View<RT, RP...>::traits;
    using Mapping =
        flare::detail::ViewMapping<traits, SrcTraits,
                                  flare::detail::ViewToDynRankViewTag>;
    static_assert(Mapping::is_assignable,
  ...
  template <class RT, class... RP>
  FLARE_INLINE_FUNCTION DynRankView& operator=(const View<RT, RP...>& rhs) {
    using SrcTraits = typename View<RT, RP...>::traits;
    using Mapping =
        flare::detail::ViewMapping<traits, SrcTraits,
                                  flare::detail::ViewToDynRankViewTag>;
  ...
  explicit inline DynRankView(
      const flare::detail::ViewCtorProp<P...>& arg_prop,
      std::enable_if_t<!flare::detail::ViewCtorProp<P...>::has_pointer,
    ...
    flare::detail::SharedAllocationRecord<>* record = m_map.allocate_shared(
        ...
        detail::ViewCtorProp<P...>::has_execution_space);
  ...
  // Wrappers
  template <class... P>
  explicit FLARE_INLINE_FUNCTION DynRankView(
      const flare::detail::ViewCtorProp<P...>& arg_prop,
      std::enable_if_t<flare::detail::ViewCtorProp<P...>::has_pointer,
                       typename traits::array_layout> const& arg_layout)
  ...
  explicit inline DynRankView(
      ...
      std::enable_if_t<flare::detail::is_view_label<Label>::value,
                       typename traits::array_layout> const& arg_layout)
      : DynRankView(flare::detail::ViewCtorProp<std::string>(arg_label),
                    arg_layout) {}
  ...
  explicit inline DynRankView(
      ...
      const size_t arg_N7 = FLARE_INVALID_INDEX)
      : DynRankView(
            flare::detail::ViewCtorProp<std::string>(arg_label),
  ...
  explicit FLARE_INLINE_FUNCTION DynRankView(
      ...
      const size_t arg_N6 = FLARE_INVALID_INDEX,
      const size_t arg_N7 = FLARE_INVALID_INDEX)
      : DynRankView(flare::detail::ViewCtorProp<pointer_type>(arg_ptr), arg_N0,
                    arg_N1, arg_N2, arg_N3, arg_N4, arg_N5, arg_N6, arg_N7) {}

  explicit FLARE_INLINE_FUNCTION DynRankView(
      pointer_type arg_ptr, typename traits::array_layout& arg_layout)
      : DynRankView(flare::detail::ViewCtorProp<pointer_type>(arg_ptr),
                    arg_layout) {}
  ...
  explicit FLARE_INLINE_FUNCTION DynRankView(
      ...
      : DynRankView(
            flare::detail::ViewCtorProp<pointer_type>(
...
class ViewMapping<
    std::enable_if_t<(std::is_void<typename SrcTraits::specialize>::value &&
                      (std::is_same<typename SrcTraits::array_layout,
                       ...
                       std::is_same<typename SrcTraits::array_layout,
                                    flare::LayoutStride>::value)),
                     flare::detail::DynRankSubviewTag>,
    SrcTraits, Args...> {
 private:
  enum {
    RZ = false,
 ...
 public:
  using traits_type = flare::ViewTraits<data_type, array_layout,
                                         typename SrcTraits::device_type,
                                         typename SrcTraits::memory_traits>;

  using type =
      flare::View<data_type, array_layout, typename SrcTraits::device_type,
                   typename SrcTraits::memory_traits>;
  ...
  struct apply {
    ...
    using traits_type =
        flare::ViewTraits<data_type, array_layout,
                           typename SrcTraits::device_type, MemoryTraits>;

    using type = flare::View<data_type, array_layout,
                              typename SrcTraits::device_type, MemoryTraits>;
  };
  ...
  using ret_type = flare::DynRankView<value_type, array_layout,
                                       typename SrcTraits::device_type,
                                       typename SrcTraits::memory_traits>;

  template <typename T, class... P>
  FLARE_INLINE_FUNCTION static ret_type subview(
      const unsigned src_rank, flare::DynRankView<T, P...> const& src,
      Args... args) {
    ...
    using dst_offset_type = ViewOffset<DstDimType, flare::LayoutStride>;
...
using Subdynrankview =
    typename flare::detail::ViewMapping<flare::detail::DynRankSubviewTag, V,
                                       Args...>::ret_type;

template <class D, class... P, class... Args>
FLARE_INLINE_FUNCTION Subdynrankview<ViewTraits<D*******, P...>, Args...>
subdynrankview(const flare::DynRankView<D, P...>& src, Args... args) {
  ...
  using metafcn =
      flare::detail::ViewMapping<flare::detail::DynRankSubviewTag,
                                flare::ViewTraits<D*******, P...>, Args...>;
...
template <class D, class... P, class... Args>
FLARE_INLINE_FUNCTION Subdynrankview<ViewTraits<D*******, P...>, Args...>
subview(const flare::DynRankView<D, P...>& src, Args... args) {
...
FLARE_INLINE_FUNCTION bool operator==(const DynRankView<LT, LP...>& lhs,
                                       const DynRankView<RT, RP...>& rhs) {
...
struct DynRankViewFill {
  ...
  DynRankViewFill(const OutputView& arg_out, const_value_type& arg_in)
    ...
    flare::parallel_for("flare::DynRankViewFill", Policy(0, output.extent(0)),
                         *this);
  }
};
...
struct DynRankViewFill<OutputView, std::enable_if_t<OutputView::rank == 0>> {
  DynRankViewFill(const OutputView& dst,
    ...
    flare::detail::DeepCopy<typename OutputView::memory_space,
                           flare::HostSpace>(
...
struct DynRankViewRemap {
  ...
  DynRankViewRemap(const ExecSpace& exec_space, const OutputView& arg_out,
    ...
    flare::parallel_for("flare::DynRankViewRemap", Policy(exec_space, 0, n0),
                         *this);
  }
  ...
  DynRankViewRemap(const OutputView& arg_out, const InputView& arg_in)
    ...
    flare::parallel_for("flare::DynRankViewRemap", Policy(0, n0), *this);
  }
...
FLARE_FUNCTION auto as_view_of_rank_n(
  ...
  if (v.rank() != N) {
    ...
    FLARE_IF_ON_DEVICE(
        flare::abort("Converting DynRankView to a View of mis-matched rank!");)
  }
...
template <typename D, class... P>
FLARE_INLINE_FUNCTION constexpr auto DynRankView<D, P...>::layout() const ->
    typename traits::array_layout {
  switch (rank()) {
    case 0: return detail::as_view_of_rank_n<0>(*this).layout();
    case 1: return detail::as_view_of_rank_n<1>(*this).layout();
    case 2: return detail::as_view_of_rank_n<2>(*this).layout();
    case 3: return detail::as_view_of_rank_n<3>(*this).layout();
    case 4: return detail::as_view_of_rank_n<4>(*this).layout();
    case 5: return detail::as_view_of_rank_n<5>(*this).layout();
    case 6: return detail::as_view_of_rank_n<6>(*this).layout();
    case 7: return detail::as_view_of_rank_n<7>(*this).layout();
    default:
      FLARE_IF_ON_HOST(
          flare::abort(
              std::string(
...
inline void deep_copy(
    ...
    std::enable_if_t<std::is_same<typename ViewTraits<DT, DP...>::specialize,
                                  void>::value>* = nullptr) {
  detail::apply_to_view_of_static_rank([=](auto view) { deep_copy(view, value); },
                                     dst);
}
...
inline void deep_copy(
    ...
    std::enable_if_t<std::is_same<typename ViewTraits<ST, SP...>::specialize,
                                  void>::value>* = 0) {
  deep_copy(e, dst, detail::as_view_of_rank_n<0>(src));
}
...
inline void deep_copy(
    ...
    std::enable_if_t<std::is_same<typename ViewTraits<ST, SP...>::specialize,
                                  void>::value>* = 0) {
  deep_copy(dst, detail::as_view_of_rank_n<0>(src));
}
...
inline void deep_copy(
    ...
    std::enable_if_t<
        (std::is_void<typename DstType::traits::specialize>::value &&
         ...
         (flare::is_dyn_rank_view<DstType>::value ||
          flare::is_dyn_rank_view<SrcType>::value))>* = nullptr) {
  static_assert(
  ...
  switch (rank(dst)) {
    case 0:
      deep_copy(exec_space, detail::as_view_of_rank_n<0>(dst),
                detail::as_view_of_rank_n<0>(src));
      break;
    case 1:
      deep_copy(exec_space, detail::as_view_of_rank_n<1>(dst),
                detail::as_view_of_rank_n<1>(src));
      break;
    case 2:
      deep_copy(exec_space, detail::as_view_of_rank_n<2>(dst),
                detail::as_view_of_rank_n<2>(src));
      break;
    case 3:
      deep_copy(exec_space, detail::as_view_of_rank_n<3>(dst),
                detail::as_view_of_rank_n<3>(src));
      break;
    case 4:
      deep_copy(exec_space, detail::as_view_of_rank_n<4>(dst),
                detail::as_view_of_rank_n<4>(src));
      break;
    case 5:
      deep_copy(exec_space, detail::as_view_of_rank_n<5>(dst),
                detail::as_view_of_rank_n<5>(src));
      break;
    case 6:
      deep_copy(exec_space, detail::as_view_of_rank_n<6>(dst),
                detail::as_view_of_rank_n<6>(src));
      break;
    case 7:
      deep_copy(exec_space, detail::as_view_of_rank_n<7>(dst),
                detail::as_view_of_rank_n<7>(src));
      break;
    default:
      flare::detail::throw_runtime_exception(
...
inline void deep_copy(
  ...
  switch (rank(dst)) {
    case 0:
      deep_copy(detail::as_view_of_rank_n<0>(dst),
                detail::as_view_of_rank_n<0>(src));
      break;
    case 1:
      deep_copy(detail::as_view_of_rank_n<1>(dst),
                detail::as_view_of_rank_n<1>(src));
      break;
    case 2:
      deep_copy(detail::as_view_of_rank_n<2>(dst),
                detail::as_view_of_rank_n<2>(src));
      break;
    case 3:
      deep_copy(detail::as_view_of_rank_n<3>(dst),
                detail::as_view_of_rank_n<3>(src));
      break;
    case 4:
      deep_copy(detail::as_view_of_rank_n<4>(dst),
                detail::as_view_of_rank_n<4>(src));
      break;
    case 5:
      deep_copy(detail::as_view_of_rank_n<5>(dst),
                detail::as_view_of_rank_n<5>(src));
      break;
    case 6:
      deep_copy(detail::as_view_of_rank_n<6>(dst),
                detail::as_view_of_rank_n<6>(src));
      break;
    case 7:
      deep_copy(detail::as_view_of_rank_n<7>(dst),
                detail::as_view_of_rank_n<7>(src));
      break;
    default:
      flare::detail::throw_runtime_exception(
...
struct MirrorDRViewType {
  ...
  using src_view_type = typename flare::DynRankView<T, P...>;
  ...
  using dest_view_type = flare::DynRankView<data_type, array_layout, Space>;
...
struct MirrorDRVType {
  ...
  using data_type = typename src_view_type::non_const_data_type;
  // The destination view type if it is not the same memory space
  using view_type = flare::DynRankView<data_type, array_layout, Space>;
};
...
inline typename DynRankView<T, P...>::HostMirror create_mirror(
    ...
    std::enable_if_t<!detail::ViewCtorProp<ViewCtorArgs...>::has_memory_space>* =
        nullptr) {
  ...
  static_assert(
      ...
      "The view constructor arguments passed to flare::create_mirror "
      "must not include a label!");
  static_assert(
      !alloc_prop_input::has_pointer,
      "The view constructor arguments passed to flare::create_mirror must "
...
inline typename DynRankView<T, P...>::HostMirror create_mirror(
    ...
    std::enable_if_t<std::is_same<typename ViewTraits<T, P...>::specialize,
                                  void>::value>* = nullptr) {
  return detail::create_mirror(src, flare::detail::ViewCtorProp<>{});
}

template <class T, class... P>
inline typename DynRankView<T, P...>::HostMirror create_mirror(
    flare::detail::WithoutInitializing_t wi, const DynRankView<T, P...>& src,
    std::enable_if_t<std::is_same<typename ViewTraits<T, P...>::specialize,
                                  void>::value>* = nullptr) {
  return detail::create_mirror(src, flare::view_alloc(wi));
}
...
inline typename DynRankView<T, P...>::HostMirror create_mirror(
    ...
    std::enable_if_t<
        ...
        !detail::ViewCtorProp<ViewCtorArgs...>::has_memory_space>* = nullptr) {
...
template <class Space, class T, class... P,
          typename Enable = std::enable_if_t<
              ...
              std::is_void<typename ViewTraits<T, P...>::specialize>::value>>
typename detail::MirrorDRVType<Space, T, P...>::view_type create_mirror(
    const Space&, const flare::DynRankView<T, P...>& src) {
  return detail::create_mirror(
      src, flare::view_alloc(typename Space::memory_space{}));
}

template <class Space, class T, class... P>
typename detail::MirrorDRVType<Space, T, P...>::view_type create_mirror(
    flare::detail::WithoutInitializing_t wi, const Space&,
    const flare::DynRankView<T, P...>& src,
    std::enable_if_t<std::is_same<typename ViewTraits<T, P...>::specialize,
                                  void>::value>* = nullptr) {
  return detail::create_mirror(
      src, flare::view_alloc(wi, typename Space::memory_space{}));
}
...
create_mirror_view(const DynRankView<T, P...>& src,
                   const typename detail::ViewCtorProp<ViewCtorArgs...>&) {
  return src;
}
...
create_mirror_view(
    const DynRankView<T, P...>& src,
    const typename detail::ViewCtorProp<ViewCtorArgs...>& arg_prop) {
...
inline std::enable_if_t<
    flare::is_space<
        typename detail::ViewCtorProp<ViewCtorArgs...>::memory_space>::value &&
        detail::MirrorDRViewType<
            typename detail::ViewCtorProp<ViewCtorArgs...>::memory_space, T,
            P...>::is_same_memspace,
    typename detail::MirrorDRViewType<
        typename detail::ViewCtorProp<ViewCtorArgs...>::memory_space, T,
        P...>::view_type>
create_mirror_view(const flare::DynRankView<T, P...>& src,
                   const typename detail::ViewCtorProp<ViewCtorArgs...>&) {
  return src;
}
...
template <class T, class... P>
inline auto create_mirror_view(flare::detail::WithoutInitializing_t wi,
                               const DynRankView<T, P...>& src) {
  return detail::create_mirror_view(src, flare::view_alloc(wi));
}
...
inline typename detail::MirrorDRViewType<Space, T, P...>::view_type
create_mirror_view(
    const Space&, const flare::DynRankView<T, P...>& src,
    std::enable_if_t<
        detail::MirrorDRViewType<Space, T, P...>::is_same_memspace>* = nullptr) {
  return src;
}
...
inline typename detail::MirrorDRViewType<Space, T, P...>::view_type
create_mirror_view(
    const Space& space, const flare::DynRankView<T, P...>& src,
    std::enable_if_t<
        !detail::MirrorDRViewType<Space, T, P...>::is_same_memspace>* = nullptr) {
...
inline auto create_mirror_view(flare::detail::WithoutInitializing_t wi,
  ...
  return detail::create_mirror_view(
      src, flare::view_alloc(typename Space::memory_space{}, wi));
}
...
inline auto create_mirror_view(
    const typename detail::ViewCtorProp<ViewCtorArgs...>& arg_prop,
    const flare::DynRankView<T, P...>& src) {
  return detail::create_mirror_view(src, arg_prop);
}
...
auto create_mirror_view_and_copy(
  ...
  using Mirror = typename detail::MirrorDRViewType<Space, T, P...>::view_type;
 ...
 * indices. */
template <class... ViewCtorArgs, class T, class... P>
inline void impl_resize(const detail::ViewCtorProp<ViewCtorArgs...>& arg_prop,
  ...
  if constexpr (alloc_prop_input::has_execution_space)
    flare::detail::DynRankViewRemap<drview_type, drview_type>(
        detail::get_property<detail::ExecutionSpaceTag>(prop_copy), v_resized, v);
  else {
    flare::detail::DynRankViewRemap<drview_type, drview_type>(v_resized, v);
    flare::fence("flare::resize(DynRankView)");
  }
  v = v_resized;
}
...
template <class... ViewCtorArgs, class T, class... P>
void resize(const detail::ViewCtorProp<ViewCtorArgs...>& arg_prop,
            DynRankView<T, P...>& v,
...
inline std::enable_if_t<detail::is_view_ctor_property<I>::value> resize(
...
template <class T, class... P, class... ViewCtorArgs>
inline void realloc(const detail::ViewCtorProp<ViewCtorArgs...>& arg_prop,
                    DynRankView<T, P...>& v,
                    const size_t n0 = FLARE_INVALID_INDEX,
                    const size_t n1 = FLARE_INVALID_INDEX,
                    const size_t n2 = FLARE_INVALID_INDEX,
