...
//
#ifndef FLARE_SIMD_ARCH_NEON64_H_
#define FLARE_SIMD_ARCH_NEON64_H_
...
#include <flare/simd/types/neon64_register.h>
...
#define flare_simd_aligned_load(inst, type, expr) inst((type)expr)
        ...
        {
            return flare_simd_aligned_load(vld1q_f64, double*, src);
        }
...
#undef WRAP_REDUCER_FLOAT
        ...
        namespace detail
        {
            ...
            inline batch<double, A> extract_pair(batch<double, A> const& lhs, batch<double, A> const& rhs, std::size_t n,
                                                 ::flare::simd::detail::index_sequence<I, Is...>) noexcept
            {
                if (n == I)
                {
        ...
        inline batch<double, A> extract_pair(batch<double, A> const& lhs, batch<double, A> const& rhs, std::size_t n, requires_arch<neon64>) noexcept
        {
            ...
            return detail::extract_pair(lhs, rhs, n, ::flare::simd::detail::make_index_sequence<size>());
        }
...
#undef WRAP_CAST
    ...
    namespace kernel
    {
        ...
        namespace detail
        {
            using ::flare::simd::batch_constant;
            using ::flare::simd::detail::integer_sequence;
            using ::flare::simd::detail::make_integer_sequence;
...
#endif  // FLARE_SIMD_ARCH_NEON64_H_
