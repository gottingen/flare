...
//
#ifndef FLARE_SIMD_ARCH_AVX512F_H_
#define FLARE_SIMD_ARCH_AVX512F_H_

#include <complex>
#include <limits>
#include <type_traits>
#include "../types/avx512f_register.h"
...
namespace flare::simd {
    ...
    namespace kernel {
        ...
        inline batch<float, A> haddp(batch<float, A> const* row, requires_arch<avx512f>) noexcept
        {
            ...
            // tmp1 = [a0..8, b0..8]
            // tmp2 = [a8..f, b8..f]
#define FLARE_SIMD_AVX512_HADDP_STEP1(I, a, b)                                \
    ...
    {                                                                    \
        ...
        res##I = _mm512_add_ps(tmp1, tmp2);                              \
            ...
            FLARE_SIMD_AVX512_HADDP_STEP1(0, row[0], row[2]);
            FLARE_SIMD_AVX512_HADDP_STEP1(1, row[4], row[6]);
            FLARE_SIMD_AVX512_HADDP_STEP1(2, row[1], row[3]);
            FLARE_SIMD_AVX512_HADDP_STEP1(3, row[5], row[7]);
            FLARE_SIMD_AVX512_HADDP_STEP1(4, row[8], row[10]);
            FLARE_SIMD_AVX512_HADDP_STEP1(5, row[12], row[14]);
            FLARE_SIMD_AVX512_HADDP_STEP1(6, row[9], row[11]);
            FLARE_SIMD_AVX512_HADDP_STEP1(7, row[13], row[15]);

#undef FLARE_SIMD_AVX512_HADDP_STEP1
...
#define FLARE_SIMD_AVX512_HADDP_STEP2(I, a, b, c, d)                                                                                                         \
    ...
    {                                                                                                                                                   \
        ...
        halfx##I = _mm256_hadd_ps(_mm256_insertf128_ps(_mm256_castps128_ps256(_mm512_extractf32x4_ps(resx3, 0)), _mm512_extractf32x4_ps(resx3, 1), 1),  \
            ...
            FLARE_SIMD_AVX512_HADDP_STEP2(0, res0, res1, res2, res3);
            FLARE_SIMD_AVX512_HADDP_STEP2(1, res4, res5, res6, res7);

#undef FLARE_SIMD_AVX512_HADDP_STEP2
...
#endif  // FLARE_SIMD_ARCH_AVX512F_H_
