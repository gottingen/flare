...
//
#ifndef FLARE_SIMD_ARCH_GENERIC_TRIGO_H_
#define FLARE_SIMD_ARCH_GENERIC_TRIGO_H_
                ...
                static inline B reduce(const B& x, B& xr) noexcept
                {
                    ...
                    else
                    {
                        ...
                        for (std::size_t i = 0; i < size; ++i)
                        {
                            ...
                            {
                                double y[2];
                                std::int32_t n = ::flare::simd::detail::__ieee754_rem_pio2(arg, y);
...
#endif  // FLARE_SIMD_ARCH_GENERIC_TRIGO_H_
