...
//
#ifndef FLARE_SIMD_ARCH_GENERIC_MATH_H_
#define FLARE_SIMD_ARCH_GENERIC_MATH_H_

#include <flare/simd/arch/scalar.h>
#include <flare/simd/arch/generic/details.h>
#include <flare/simd/arch/generic/trigo.h>
...
namespace flare::simd {
    ...
    namespace kernel {
        ...
        inline batch<float, A> cbrt(batch<float, A> const& self, requires_arch<generic>) noexcept
        {
...
#ifndef FLARE_SIMD_NO_DENORMALS
            ...
            x = x | bitofsign(self);
#endif
#ifndef FLARE_SIMD_NO_INFINITIES
...
#ifndef FLARE_SIMD_NO_INFINITIES
            r1 = select(flare::simd::isinf(self), sign(self), r1);
#endif
            return r1;
        }
...
#ifndef FLARE_SIMD_NO_INFINITIES
            z = select(flare::simd::isinf(self), sign(self), z);
#endif
        ...
        namespace detail
        {
            ...
            private:
                ...
                inline B eval(::flare::simd::detail::index_sequence<Is...>, const Tuple& tuple)
                {
                ...
                {
                    return eval(::flare::simd::detail::make_index_sequence<sizeof...(Args)>(), tuple);
                }
        ...
        namespace detail
        {
            ...
            static inline batch<float, A> expm1(const batch<float, A>& a) noexcept
            {
                ...
                using i_type = as_integer_t<batch_type>;
                i_type ik = to_int(k);
                batch_type two2mk = ::flare::simd::bitwise_cast<float>((constants::maxexponent<batch_type>() - ik) << constants::nmb<batch_type>());
            ...
            static inline batch<double, A> expm1(const batch<double, A>& a) noexcept
            {
                ...
                using i_type = as_integer_t<batch_type>;
                i_type ik = to_int(k);
                batch_type two2mk = ::flare::simd::bitwise_cast<double>((constants::maxexponent<batch_type>() - ik) << constants::nmb<batch_type>());
        ...
        inline batch<T, A> frexp(const batch<T, A>& self, batch<as_integer_t<T>, A>& exp, requires_arch<generic>) noexcept
        {
            ...
            i_type r1 = m1f & ::flare::simd::bitwise_cast<int_type>(self);
            batch_type x = self & ::flare::simd::bitwise_cast<T>(~m1f);
            ...
            return select((self != batch_type(0.)), x | ::flare::simd::bitwise_cast<T>(constants::mask2frexp<batch_type>()), batch_type(0.));
        }
        ...
        {
            return ::flare::simd::detail::ipow(self, other);
        }
        ...
        inline batch<T, A> ldexp(const batch<T, A>& self, const batch<as_integer_t<T>, A>& other, requires_arch<generic>) noexcept
        {
            ...
            return self * ::flare::simd::bitwise_cast<T>(ik);
        }
...
#endif
            i_type ix = ::flare::simd::bitwise_cast<int_type>(x);
            ix += 0x3f800000 - 0x3f3504f3;
            k += (ix >> 23) - 0x7f;
            ix = (ix & i_type(0x007fffff)) + 0x3f3504f3;
            x = ::flare::simd::bitwise_cast<float>(ix);
            batch_type f = --x;
        ...
        inline batch<double, A> log(batch<double, A> const& self, requires_arch<generic>) noexcept
        {
            ...
            batch_type x = self;
            i_type hx = ::flare::simd::bitwise_cast<int_type>(x) >> 32;
            i_type k(0);
            auto isnez = (self != batch_type(0.));
#ifndef FLARE_SIMD_NO_DENORMALS
            auto test = (self < constants::smallestposval<batch_type>()) && isnez;
            ...
            x = ::flare::simd::bitwise_cast<double>(hx << 32 | (i_type(0xffffffff) & ::flare::simd::bitwise_cast<int_type>(x)));
        ...
        inline batch<double, A> log2(batch<double, A> const& self, requires_arch<generic>) noexcept
        {
            ...
            hi = hi & ::flare::simd::bitwise_cast<double>((constants::allbits<i_type>() << 32));
        ...
        inline batch<float, A> log10(batch<float, A> const& self, requires_arch<generic>) noexcept
        {
            ...
            hibits &= ::flare::simd::bitwise_cast<float>(i_type(0xfffff000));
        ...
        inline batch<float, A> log1p(batch<float, A> const& self, requires_arch<generic>) noexcept
        {
            ...
            i_type iu = ::flare::simd::bitwise_cast<int_type>(uf);
            iu += 0x3f800000 - 0x3f3504f3;
            i_type k = (iu >> 23) - 0x7f;
            iu = (iu & i_type(0x007fffff)) + 0x3f3504f3;
            batch_type f = --(::flare::simd::bitwise_cast<float>(iu));
            batch_type s = f / (batch_type(2.) + f);
            batch_type z = s * s;
            batch_type w = z * z;
            batch_type t1 = w * detail::horner<batch_type, 0x3eccce13, 0x3e789e26>(w);
        ...
        inline batch<double, A> log1p(batch<double, A> const& self, requires_arch<generic>) noexcept
        {
            ...
            const batch_type uf = self + batch_type(1.);
            auto isnez = (uf != batch_type(0.));
            i_type hu = ::flare::simd::bitwise_cast<int_type>(uf) >> 32;
            ...
            batch_type f = ::flare::simd::bitwise_cast<double>((hu << 32) | (i_type(0xffffffff) & ::flare::simd::bitwise_cast<int_type>(uf)));
            f = --f;
            batch_type hfsq = batch_type(0.5) * f * f;
            batch_type s = f / (batch_type(2.) + f);
            batch_type z = s * s;
        ...
        namespace detail
        {
            ...
            struct nextafter_kernel<T, A, false>
            {
                ...
                {
                    batch_type n = ::flare::simd::bitwise_cast<T>(::flare::simd::bitwise_cast<int_type>(b) + int_type(1));
                    return select(b == constants::infinity<batch_type>(), b, n);
                }

                static inline batch_type prev(const batch_type& b) noexcept
                {
                    batch_type p = ::flare::simd::bitwise_cast<T>(::flare::simd::bitwise_cast<int_type>(b) - int_type(1));
        ...
        inline batch<std::complex<T>, A> sqrt(batch<std::complex<T>, A> const& z, requires_arch<generic>) noexcept
        {
            ...
            real_batch t0 = select(condxp, flare::simd::sqrt(0.5 * (r + x)), flare::simd::sqrt(0.5 * (r - x)));
...
#endif  // FLARE_SIMD_ARCH_GENERIC_MATH_H_
