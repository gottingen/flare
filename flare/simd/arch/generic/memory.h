...
//
#ifndef FLARE_SIMD_ARCH_GENERIC_MEMORY_H_
#define FLARE_SIMD_ARCH_GENERIC_MEMORY_H_
...
namespace flare::simd {
    ...
    namespace kernel {
        ...
        namespace detail
        {
            ...
            template <size_t N, typename T, typename A, typename U, typename V, typename std::enable_if<N != 0, int>::type = 0>
            inline batch<T, A>
            gather(U const* src, batch<V, A> const& index, ::flare::simd::index<N> I) noexcept
            {
        ...
        inline T get(batch<T, A> const& self, ::flare::simd::index<I>, requires_arch<generic>) noexcept
        {
        ...
        template <class A, size_t I, class T>
        inline T get(batch_bool<T, A> const& self, ::flare::simd::index<I>, requires_arch<generic>) noexcept
        {
        ...
        template <class A, size_t I, class T>
        inline auto get(batch<std::complex<T>, A> const& self, ::flare::simd::index<I>, requires_arch<generic>) noexcept -> typename batch<std::complex<T>, A>::value_type
        {
...
#endif  // FLARE_SIMD_ARCH_GENERIC_MEMORY_H_
