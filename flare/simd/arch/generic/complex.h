...
//
#ifndef FLARE_SIMD_ARCH_GENERIC_COMPLEX_H_
#define FLARE_SIMD_ARCH_GENERIC_COMPLEX_H_
...
namespace flare::simd {
    ...
    namespace kernel {
        ...
        inline complex_batch_type_t<batch<T, A>> proj(batch<T, A> const &self, requires_arch<generic>) noexcept {
            ...
            auto cond = flare::simd::isinf(real(self)) || flare::simd::isinf(imag(self));
            return select(cond,
...
#endif  // FLARE_SIMD_ARCH_GENERIC_COMPLEX_H_
