...
//
#ifndef FLARE_SIMD_ARCH_GENERIC_DETAILS_H_
#define FLARE_SIMD_ARCH_GENERIC_DETAILS_H_
...
namespace flare::simd {
    ...
    namespace kernel {
        ...
        namespace detail {
            ...
            using flare::simd::detail::void_t;
...
#endif  // FLARE_SIMD_ARCH_GENERIC_DETAILS_H_
