...
namespace flare::simd {
    ...
    template <>
    struct fma3<avx> : avx {
        static constexpr bool supported() noexcept { return FLARE_SIMD_ENABLE_FMA3_AVX; }
    ...
    namespace types {
        ...
        FLARE_SIMD_DECLARE_SIMD_REGISTER_ALIAS(fma3<avx>, avx);
...
#endif  // FLARE_SIMD_TYPES_FMA3_AVX_REGISTER_H_
