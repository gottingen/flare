...
#ifndef FLARE_SIMD_TYPES_TRAITS_H_
#define FLARE_SIMD_TYPES_TRAITS_H_
...
namespace flare::simd {
    ...
    namespace detail {
        ...
        struct static_check_supported_config_emitter {
            ...
            static_assert(!A::supported() || flare::simd::has_simd_register<T, A>::value,
    ...
    template<class T>
    struct simd_traits : detail::simd_traits_impl<T, flare::simd::has_simd_register<T>::value> {
    };

    template<class T>
    struct simd_traits<std::complex<T>>
            : detail::simd_traits_impl<std::complex<T>, flare::simd::has_simd_register<T>::value> {
    };
...
#endif  // FLARE_SIMD_TYPES_TRAITS_H_
