...
//
#ifndef FLARE_SIMD_TYPES_NEON_REGISTER_H_
#define FLARE_SIMD_TYPES_NEON_REGISTER_H_
...
namespace flare::simd {
     ...
     */
    struct neon : generic {
        static constexpr bool supported() noexcept { return FLARE_SIMD_ENABLE_NEON; }
    ...
    namespace types {
        ...
        FLARE_SIMD_DECLARE_SIMD_REGISTER(signed char, neon, detail::neon_vector_type<signed char>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(unsigned char, neon, detail::neon_vector_type<unsigned char>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(char, neon, detail::char_neon_vector_type);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(short, neon, detail::neon_vector_type<short>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(unsigned short, neon, detail::neon_vector_type<unsigned short>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(int, neon, detail::neon_vector_type<int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(unsigned int, neon, detail::neon_vector_type<unsigned int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(long int, neon, detail::neon_vector_type<long int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(unsigned long int, neon, detail::neon_vector_type<unsigned long int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(long long int, neon, detail::neon_vector_type<long long int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(unsigned long long int, neon, detail::neon_vector_type<unsigned long long int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(float, neon, float32x4_t);
        FLARE_SIMD_DECLARE_INVALID_SIMD_REGISTER(double, neon);
...
#endif  // FLARE_SIMD_TYPES_NEON_REGISTER_H_
