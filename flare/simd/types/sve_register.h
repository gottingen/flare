...
//
#ifndef FLARE_SIMD_TYPES_SVE_REGISTER_H_
#define FLARE_SIMD_TYPES_SVE_REGISTER_H_

#include <flare/simd/types/generic_arch.h>
#include <flare/simd/types/register.h>
...
namespace flare::simd {
    namespace detail {
        ...
        struct sve : flare::simd::generic
        {
            static constexpr bool supported() noexcept { return Width == FLARE_SIMD_SVE_BITS; }
...
#undef SVE_TO_FIXED_SIZE
        ...
        FLARE_SIMD_DECLARE_SIMD_REGISTER(signed char, sve, detail::sve_vector_type<signed char>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(unsigned char, sve, detail::sve_vector_type<unsigned char>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(char, sve, detail::sve_vector_type<char>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(short, sve, detail::sve_vector_type<short>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(unsigned short, sve, detail::sve_vector_type<unsigned short>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(int, sve, detail::sve_vector_type<int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(unsigned int, sve, detail::sve_vector_type<unsigned int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(long int, sve, detail::sve_vector_type<long int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(unsigned long int, sve, detail::sve_vector_type<unsigned long int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(long long int, sve, detail::sve_vector_type<long long int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(unsigned long long int, sve, detail::sve_vector_type<unsigned long long int>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(float, sve, detail::sve_vector_type<float>);
        FLARE_SIMD_DECLARE_SIMD_REGISTER(double, sve, detail::sve_vector_type<double>);
...
#endif  // FLARE_SIMD_TYPES_SVE_REGISTER_H_
