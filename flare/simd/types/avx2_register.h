...
namespace flare::simd {
     ...
     */
    struct avx2 : avx {
        static constexpr bool supported() noexcept { return FLARE_SIMD_ENABLE_AVX2; }
    ...
    namespace types {
        FLARE_SIMD_DECLARE_SIMD_REGISTER_ALIAS(avx2, avx);
    }
#endif
}

#endif  // FLARE_SIMD_TYPES_AVX2_REGISTER_H_
