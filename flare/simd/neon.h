...
#ifndef FLARE_SIMD_NEON_H_
#define FLARE_SIMD_NEON_H_
...
class neon_mask<Derived, 64> {
 ...
 public:
  class reference {
   ...
   public:
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference(uint64x2_t& mask_arg,
                                                    int lane_arg)
  ...
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION neon_mask() = default;
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION explicit neon_mask(value_type value)
  ...
  template <class G,
            std::enable_if_t<
                ...
                bool> = false>
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION constexpr explicit neon_mask(
      G&& gen) noexcept {
  ...
  template <class U>
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION neon_mask(
      neon_mask<U, 32> const& other) {
    operator[](0) = bool(other[0]);
    operator[](1) = bool(other[1]);
  }
  template <class U>
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION neon_mask(neon_mask<U, 64> const& other)
  ...
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION constexpr explicit neon_mask(
      ...
      : m_value(value_in) {}
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION constexpr explicit operator uint64x2_t()
      const {
    return m_value;
  }
  ...
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION Derived
  ...
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION Derived operator!() const {
...
class neon_mask<Derived, 32> {
 ...
 public:
  class reference {
   ...
   public:
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference(uint32x2_t& mask_arg,
                                                    int lane_arg)
        : m_mask(mask_arg), m_lane(lane_arg) {}
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference
    operator=(bool value) const {
  ...
  template <class U>
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION neon_mask(neon_mask<U, 32> const& other)
  ...
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION constexpr explicit neon_mask(
      ...
      : m_value(value_in) {}
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION constexpr explicit operator uint32x2_t()
      const {
    return m_value;
  }
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference operator[](std::size_t i) {
...
class simd_mask<T, simd_abi::neon_fixed_size<2>>
    : public detail::neon_mask<simd_mask<T, simd_abi::neon_fixed_size<2>>,
                             sizeof(T) * 8> {
  using base_type = detail::neon_mask<simd_mask<T, simd_abi::neon_fixed_size<2>>,
                                    sizeof(T) * 8>;

 public:
  using implementation_type = typename base_type::implementation_type;
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION simd_mask() = default;
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION explicit simd_mask(bool value)
      : base_type(value) {}
  template <class U>
...
class simd<double, simd_abi::neon_fixed_size<2>> {
 ...
 public:
  ...
  class reference {
   ...
   public:
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference(float64x2_t& mask_arg,
                                                    int lane_arg)
    ...
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION operator double() const {
      switch (m_lane) {
  ...
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION constexpr explicit
...
class simd<float, simd_abi::neon_fixed_size<2>> {
 ...
 public:
  ...
  class reference {
   ...
   public:
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference(float32x2_t& value_arg,
                                                    int lane_arg)
    ...
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION operator float() const {
      switch (m_lane) {
...
class simd<std::int32_t, simd_abi::neon_fixed_size<2>> {
 ...
 public:
  ...
  class reference {
   ...
   public:
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference(int32x2_t& value_arg,
                                                    int lane_arg)
        : m_value(value_arg), m_lane(lane_arg) {}
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference
    ...
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION operator std::int32_t() const {
      switch (m_lane) {
  ...
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION constexpr explicit operator int32x2_t()
      const {
    return m_value;
  }
...
class simd<std::int64_t, simd_abi::neon_fixed_size<2>> {
 ...
 public:
  ...
  class reference {
   ...
   public:
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference(int64x2_t& value_arg,
                                                    int lane_arg)
        : m_value(value_arg), m_lane(lane_arg) {}
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference
    ...
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION operator std::int64_t() const {
      switch (m_lane) {
  ...
  FLARE_IMPL_HOST_FORCEINLINE_FUNCTION constexpr explicit operator int64x2_t()
      const {
    return m_value;
  }
...
class simd<std::uint64_t, simd_abi::neon_fixed_size<2>> {
 ...
 public:
  ...
  class reference {
   ...
   public:
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference(uint64x2_t& value_arg,
                                                    int lane_arg)
        : m_value(value_arg), m_lane(lane_arg) {}
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION reference
    ...
    FLARE_IMPL_HOST_FORCEINLINE_FUNCTION operator std::uint64_t() const {
      switch (m_lane) {
