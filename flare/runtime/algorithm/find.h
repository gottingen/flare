...
//
#ifndef FLARE_RUNTIME_ALGORITHM_FIND_H_
#define FLARE_RUNTIME_ALGORITHM_FIND_H_

#include <flare/runtime/algorithm/launch.h>
...
Task flare::rt::FlowBuilder::find_if(B first, E last, T& result, UOP predicate, P&& part) {
...
template <typename B, typename E, typename T, typename UOP, typename P>
Task flare::rt::FlowBuilder::find_if_not(B first, E last, T& result, UOP predicate, P&& part) {
...
#endif  // FLARE_RUNTIME_ALGORITHM_FIND_H_
