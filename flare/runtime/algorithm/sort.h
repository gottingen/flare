...
//
#ifndef FLARE_RUNTIME_ALGORITHM_SORT_H_
#define FLARE_RUNTIME_ALGORITHM_SORT_H_

#include <flare/runtime/core/async.h>

namespace flare::rt::detail {
...
void parallel_3wqsort(flare::rt::Runtime& rt, RandItr first, RandItr last, C compare) {
  ...
  if(l - first > 1 && is_swapped_l) {
    //rt.emplace([&](flare::rt::Runtime& rtl) mutable {
  ...
  if(last - r > 1 && is_swapped_r) {
    //rt.emplace([&](flare::rt::Runtime& rtr) mutable {
...
#endif  // FLARE_RUNTIME_ALGORITHM_SORT_H_
