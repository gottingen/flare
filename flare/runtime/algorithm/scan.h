...
//
#ifndef FLARE_RUNTIME_ALGORITHM_SCAN_H_
#define FLARE_RUNTIME_ALGORITHM_SCAN_H_
...
TF_FORCE_INLINE auto make_inclusive_scan_task(B first, E last, D d_first, BOP bop) {
  ...
  return [=] (Runtime& rt) mutable {
    ...
    std::vector<flare::detail::CachelineAligned<value_type>> buf(W);
...
#endif  // FLARE_RUNTIME_ALGORITHM_SCAN_H_
