...
//
#ifndef FLARE_RUNTIME_CUDA_CUDA_EXECUTION_POLICY_H_
#define FLARE_RUNTIME_CUDA_CUDA_EXECUTION_POLICY_H_
...
class cudaExecutionPolicy {
  ...
  */
  ...
  The function is used to allocate a buffer for calling flare::rt::cuda_reduce,
  flare::rt::cuda_uninitialized_reduce, flare::rt::cuda_transform_reduce, and
  flare::rt::cuda_uninitialized_transform_reduce.
  */
  template <typename T>
  static unsigned reduce_bufsz(unsigned count);

  /**
  @brief queries the buffer size in bytes needed to call flare::rt::cuda_min_element
  ...
  */
  ...
  /**
  @brief queries the buffer size in bytes needed to call flare::rt::cuda_max_element
  ...
  */
  ...
  flare::rt::cuda_inclusive_scan, flare::rt::cuda_exclusive_scan,
  flare::rt::cuda_transform_inclusive_scan, and flare::rt::cuda_transform_exclusive_scan.
  */
  template <typename T>
  ...
  The function is used to allocate a buffer for calling
  flare::rt::cuda_merge and flare::rt::cuda_merge_by_key.
  */
...
#endif  // FLARE_RUNTIME_CUDA_CUDA_EXECUTION_POLICY_H_
