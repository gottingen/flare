...
//
#ifndef FLARE_RUNTIME_CUDA_CUDA_MEMORY_H_
#define FLARE_RUNTIME_CUDA_CUDA_MEMORY_H_

#include <flare/runtime/cuda/cuda_device.h>
...
#endif  // FLARE_RUNTIME_CUDA_CUDA_MEMORY_H_
