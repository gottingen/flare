...
//
#ifndef FLARE_RUNTIME_CUDA_CUDA_META_H_
#define FLARE_RUNTIME_CUDA_CUDA_META_H_

#include <flare/runtime/cuda/cuda_execution_policy.h>
...
#endif  // FLARE_RUNTIME_CUDA_CUDA_META_H_
