...
#ifndef FLARE_RUNTIME_CUDA_CUDA_STREAM_H_
#define FLARE_RUNTIME_CUDA_CUDA_STREAM_H_

#include <flare/runtime/cuda/cuda_object.h>
...
#endif  // FLARE_RUNTIME_CUDA_CUDA_STREAM_H_
