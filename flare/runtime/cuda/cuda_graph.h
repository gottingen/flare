...
//
#ifndef FLARE_RUNTIME_CUDA_CUDA_GRAPH_H_
#define FLARE_RUNTIME_CUDA_CUDA_GRAPH_H_

#include <flare/runtime/cuda/cuda_memory.h>
#include <flare/runtime/cuda/cuda_stream.h>
#include <flare/runtime/cuda/cuda_meta.h>
...
*/
    ...
    private:
        ...
        flare::detail::SmallVector<cudaFlowNode *> _successors;
        flare::detail::SmallVector<cudaFlowNode *> _dependents;
...
#endif  // FLARE_RUNTIME_CUDA_CUDA_GRAPH_H_
