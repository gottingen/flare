...
#ifndef FLARE_RUNTIME_CUDA_CUDAFLOW_H_
#define FLARE_RUNTIME_CUDA_CUDAFLOW_H_
#include <flare/runtime/taskflow.h>
#include <flare/runtime/cuda/cuda_task.h>
#include <flare/runtime/cuda/cuda_capturer.h>
...
taskflow.emplace([&](flare::rt::cudaFlow& cf){
  // create two kernel tasks
  flare::rt::cudaTask task1 = cf.kernel(grid1, block1, shm_size1, kernel1, args1);
  flare::rt::cudaTask task2 = cf.kernel(grid2, block2, shm_size2, kernel2, args2);
...
A %cudaFlow is a task (flare::rt::Task) created from flare::rt::Taskflow
and will be run by @em one worker thread in the executor.
That is, the callable that describes a %cudaFlow
will be executed sequentially.
Inside a %cudaFlow task, different GPU tasks (flare::rt::cudaTask) may run
...
class cudaFlow {
  ...
  public:
    ...
    */
    ...
    @return a flare::rt::cudaTask handle
    ...
    */
    ...
    The method is similar to flare::rt::cudaFlow::host but operates on a task
    of type flare::rt::cudaTaskType::HOST.
    */
    template <typename C>
    ...
    */
    ...
    The method is similar to flare::rt::cudaFlow::kernel but operates on a task
    of type flare::rt::cudaTaskType::KERNEL.
    ...
    */
    ...
    The method is similar to flare::rt::cudaFlow::memset but operates on a task
    of type flare::rt::cudaTaskType::MEMSET.
    ...
    */
    ...
    The method is similar to flare::rt::cudaFlow::memcpy but operates on a task
    of type flare::rt::cudaTaskType::MEMCPY.
    The source/destination memory may have different address values but
    must be allocated from the same contexts as the original
    source/destination memory.
    */
    ...
    */
    ...
    The method is similar to flare::rt::cudaFlow::zero but operates on
    a task of type flare::rt::cudaTaskType::MEMSET.
    ...
    */
    ...
    The method is similar to flare::rt::cudaFlow::fill but operates on a task
    of type flare::rt::cudaTaskType::MEMSET.
    ...
    */
    ...
    The method is similar to flare::rt::cudaFlow::copy but operates on a task
    of type flare::rt::cudaTaskType::MEMCPY.
    The source/destination memory may have different address values but
    must be allocated from the same contexts as the original
    source/destination memory.
    ...
    */
    ...
    @brief updates parameters of a kernel task created from
           flare::rt::cudaFlow::for_each

    The type of the iterators and the callable must be the same as
    the task created from flare::rt::cudaFlow::for_each.
    */
    template <typename I, typename C>
    ...
    */
    ...
    /**
    @brief updates parameters of a kernel task created from
           flare::rt::cudaFlow::for_each_index

    The type of the iterators and the callable must be the same as
    the task created from flare::rt::cudaFlow::for_each_index.
    */
    template <typename I, typename C>
    void for_each_index(
    ...
    */
    ...
    /**
    @brief constructs a subflow graph through flare::rt::cudaFlowCapturer

    @tparam C callable type constructible from
              @c std::function<void(flare::rt::cudaFlowCapturer&)>
    ...
    taskflow.emplace([&](flare::rt::cudaFlow& cf){
      ...
      flare::rt::cudaTask my_kernel = cf.kernel(my_arguments);

      // create a flow capturer to capture custom kernels
      flare::rt::cudaTask my_subflow = cf.capture([&](flare::rt::cudaFlowCapturer& capturer){
    ...
    */
    ...
    The method is similar to flare::rt::cudaFlow::capture but operates on a task
    of type flare::rt::cudaTaskType::SUBFLOW.
...
#endif  // FLARE_RUNTIME_CUDA_CUDAFLOW_H_
