...
//
#ifndef FLARE_RUNTIME_CUDA_ALGORITHM_MERGE_H_
#define FLARE_RUNTIME_CUDA_ALGORITHM_MERGE_H_
...
This function is equivalent to flare::rt::cuda_merge_by_key without values.
...
#endif  // FLARE_RUNTIME_CUDA_ALGORITHM_MERGE_H_
