...
//
#ifndef FLARE_RUNTIME_CUDA_ALGORITHM_FIND_H_
#define FLARE_RUNTIME_CUDA_ALGORITHM_FIND_H_
...
flare::rt::cuda_min_element_bufsz bytes for internal use.
...
using the given comparator @c op.
You need to provide a buffer that holds at least
flare::rt::cuda_max_element_bufsz bytes for internal use.
The function is equivalent to a parallel execution of the following loop:
...
#endif  // FLARE_RUNTIME_CUDA_ALGORITHM_FIND_H_
