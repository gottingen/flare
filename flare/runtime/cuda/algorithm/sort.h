...
//
#ifndef FLARE_RUNTIME_CUDA_ALGORITHM_SORT_H_
#define FLARE_RUNTIME_CUDA_ALGORITHM_SORT_H_
...
@tparam K key type
@tparam V value type (default flare::rt::cudaEmpty)

@param count number of keys/values to sort

The function is used to allocate a buffer for calling flare::rt::cuda_sort.
...
This method is equivalent to flare::rt::cuda_sort_by_key without values.
...
#endif  // FLARE_RUNTIME_CUDA_ALGORITHM_SORT_H_
