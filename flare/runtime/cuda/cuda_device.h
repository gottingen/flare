...
//
#ifndef FLARE_RUNTIME_CUDA_CUDA_DEVICE_H_
#define FLARE_RUNTIME_CUDA_CUDA_DEVICE_H_
...
@code{.cpp}
{
  flare::rt::cudaScopedDevice device(1);  // switch to the device context 1
...
#endif  // FLARE_RUNTIME_CUDA_CUDA_DEVICE_H_
