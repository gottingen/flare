...
#ifndef FLARE_RUNTIME_CUDA_CUDA_OPTIMIZER_H_
#define FLARE_RUNTIME_CUDA_CUDA_OPTIMIZER_H_

#include <flare/runtime/cuda/cuda_graph.h>
...
A linear capturing algorithm is a special case of flare::rt::cudaFlowSequentialOptimizer
...
#endif  // FLARE_RUNTIME_CUDA_CUDA_OPTIMIZER_H_
