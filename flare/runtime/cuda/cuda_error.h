...
//
#ifndef FLARE_RUNTIME_CUDA_CUDA_ERROR_H_
#define FLARE_RUNTIME_CUDA_CUDA_ERROR_H_
...
if(TF_CUDA_GET_FIRST(__VA_ARGS__) != cudaSuccess) {              \
  ...
  flare::rt::ostreamize(oss, TF_CUDA_REMOVE_FIRST(__VA_ARGS__));        \
  throw std::runtime_error(oss.str());                           \
}

#endif  // FLARE_RUNTIME_CUDA_CUDA_ERROR_H_
