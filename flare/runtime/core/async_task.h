...
//
#ifndef FLARE_RUNTIME_CORE_ASYNC_TASK_H_
#define FLARE_RUNTIME_CORE_ASYNC_TASK_H_
...
A flare::rt::AsyncTask is a lightweight handle that retains @em shared ownership
...
flare::rt::AsyncTask A = executor.silent_dependent_async([](){});
...
flare::rt::AsyncTask B = executor.silent_dependent_async([](){}, A);
@endcode

Currently, flare::rt::AsyncTask is implemented based on the logic of
...
#endif  // FLARE_RUNTIME_CORE_ASYNC_TASK_H_
