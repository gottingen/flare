...
//
#ifndef FLARE_RUNTIME_CORE_WORKER_H_
#define FLARE_RUNTIME_CORE_WORKER_H_

#include <flare/runtime/core/declarations.h>
#include <flare/runtime/core/tsq.h>
#include <flare/runtime/core/notifier.h>
...
using flare::rt::WorkerInterface.
*/
class Worker {
...
from an observer derived from flare::rt::ObserverInterface.
*/
class WorkerView {
...
#endif  // FLARE_RUNTIME_CORE_WORKER_H_
