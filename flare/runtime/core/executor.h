...
//
#ifndef FLARE_RUNTIME_CORE_EXCUTOR_H_
#define FLARE_RUNTIME_CORE_EXCUTOR_H_

#include <flare/runtime/core/observer.h>
#include <flare/runtime/core/taskflow.h>
#include <flare/runtime/core/async_task.h>
...
namespace flare::rt {
    ...
    flare::rt::Task A = taskflow.emplace([] () { std::cout << "This is TaskA\n"; });
    flare::rt::Task B = taskflow.emplace([] () { std::cout << "This is TaskB\n"; });
    flare::rt::Task C = taskflow.emplace([] () { std::cout << "This is TaskC\n"; });

    // Build precedence between tasks
    A.precede(B, C);

    flare::rt::Future<void> fu = executor.run(taskflow);
    ...
    */
    ...
    public:
        ...
        */
        ...
        @param taskflow a flare::rt::Taskflow object

        @return a flare::rt::Future that holds the result of the execution

        This member function executes the given taskflow once and returns a flare::rt::Future
        object that eventually holds the result of the execution.

        @code{.cpp}
        flare::rt::Future<void> future = executor.run(taskflow);
        // do something else
        future.wait();
        @endcode
        ...
        */
        flare::rt::Future<void> run(Taskflow &taskflow);

        /**
        @brief runs a moved taskflow once

        @param taskflow a moved flare::rt::Taskflow object

        @return a flare::rt::Future that holds the result of the execution

        This member function executes a moved taskflow once and returns a flare::rt::Future
        object that eventually holds the result of the execution.
        The executor will take care of the lifetime of the moved taskflow.

        @code{.cpp}
        flare::rt::Future<void> future = executor.run(std::move(taskflow));
        // do something else
        future.wait();
        @endcode
        ...
        */
        ...
        This member function returns a flare::rt::Future object that
        eventually holds the result of the execution.

        @code{.cpp}
        flare::rt::Future<void> future = executor.run(taskflow, [](){ std::cout << "done"; });
        // do something else
        future.wait();
        @endcode
        ...
        */
        template<typename C>
        flare::rt::Future<void> run(Taskflow &taskflow, C &&callable);
        ...
        @code{.cpp}
        flare::rt::Future<void> future = executor.run(
        ...
        */
        ...
        This member function executes the given taskflow @c N times and returns a flare::rt::Future
        object that eventually holds the result of the execution.

        @code{.cpp}
        flare::rt::Future<void> future = executor.run_n(taskflow, 2);  // run taskflow 2 times
        // do something else
        future.wait();
        @endcode
        ...
        */
        flare::rt::Future<void> run_n(Taskflow &taskflow, size_t N);
        ...
        This member function executes a moved taskflow @c N times and returns a flare::rt::Future
        object that eventually holds the result of the execution.
        The executor will take care of the lifetime of the moved taskflow.

        @code{.cpp}
        flare::rt::Future<void> future = executor.run_n(
        ...
        */
        ...
        @param taskflow a flare::rt::Taskflow
        @param N number of runs
        @param callable a callable object to be invoked after this run
        ...
        */
        template<typename C>
        flare::rt::Future<void> run_n(Taskflow &taskflow, size_t N, C &&callable);

        /**
        @brief runs a moved taskflow for @c N times and then invokes a callback

        @param taskflow a moved flare::rt::Taskflow
        @param N number of runs
        @param callable a callable object to be invoked after this run
        ...
        */
        ...
        @code{.cpp}
        flare::rt::Future<void> future = executor.run_until(
        ...
        */
        template<typename P>
        flare::rt::Future<void> run_until(Taskflow &taskflow, P &&pred);
        ...
        */
        ...
        flare::rt::Future<void> run_until(Taskflow &taskflow, P &&pred, C &&callable);
        ...
        */
        ...
        @tparam T target type which has `flare::rt::Graph& T::graph()` defined
        @param target the target task graph object

        The method runs a target graph which has `flare::rt::Graph& T::graph()` defined
        and waits until the execution completes.
        Unlike the typical flow of calling `flare::rt::Executor::run` series
        ...
        @code{.cpp}
        flare::rt::Executor executor(2);
        flare::rt::Taskflow taskflow;
        std::array<flare::rt::Taskflow, 1000> others;
        ...
        @attention
        You must call flare::rt::Executor::corun from a worker of the calling executor
        or an exception will be thrown.
        */
        template<typename T>
        void corun(T &target);
        ...
        @attention
        You must call flare::rt::Executor::corun_until from a worker of the calling executor
        or an exception will be thrown.
        */
        template<typename P>
        ...
        */
        ...
        @code{.cpp}
        flare::rt::Executor executor(4);   // 4 workers in the executor
        ...
        */
        ...
        @tparam Observer observer type derived from flare::rt::ObserverInterface
        ...
        flare::rt::ObserverInterface::on_entry and flare::rt::ObserverInterface::on_exit
        ...
        */
        ...
        /**
        @brief similar to flare::rt::Executor::async but does not return a future object

        @tparam F callable type

        @param func callable object

        This member function is more efficient than flare::rt::Executor::async
        ...
        */
        ...
        @tparam F callable type
        @tparam Tasks task types convertible to flare::rt::AsyncTask

        @param func callable object
        @param tasks asynchronous tasks on which this execution depends

        @return a flare::rt::AsyncTask handle

        This member function is more efficient than flare::rt::Executor::dependent_async
        and is encouraged to use when you do not want a @std_future to
        acquire the result or synchronize the execution.
        ...
        @code{.cpp}
        flare::rt::AsyncTask A = executor.silent_dependent_async([](){ printf("A\n"); });
        flare::rt::AsyncTask B = executor.silent_dependent_async([](){ printf("B\n"); });
        ...
        */
        ...
        >
        flare::rt::AsyncTask silent_dependent_async(F &&func, Tasks &&... tasks);
        ...
        @code{.cpp}
        flare::rt::AsyncTask A = executor.silent_dependent_async("A", [](){ printf("A\n"); });
        flare::rt::AsyncTask B = executor.silent_dependent_async("B", [](){ printf("B\n"); });
        ...
        */
        template<typename F, typename... Tasks,
                std::enable_if_t<all_same_v<AsyncTask, std::decay_t<Tasks>...>, void> * = nullptr
        >
        flare::rt::AsyncTask silent_dependent_async(const std::string &name, F &&func, Tasks &&... tasks);
        ...
        @code{.cpp}
        std::array<flare::rt::AsyncTask, 2> array {
        ...
        */
        ...
        >
        flare::rt::AsyncTask silent_dependent_async(F &&func, I first, I last);
        ...
        */
        template<typename F, typename I,
                std::enable_if_t<!std::is_same_v<std::decay_t<I>, AsyncTask>, void> * = nullptr
        >
        flare::rt::AsyncTask silent_dependent_async(const std::string &name, F &&func, I first, I last);
        ...
        @return a pair of a flare::rt::AsyncTask handle and
                          a @std_future that holds the result of the execution

        The example below creates three asynchronous tasks, @c A, @c B, and @c C,
        in which task @c C runs after task @c A and task @c B.
        Task @c C returns a pair of its flare::rt::AsyncTask handle and a std::future<int>
        ...
        You can mixed the use of flare::rt::AsyncTask handles
    ...
    private:
        ...
        void _schedule(Worker &, const flare::detail::SmallVector<Node *> &);

        void _schedule(const flare::detail::SmallVector<Node *> &);

        void _set_up_topology(Worker *, Topology *);

        void _set_up_graph(Graph &, Node *, Topology *, int, flare::detail::SmallVector<Node *> &);
        ...
        void _invoke_condition_task(Worker &, Node *, flare::detail::SmallVector<int> &);

        void _invoke_multi_condition_task(Worker &, Node *, flare::detail::SmallVector<int> &);
        ...
        void _process_async_dependent(Node *, flare::rt::AsyncTask &, size_t &);
    ...
    inline Executor::Executor(size_t N) :
        ...
        if (flare::detail::has_env(TF_ENABLE_PROFILER)) {
...
// Procedure: _schedule
    inline void Executor::_schedule(Worker &worker, const flare::detail::SmallVector<Node *> &nodes) {
...
// Procedure: _schedule
    inline void Executor::_schedule(const flare::detail::SmallVector<Node *> &nodes) {
...
// Procedure: _invoke
    inline void Executor::_invoke(Worker &worker, Node *node) {
        ...
        flare::detail::SmallVector<int> conds;
        ...
        if (node->_semaphores && !node->_semaphores->to_acquire.empty()) {
            flare::detail::SmallVector<Node *> nodes;
...
// Procedure: _detach_dynamic_task
    inline void Executor::_detach_dynamic_task(Worker &w, Node *p, Graph &g) {
        ...
        flare::detail::SmallVector<Node *> src;
...
// Procedure: _invoke_condition_task
    inline void Executor::_invoke_condition_task(
            Worker &worker, Node *node, flare::detail::SmallVector<int> &conds
    ) {
        _observer_prologue(worker, node);
        try {
...
// Function: run
    inline flare::rt::Future<void> Executor::run(Taskflow &f) {
        return run_n(f, 1, []() {});
    }
...
// Function: run
    template<typename C>
    flare::rt::Future<void> Executor::run(Taskflow &f, C &&c) {
...
// Function: run_n
    inline flare::rt::Future<void> Executor::run_n(Taskflow &f, size_t repeat) {
...
// Function: run_n
    template<typename C>
    flare::rt::Future<void> Executor::run_n(Taskflow &f, size_t repeat, C &&c) {
        return run_until(
...
// Function: run_until
    template<typename P>
    flare::rt::Future<void> Executor::run_until(Taskflow &f, P &&pred) {
...
// Function: run_until
    template<typename P, typename C>
    flare::rt::Future<void> Executor::run_until(Taskflow &f, P &&p, C &&c) {
        ...
        if (empty || p()) {
            ...
            promise.set_value();
            _decrement_topology();
            return flare::rt::Future<void>(promise.get_future());
        }
        ...
        flare::rt::Future<void> future(t->_promise.get_future(), t);
...
// Function: run_until
    template<typename P, typename C>
    flare::rt::Future<void> Executor::run_until(Taskflow &&f, P &&pred, C &&c) {
...
// Function: _set_up_graph
    inline void Executor::_set_up_graph(
            Graph &g, Node *parent, Topology *tpg, int state, flare::detail::SmallVector<Node *> &src
    ) {
...
// Procedure: corun
    ...
    void Runtime::corun(T &&target) {
        ...
        if constexpr (is_dynamic_task_v<T>) {
            ...
            // a composable graph object with `flare::rt::Graph& T::graph()` defined
        else {
...
#endif  // FLARE_RUNTIME_CORE_EXCUTOR_H_
