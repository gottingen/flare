...
//
#ifndef FLARE_RUNTIME_CORE_TASK_H_
#define FLARE_RUNTIME_CORE_TASK_H_

#include <flare/runtime/core/graph.h>
...
namespace flare::rt {
    ...
    */
    ...
    or std::function<int(flare::rt::Runtime&)>.
    */
    template<typename C>
    ...
    std::function<flare::rt::flare::detail::SmallVector<int>()> or
    std::function<flare::rt::flare::detail::SmallVector<int>(flare::rt::Runtime&)>.
    */
    template<typename C>
    constexpr bool is_multi_condition_task_v =
            (std::is_invocable_r_v<flare::detail::SmallVector < int>, C > ||
                                                       std::is_invocable_r_v<flare::detail::SmallVector < int>, C, Runtime & >
    ) &&
    !
    is_dynamic_task_v<C>;
    ...
    or std::function<void(flare::rt::Runtime&)>.
    */
    template<typename C>
    ...
    */
    ...
    public:
        ...
        */
        ...
        flare::rt::Taskflow taskflow("attach data to a task");
        ...
        */
        ...
        flare::rt::TaskPriority::HIGH (numerically equivalent to 0),
        flare::rt::TaskPriority::NORMAL (numerically equivalent to 1), and
        flare::rt::TaskPriority::LOW (numerically equivalent to 2).
...
namespace std {
    ...
    @brief hash specialization for std::hash<flare::rt::Task>
    */
    template<>
    struct hash<flare::rt::Task> {
        auto operator()(const flare::rt::Task &task) const noexcept {
...
@brief hash specialization for std::hash<flare::rt::TaskView>
*/
    template<>
    struct hash<flare::rt::TaskView> {
        auto operator()(const flare::rt::TaskView &task_view) const noexcept {
            return task_view.hash_value();
        }
    };

}  // namespace std
#endif  // FLARE_RUNTIME_CORE_TASK_H_
