...
//
#ifndef FLARE_RUNTIME_CORE_GRAPH_H_
#define FLARE_RUNTIME_CORE_GRAPH_H_
...
#include <flare/runtime/utility/serializer.h>
#include <flare/runtime/core/error.h>
#include <flare/runtime/core/declarations.h>
#include <flare/runtime/core/semaphore.h>
#include <flare/runtime/core/environment.h>
#include <flare/runtime/core/topology.h>
#include <flare/runtime/core/tsq.h>
...
@code{.cpp}
flare::rt::Task A, B, C, D;
std::tie(A, B, C, D) = taskflow.emplace(
  [] () { return 0; },
  [&C] (flare::rt::Runtime& rt) {  // C must be captured by reference
    std::cout << "B\n";
    rt.schedule(C);
  },
  [] () { std::cout << "C\n"; },
...
class Runtime {
  ...
  Issues a flare::rt::Runtime::corun_all to finish all spawned asynchronous tasks
  ...
  */
  ...
  taskflow.emplace([&](flare::rt::Runtime& rt){
  ...
  */
  ...
  The difference to flare::rt::Executor::async is that the created asynchronous task
  pertains to the runtime object.
  Applications can explicitly issue flare::rt::Runtime::corun_all
  ...
  */
  ...
  /**
  @brief similar to flare::rt::Runtime::async but assigns the task a name
  ...
  */
  ...
  This member function is more efficient than flare::rt::Runtime::async
  ...
  */
  ...
  /**
  @brief similar to flare::rt::Runtime::silent_async but assigns the task a name
  ...
  */
  ...
  /**
  @brief similar to flare::rt::Runtime::silent_async but the caller must be the worker of the runtime
  ...
  */
  ...
  taskflow.emplace([](flare::rt::Runtime& rt){
    rt.corun([](flare::rt::Subflow& sf){
      flare::rt::Task A = sf.emplace([](){});
      flare::rt::Task B = sf.emplace([](){});
    }); 
  });
  
  // co-run a taskflow and wait until all tasks complete
  flare::rt::Taskflow taskflow1, taskflow2;
  taskflow1.emplace([](){ std::cout << "running taskflow1\n"; });
  taskflow2.emplace([&](flare::rt::Runtime& rt){
  ...
  Although flare::rt::Runtime::corun blocks until the operation completes,
  ...
  @attention
  Only the worker of this flare::rt::Runtime can issue corun.
  */
  template <typename T>
  void corun(T&& target);
  ...
  */
  ...
  Coruns all asynchronous tasks (flare::rt::Runtime::async,
  flare::rt::Runtime::silent_async) with other workers until all those
  ...
  @attention
  Only the worker of this flare::rt::Runtime can issue flare::rt::Runtime::corun_all.
  */
...
class Node {
  ...
  struct MultiCondition {
    ...
    std::variant<
      std::function<flare::detail::SmallVector<int>()>, std::function<flare::detail::SmallVector<int>(Runtime&)>
    > work;
  };
  ...
  struct Semaphores {
      flare::detail::SmallVector<Semaphore*> to_acquire;
      flare::detail::SmallVector<Semaphore*> to_release;
  };
  ...
  void* _data {nullptr};
    ...
    flare::detail::SmallVector<Node*> _successors;
    flare::detail::SmallVector<Node*> _dependents;
  ...
  bool _acquire_all(flare::detail::SmallVector<Node*>&);

    flare::detail::SmallVector<Node*> _release_all();
};
...
inline bool Node::_acquire_all(flare::detail::SmallVector<Node*>& nodes) {
...
inline flare::detail::SmallVector<Node*> Node::_release_all() {
...
#endif  // FLARE_RUNTIME_CORE_GRAPH_H_
