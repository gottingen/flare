...
//
#ifndef FLARE_RUNTIME_CORE_SEMAPHORE_H_
#define FLARE_RUNTIME_CORE_SEMAPHORE_H_
...
A flare::rt::Semaphore object starts with an initial count.
...
flare::rt::Semaphore semaphore(1); // create a semaphore with initial count 1
...
class Semaphore {
  ...
  public:
    ...
    @code{.cpp}
    flare::rt::Semaphore semaphore(4);  // concurrency constraint of 4 workers
    @endcode
    */
...
#endif  // FLARE_RUNTIME_CORE_SEMAPHORE_H_
