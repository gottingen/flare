...
//
#ifndef FLARE_RUNTIME_CORE_ASYNC_H_
#define FLARE_RUNTIME_CORE_ASYNC_H_

#include <flare/runtime/core/executor.h>
...
>
flare::rt::AsyncTask Executor::silent_dependent_async(F&& func, Tasks&&... tasks) {
...
template <typename F, typename... Tasks,
  std::enable_if_t<all_same_v<AsyncTask, std::decay_t<Tasks>...>, void>*
>
flare::rt::AsyncTask Executor::silent_dependent_async(
...
>
flare::rt::AsyncTask Executor::silent_dependent_async(F&& func, I first, I last) {
...
inline void Executor::_process_async_dependent(
  Node* node, flare::rt::AsyncTask& task, size_t& num_dependents
) {
...
#endif  // FLARE_RUNTIME_CORE_ASYNC_H_
