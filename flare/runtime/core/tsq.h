...
//
#ifndef FLARE_RUNTIME_CORE_TSQ_H_
#define FLARE_RUNTIME_CORE_TSQ_H_

#include <flare/runtime/utility/macros.h>
...
namespace flare::rt {
    ...
    */
    ...
    class TaskQueue {
        ...
        // decent performance.
        flare::detail::CachelineAligned <std::atomic<int64_t>> _top[TF_MAX_PRIORITY];
        flare::detail::CachelineAligned <std::atomic<int64_t>> _bottom[TF_MAX_PRIORITY];
...
#endif  // FLARE_RUNTIME_CORE_TSQ_H_
