...
#ifndef FLARE_CORE_COMMON_SMALL_VECTOR_H_
#define FLARE_CORE_COMMON_SMALL_VECTOR_H_
...
namespace flare::detail { namespace detail {
...
void SmallVectorTemplateBase<T, isPodLike>::grow(size_t MinSize) {
  ...
  size_t NewCapacity = size_t(flare::detail::detail::NextCapacity(CurCapacity+2));
...
public:
  ...
  */
  ...
  //explicit SmallVector(const flare::detail::iterator_range<RangeTy> &R)
  //    : SmallVectorImpl<T>(N) {
...
namespace std {
  ...
  template<typename T>
  inline void
  swap(flare::detail::SmallVectorImpl<T> &LHS, flare::detail::SmallVectorImpl<T> &RHS) {
    LHS.swap(RHS);
  }
  ...
  template<typename T, unsigned N>
  inline void
  swap(flare::detail::SmallVector<T, N> &LHS, flare::detail::SmallVector<T, N> &RHS) {
    LHS.swap(RHS);
  }
}  // namespace std

#endif  // FLARE_CORE_COMMON_SMALL_VECTOR_H_
