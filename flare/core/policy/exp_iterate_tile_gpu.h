...
#ifndef FLARE_CORE_POLICY_EXP_ITERATE_TILE_GPU_H_
#define FLARE_CORE_POLICY_EXP_ITERATE_TILE_GPU_H_
...
namespace flare::detail {
    ...
    FLARE_IMPL_FORCEINLINE_FUNCTION std::enable_if_t<std::is_void<Tag>::value>
    ...
    template<class Tag, class Functor, class T, size_t N, size_t... Idxs,
            class... Args>
    FLARE_IMPL_FORCEINLINE_FUNCTION void _tag_invoke_array_helper(
    ...
    FLARE_IMPL_FORCEINLINE_FUNCTION void _tag_invoke_array(Functor const &f,
                                                           T (&vals)[N],
                                                           Args &&... args) {
...
// Rank 2
    ...
    struct DeviceIterateTile<2, PolicyType, Functor, Tag> {
        ...
        FLARE_IMPL_DEVICE_FUNCTION DeviceIterateTile(const PolicyType &policy_,
                                                     const Functor &f_)
                    ...
                    if (offset_1 < m_policy.m_upper[1] &&
                        ...
                        for (index_type tile_id0 = static_cast<index_type>(blockIdx.x);
                            ...
                            if (offset_0 < m_policy.m_upper[0] &&
                                ...
                                detail::_tag_invoke<Tag>(m_func, offset_0, offset_1);
                            }
                        }
                    }
                }
                        ...
                        for (index_type tile_id1 = static_cast<index_type>(blockIdx.y);
                            ...
                            if (offset_1 < m_policy.m_upper[1] &&
                                ...
                                for (index_type tile_id0 = static_cast<index_type>(blockIdx.x);
                                    ...
                                    if (offset_0 < m_policy.m_upper[0] &&
                                        static_cast<index_type>(threadIdx.x) < m_policy.m_tile[0]) {
                                        detail::_tag_invoke<Tag>(m_func, offset_0, offset_1, offset_2);
                                    }
                                }
                            }
                        }
                ...
                if (static_cast<index_type>(blockIdx.x) < m_policy.m_num_tiles &&
                    ...
                    for (index_type tileidx = static_cast<index_type>(blockIdx.x);
                        ...
                        if (PolicyType::inner_direction == Iterate::Left) {
                            ...
                            if (in_bounds) {
                                detail::_tag_invoke_array<Tag>(m_func, m_offset, m_v);
                            }
                        }
                            // LR
                        else {
...
#endif  // FLARE_CORE_POLICY_EXP_ITERATE_TILE_GPU_H_
