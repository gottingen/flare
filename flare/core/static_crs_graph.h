...
#ifndef FLARE_CORE_STATIC_CRS_GRAPH_H_
#define FLARE_CORE_STATIC_CRS_GRAPH_H_
...
namespace flare {
    ...
    public:
        ...
        FLARE_INLINE_FUNCTION StaticCrsGraph(const EntriesType &entries_,
        ...
        void create_block_partitioning(size_type num_blocks,
            ...
            flare::parallel_for("flare::StaticCrsGraph::create_block_partitioning",
                                flare::RangePolicy<execution_space>(0, numRows()),
                                partitioner);
            typename device_type::execution_space().fence(
                    "flare::StaticCrsGraph::create_block_partitioning:: fence after "
                    "partition");
...
#include <flare/containers/static_crs_graph_factory.h>
...
namespace flare {
    ...
    DataType maximum_entry(const StaticCrsGraph<DataType, Arg1Type, Arg2Type,
        ...
        using GraphType =
                StaticCrsGraph<DataType, Arg1Type, Arg2Type, Arg3Type, SizeType>;
        using FunctorType = detail::StaticCrsGraphMaximumEntry<GraphType>;

        DataType result = 0;
        flare::parallel_reduce("flare::maximum_entry", graph.entries.extent(0),
...
#endif  // FLARE_CORE_STATIC_CRS_GRAPH_H_
