...
struct layout_stride {
  ...
  private:
    ...
    _MDSPAN_HOST_DEVICE
    constexpr index_type __get_size(::flare::extents<SizeType, Ep...>,std::integer_sequence<size_t, Idx...>) const {
  ...
  public:
    ...
    MDSPAN_TEMPLATE_REQUIRES(
      ...
      /* requires */ (
        ...
        // error C2641: cannot deduce template arguments for 'flare::layout_stride::mapping'
