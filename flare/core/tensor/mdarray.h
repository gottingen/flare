...
#ifndef FLARE_CORE_TENSOR_MDARRAY_H_
#define FLARE_CORE_TENSOR_MDARRAY_H_

#include <flare/mdarray.h>
#include <cassert>
#include <vector>
...
class mdarray {
private:
  static_assert(::flare::detail::__is_extents_v<Extents>,
...
#endif   // FLARE_CORE_TENSOR_MDARRAY_H_
