...
#pragma once
#ifndef FLARE_CORE_TENSOR_MDSPAN_H_
#define FLARE_CORE_TENSOR_MDSPAN_H_

#include <flare/core/tensor/default_accessor.h>
#include <flare/core/tensor/layout_right.h>
#include <flare/core/tensor/extents.h>
#include <flare/core/tensor/trait_backports.h>
#include <flare/core/tensor/compressed_pair.h>
...
MDSPAN_DEDUCTION_GUIDE explicit mdspan(ElementType*, SizeTypes...)
  -> mdspan<ElementType, ::flare::dextents<size_t, sizeof...(SizeTypes)>>;
...
MDSPAN_DEDUCTION_GUIDE mdspan(ElementType*, const ::std::array<SizeType, N>&)
  -> mdspan<ElementType, ::flare::dextents<size_t, N>>;
...
MDSPAN_DEDUCTION_GUIDE mdspan(ElementType*, const extents<SizeType, ExtentsPack...>&)
  -> mdspan<ElementType, ::flare::extents<SizeType, ExtentsPack...>>;
...
#endif  // FLARE_CORE_TENSOR_MDSPAN_H_
