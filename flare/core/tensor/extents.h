...
#ifndef FLARE_CORE_TENSOR_EXTENTS_H_
#define FLARE_CORE_TENSOR_EXTENTS_H_

#include <flare/core/tensor/dynamic_extent.h>
...
// See ISO C++ standard [mdspan.extents]
    ...
    public:
        ...
        static_assert(std::is_integral<index_type>::value && !std::is_same<index_type, bool>::value,
                      "flare::extents::index_type must be a signed or unsigned integer type");
    private:
...
namespace flare::detail {
    ...
    template<class IndexType, size_t Rank,
            class Extents = ::flare::extents<IndexType>>
    struct __make_dextents;

    template<class IndexType, size_t Rank, size_t... ExtentsPack>
    struct __make_dextents<
            IndexType, Rank, ::flare::extents<IndexType, ExtentsPack...>> {
        using type = typename __make_dextents<
                IndexType, Rank - 1,
                ::flare::extents<IndexType,
    ...
    struct __make_dextents<
            IndexType, 0, ::flare::extents<IndexType, ExtentsPack...>> {
        using type = ::flare::extents<IndexType, ExtentsPack...>;
    };
...
// Deduction guide for extents
    ...
    template<class... IndexTypes> extents(IndexTypes...)->extents<size_t, size_t(
            (IndexTypes(), ::flare::dynamic_extent))...>;
#endif
}  // namespace flare
...
namespace flare::detail {
    ...
    template<class IndexType, size_t... ExtentsPack>
    struct __is_extents<::flare::extents<IndexType, ExtentsPack...>>
            : ::std::true_type {
    };
...
#endif  // FLARE_CORE_TENSOR_EXTENTS_H_
