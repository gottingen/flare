...
#include <stdexcept>
#include <flare/core/tensor/layout_stride.h>
...
class layout_right::mapping {
  ...
  private:
    ...
    static_assert(detail::__is_extents_v<extents_type>,
                  "flare::layout_right::mapping must be instantiated with a specialization of " MDSPAN_IMPL_STANDARD_NAMESPACE_STRING "::extents.");
  ...
  public:
    ...
    constexpr index_type __get_stride(flare::extents<SizeType, E...>,std::integer_sequence<size_t, Idx...>) const {
