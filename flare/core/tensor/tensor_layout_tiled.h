...
#ifndef FLARE_CORE_TENSOR_TENSOR_LAYOUT_TILE_H_
#define FLARE_CORE_TENSOR_TENSOR_LAYOUT_TILE_H_
...
namespace flare {
    ...
    // Tensor offset and mapping for tiled tensor's
...
#else
            FLARE_DEFAULTED_FUNCTION ~TensorOffset() = default;

            FLARE_DEFAULTED_FUNCTION TensorOffset() = default;

            FLARE_DEFAULTED_FUNCTION TensorOffset(const TensorOffset &) = default;

            FLARE_DEFAULTED_FUNCTION TensorOffset &operator=(const TensorOffset &) = default;
...
#define FLARE_ITERATE_TENSOR_OFFSET_ENABLE                               \
  std::enable_if_t<((Dimension::rank <= 8) && (Dimension::rank >= 2) && \
                    is_array_layout<Layout>::value &&                   \
                    is_array_layout_tiled<Layout>::value)>
        template<class Dimension, class Layout>
        constexpr flare::Iterate TensorOffset<
                Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::outer_pattern;
        template<class Dimension, class Layout>
        constexpr flare::Iterate TensorOffset<
                Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::inner_pattern;
        template<class Dimension, class Layout>
        constexpr int
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::VORank;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_0;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_1;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_2;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_3;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_4;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_5;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_6;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_7;
        template<class Dimension, class Layout>
        constexpr int
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::MASK_0;
        template<class Dimension, class Layout>
        constexpr int
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::MASK_1;
        template<class Dimension, class Layout>
        constexpr int
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::MASK_2;
        template<class Dimension, class Layout>
        constexpr int
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::MASK_3;
        template<class Dimension, class Layout>
        constexpr int
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::MASK_4;
        template<class Dimension, class Layout>
        constexpr int
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::MASK_5;
        template<class Dimension, class Layout>
        constexpr int
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::MASK_6;
        template<class Dimension, class Layout>
        constexpr int
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::MASK_7;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_2T;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_3T;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_4T;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_5T;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_6T;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_7T;
        template<class Dimension, class Layout>
        constexpr unsigned
                TensorOffset<Dimension, Layout, FLARE_ITERATE_TENSOR_OFFSET_ENABLE >::SHIFT_8T;
#undef FLARE_ITERATE_TENSOR_OFFSET_ENABLE

//----------------------------------------

// TensorMapping assign method needed in order to return a 'subtensor' tile as a
// proper Tensor The outer iteration pattern determines the mapping of the pointer
// offset to the beginning of requested tile The inner iteration pattern is
// needed for the layout of the tile's Tensor to be returned Rank 2
        template<typename T, flare::Iterate OuterP, flare::Iterate InnerP,
                ...
                typename iType1>
        class TensorMapping<std::enable_if_t<(N2 == 0 && N3 == 0 && N4 == 0 && N5 == 0 &&
                                            N6 == 0 && N7 == 0)>  // void
                ,
                flare::TensorTraits<
                        T **,
        ...
        public:
            using src_layout =
                    flare::experimental::LayoutTiled<OuterP, InnerP, N0, N1, N2, N3, N4, N5,
                            N6, N7, true>;
            using src_traits = flare::TensorTraits<T **, src_layout, P...>;
            ...
            using array_layout = std::conditional_t<is_inner_left, flare::LayoutLeft,
                    flare::LayoutRight>;
            using traits = flare::TensorTraits<T[N0][N1], array_layout, P...>;
            using type = flare::Tensor<T[N0][N1], array_layout, P...>;

            FLARE_INLINE_FUNCTION static void assign(
                    TensorMapping<traits, void> &dst, const TensorMapping<src_traits, void> &src,
                    const src_layout &, const iType0 i_tile0, const iType1 i_tile1) {
                using dst_map_type = TensorMapping<traits, void>;
                using src_map_type = TensorMapping<src_traits, void>;
...
// Rank 3
        ...
        class TensorMapping<std::enable_if_t<(N3 == 0 && N4 == 0 && N5 == 0 && N6 == 0 &&
                                            N7 == 0)>  // void
                ,
                flare::TensorTraits<
                        T ***,
        ...
        public:
            ...
            using array_layout = std::conditional_t<is_inner_left, flare::LayoutLeft,
                    flare::LayoutRight>;
            using traits = flare::TensorTraits<T[N0][N1][N2], array_layout, P...>;
            using type = flare::Tensor<T[N0][N1][N2], array_layout, P...>;
...
// Rank 4
        ...
        public:
            ...
            using array_layout = std::conditional_t<is_inner_left, flare::LayoutLeft,
                    flare::LayoutRight>;
            using traits = flare::TensorTraits<T[N0][N1][N2][N3], array_layout, P...>;
            using type = flare::Tensor<T[N0][N1][N2][N3], array_layout, P...>;
...
// Rank 5
        ...
        class TensorMapping<std::enable_if_t<(N5 == 0 && N6 == 0 && N7 == 0)>  // void
                ,
                flare::TensorTraits<
                        T *****,
                        flare::experimental::LayoutTiled<
        ...
        public:
            ...
            using array_layout = std::conditional_t<is_inner_left, flare::LayoutLeft,
                    flare::LayoutRight>;
            using traits = flare::TensorTraits<T[N0][N1][N2][N3][N4], array_layout, P...>;
            using type = flare::Tensor<T[N0][N1][N2][N3][N4], array_layout, P...>;
...
// Rank 6
        template<typename T, flare::Iterate OuterP, flare::Iterate InnerP,
                ...
                typename iType1, typename iType2, typename iType3, typename iType4,
                typename iType5>
        class TensorMapping<std::enable_if_t<(N6 == 0 && N7 == 0)>  // void
                ,
                flare::TensorTraits<
                        T ******,
                        flare::experimental::LayoutTiled<
        ...
        public:
            ...
            using array_layout = std::conditional_t<is_inner_left, flare::LayoutLeft,
                    flare::LayoutRight>;
            using traits =
                    flare::TensorTraits<T[N0][N1][N2][N3][N4][N5], array_layout, P...>;
            using type = flare::Tensor<T[N0][N1][N2][N3][N4][N5], array_layout, P...>;
...
// Rank 7
        ...
        class TensorMapping<std::enable_if_t<(N7 == 0)>  // void
                ,
                flare::TensorTraits<
                        T *******,
                        flare::experimental::LayoutTiled<
        ...
        public:
            ...
            using array_layout = std::conditional_t<is_inner_left, flare::LayoutLeft,
                    flare::LayoutRight>;
            using traits =
                    flare::TensorTraits<T[N0][N1][N2][N3][N4][N5][N6], array_layout, P...>;
            using type = flare::Tensor<T[N0][N1][N2][N3][N4][N5][N6], array_layout, P...>;
...
// Rank 8
        ...
        public:
            ...
            using array_layout = std::conditional_t<is_inner_left, flare::LayoutLeft,
                    flare::LayoutRight>;
            using traits =
                    flare::TensorTraits<T[N0][N1][N2][N3][N4][N5][N6][N7], array_layout, P...>;
            using type =
                    flare::Tensor<T[N0][N1][N2][N3][N4][N5][N6][N7], array_layout, P...>;
...
// Rank 2
    ...
    flare::Tensor<T[N0][N1],
            std::conditional_t<(InnerP == flare::Iterate::Left),
                    flare::LayoutLeft, flare::LayoutRight>,
            P...>
    tile_subtensor(const flare::Tensor<
            T **,
            flare::experimental::LayoutTiled<
                    OuterP, InnerP, N0, N1, N2, N3, N4, N5, N6, N7, true>,
            P...> &src,
                 const size_t i_tile0, const size_t i_tile1) {
        // Force the specialized TensorMapping for extracting a tile
        // by using the first subtensor argument as the layout.
        using array_layout =
        ...
        return flare::Tensor<T[N0][N1], array_layout, P...>(src, SrcLayout(), i_tile0,
                                                          i_tile1);
    }
...
// Rank 3
    ...
    tile_subtensor(const flare::Tensor<
        ...
        return flare::Tensor<T[N0][N1][N2], array_layout, P...>(
...
// Rank 4
    ...
    tile_subtensor(const flare::Tensor<
        ...
        return flare::Tensor<T[N0][N1][N2][N3], array_layout, P...>(
    ...
    tile_subtensor(const flare::Tensor<
        ...
        return flare::Tensor<T[N0][N1][N2][N3][N4], array_layout, P...>(
...
// Rank 6
    template<typename T, flare::Iterate OuterP, flare::Iterate InnerP,
            ...
            unsigned N5, unsigned N6, unsigned N7, class... P>
    FLARE_INLINE_FUNCTION
    flare::Tensor<T[N0][N1][N2][N3][N4][N5],
            std::conditional_t<(InnerP == flare::Iterate::Left),
                    flare::LayoutLeft, flare::LayoutRight>,
            P...>
    tile_subtensor(const flare::Tensor<
        ...
        return flare::Tensor<T[N0][N1][N2][N3][N4][N5], array_layout, P...>(
...
// Rank 7
    template<typename T, flare::Iterate OuterP, flare::Iterate InnerP,
            ...
            unsigned N5, unsigned N6, unsigned N7, class... P>
    FLARE_INLINE_FUNCTION
    flare::Tensor<T[N0][N1][N2][N3][N4][N5][N6],
            std::conditional_t<(InnerP == flare::Iterate::Left),
                    flare::LayoutLeft, flare::LayoutRight>,
            P...>
    tile_subtensor(const flare::Tensor<
        ...
        return flare::Tensor<T[N0][N1][N2][N3][N4][N5][N6], array_layout, P...>(
                src, SrcLayout(), i_tile0, i_tile1, i_tile2, i_tile3, i_tile4, i_tile5,
                i_tile6);
    }
...
// Rank 8
    template<typename T, flare::Iterate OuterP, flare::Iterate InnerP,
            ...
            unsigned N5, unsigned N6, unsigned N7, class... P>
    FLARE_INLINE_FUNCTION
    flare::Tensor<T[N0][N1][N2][N3][N4][N5][N6][N7],
            std::conditional_t<(InnerP == flare::Iterate::Left),
                    flare::LayoutLeft, flare::LayoutRight>,
            P...>
    tile_subtensor(const flare::Tensor<
        ...
        return flare::Tensor<T[N0][N1][N2][N3][N4][N5][N6][N7], array_layout, P...>(
                src, SrcLayout(), i_tile0, i_tile1, i_tile2, i_tile3, i_tile4, i_tile5,
                i_tile6, i_tile7);
    }
...
#endif  // FLARE_CORE_TENSOR_TENSOR_LAYOUT_TILE_H_
