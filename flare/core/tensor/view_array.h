...
#ifndef FLARE_CORE_TENSOR_VIEW_ARRAY_MAPPING_H_
#define FLARE_CORE_TENSOR_VIEW_ARRAY_MAPPING_H_
...
class ViewMapping<Traits, flare::Array<>> {
 private:
  template <class, class...>
  friend class ViewMapping;
  template <class, class...>
  friend class flare::View;
 ...
 public:
  ...
  template <class... Args>
  FLARE_INLINE_FUNCTION ViewMapping(pointer_type ptr, Args... args)
      : m_impl_handle(ptr),
...
class ViewMapping<
 ...
 public:
  ...
  using SrcType   = ViewMapping<SrcTraits, flare::Array<>>;
