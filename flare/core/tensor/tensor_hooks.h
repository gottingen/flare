...
#ifndef FLARE_CORE_TENSOR_TENSOR_HOOKS_H_
#define FLARE_CORE_TENSOR_TENSOR_HOOKS_H_
...
using copy_subscription_function_type = void (*)(Tensor &, const Tensor &);
...
struct invoke_subscriber_impl<Invoker> {
  ...
  static void invoke(TensorType &, const TensorType &) {}
};
...
struct invoke_subscriber_impl<Invoker, Subscriber, RemSubscribers...> {
  template <typename TensorType>
  static void invoke(TensorType &self, const TensorType &other) {
...
struct copy_constructor_invoker {
  template <typename Tensor>
  static void call(Tensor &self, const Tensor &other) {
...
struct EmptyTensorHooks {
  using hooks_policy = EmptyTensorHooks;

  template <typename Tensor>
  static void copy_construct(Tensor &, const Tensor &) {}
  template <typename Tensor>
  static void copy_assign(Tensor &, const Tensor &) {}
  template <typename Tensor>
  static void move_construct(Tensor &, const Tensor &) {}
  template <typename Tensor>
  static void move_assign(Tensor &, const Tensor &) {}
};

template <class... Subscribers>
struct SubscribableTensorHooks {
  using hooks_policy = SubscribableTensorHooks<Subscribers...>;

  template <typename Tensor>
  static void copy_construct(Tensor &self, const Tensor &other) {
    detail::invoke_subscriber_impl<detail::copy_constructor_invoker,
                                 Subscribers...>::invoke(self, other);
  }
  template <typename Tensor>
  static void copy_assign(Tensor &self, const Tensor &other) {
    detail::invoke_subscriber_impl<detail::copy_assignment_operator_invoker,
                                 Subscribers...>::invoke(self, other);
  }
  template <typename Tensor>
  static void move_construct(Tensor &self, const Tensor &other) {
    detail::invoke_subscriber_impl<detail::move_constructor_invoker,
                                 Subscribers...>::invoke(self, other);
  }
  template <typename Tensor>
  static void move_assign(Tensor &self, const Tensor &other) {
    detail::invoke_subscriber_impl<detail::move_assignment_operator_invoker,
                                 Subscribers...>::invoke(self, other);
  }
};

using DefaultTensorHooks = EmptyTensorHooks;

}  // namespace experimental
}  // namespace flare

#endif  // FLARE_CORE_TENSOR_TENSOR_HOOKS_H_
