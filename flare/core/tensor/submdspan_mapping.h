...
#ifndef FLARE_CORE_TENSOR_SUBMDSPAN_MAPPING_H_
#define FLARE_CORE_TENSOR_SUBMDSPAN_MAPPING_H_
...
namespace detail {
using experimental::detail::first_of;
using experimental::detail::stride_of;
using experimental::detail::inv_map_rank;
...
submdspan_mapping(const layout_left::mapping<Extents> &src_mapping,
  ...
  using experimental::submdspan_extents;
  using experimental::mapping_offset;
...
#endif  // FLARE_CORE_TENSOR_SUBMDSPAN_MAPPING_H_
