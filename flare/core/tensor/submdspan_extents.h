...
#ifndef FLARE_CORE_TENSOR_SUBMDSPAN_EXTENTS_H_
#define FLARE_CORE_TENSOR_SUBMDSPAN_EXTENTS_H_

#include <tuple>

#include <flare/core/tensor/strided_slice.h>
namespace flare {
...
first_of(const ::flare::full_extent_t &) {
...
#endif  // FLARE_CORE_TENSOR_SUBMDSPAN_EXTENTS_H_
