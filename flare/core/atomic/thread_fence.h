...
#ifndef FLARE_CORE_ATOMIC_THREAD_FENCE_H_
#define FLARE_CORE_ATOMIC_THREAD_FENCE_H_
...
#include <flare/core/atomic/thread_fence_scope_caller.h>

#endif  // FLARE_CORE_ATOMIC_THREAD_FENCE_H_
