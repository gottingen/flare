...
#ifndef FLARE_CORE_ATOMIC_LOCK_BASED_FETCH_OP_HOST_H_
#define FLARE_CORE_ATOMIC_LOCK_BASED_FETCH_OP_HOST_H_
...
#endif  // FLARE_CORE_ATOMIC_LOCK_BASED_FETCH_OP_HOST_H_
