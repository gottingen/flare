...
#ifndef FLARE_KERNEL_DENSE_NORM_L2_H_
#define FLARE_KERNEL_DENSE_NORM_L2_H_
...
namespace flare::kernel::dense {
    ...
    struct NormL2Functor {
        ...
        NormL2Functor(const XV& x, bool take_sqrt = true) : m_x(x),m_take_sqrt(take_sqrt)  {
