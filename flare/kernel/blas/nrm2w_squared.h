...
namespace flare::blas {
    ...
    /// \param w [in] Input weights (1-D Tensor).
    ///
    ...
    nrm2w_squared(const execution_space& space, const XVector& x,
        ...
        static_assert(flare::is_tensor<XVector>::value,
                      "flare::blas::nrm2w_squared: XVector must be a flare::Tensor.");
        static_assert(
    ...
    void nrm2w_squared(
        ...
        // rank 1 or rank 2.
        using RV_Internal  = flare::Tensor<typename RV::non_const_data_type,
