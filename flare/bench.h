...
#ifndef FLARE_BENCH_H_
#define FLARE_BENCH_H_
...
namespace flare {
    ...
    public:
        ...
        Benchmarker(const size_t max_iter)
                : MAX_ITER(max_iter), MAX_RUNTIME(0) {
        }
...
template<typename T>
std::ostream &
operator<<(std::ostream &os, const flare::Statistics<T> &stats) {
    os << "Statistics:\n"
