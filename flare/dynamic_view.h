...
#ifndef FLARE_DYNAMIC_VIEW_H_
#define FLARE_DYNAMIC_VIEW_H_
...
class DynamicView : public flare::ViewTraits<DataType, P...> {
 public:
  using traits = flare::ViewTraits<DataType, P...>;
 ...
 public:
  ...
  operator()(const I0& i0, const Args&... /*args*/) const {
    ...
    flare::detail::runtime_check_memory_access_violation<
        ...
        "flare::DynamicView ERROR: attempt to access inaccessible memory "
        "space");
    ...
    if (n <= ic) flare::abort("flare::DynamicView array bounds error");
#endif
  ...
  inline void resize_serial(IntType const& n) {
    ...
    if (m_chunk_max < NC) {
      flare::abort("DynamicView::resize_serial exceeded maximum size");
    }
   ...
   */
  template <class... Prop>
  DynamicView(const flare::detail::ViewCtorProp<Prop...>& arg_prop,
    ...
    if (device_accessor::template IsAccessibleFrom<host_space>::value) {
      ...
      using alloc_prop_input = flare::detail::ViewCtorProp<Prop...>;
  ...
  DynamicView(const std::string& arg_label, const unsigned min_chunk_size,
              const unsigned max_extent)
      : DynamicView(flare::view_alloc(arg_label), min_chunk_size, max_extent) {
  }
};
...
struct is_dynamic_view<flare::experimental::DynamicView<D, P...>>
...
struct MirrorDynamicViewType {
  ...
  using src_view_type = typename flare::experimental::DynamicView<T, P...>;
  ...
  using dest_view_type =
      flare::experimental::DynamicView<data_type, array_layout, Space>;
...
inline auto create_mirror(
    const flare::experimental::DynamicView<T, P...>& src,
  ...
  auto ret = typename flare::experimental::DynamicView<T, P...>::HostMirror(
...
inline auto create_mirror(
  ...
  auto ret = typename flare::detail::MirrorDynamicViewType<
...
template <class Space, class T, class... P>
inline auto create_mirror(
    const Space&, const flare::experimental::DynamicView<T, P...>& src) {
  return detail::create_mirror(
      src, flare::view_alloc(typename Space::memory_space{}));
}

template <class Space, class T, class... P>
typename flare::detail::MirrorDynamicViewType<Space, T, P...>::view_type
...
inline std::enable_if_t<
    !detail::ViewCtorProp<ViewCtorArgs...>::has_memory_space &&
        (std::is_same<
             typename flare::experimental::DynamicView<T, P...>::memory_space,
             typename flare::experimental::DynamicView<
                 T, P...>::HostMirror::memory_space>::value &&
         std::is_same<
             typename flare::experimental::DynamicView<T, P...>::data_type,
             typename flare::experimental::DynamicView<
                 T, P...>::HostMirror::data_type>::value),
    typename flare::experimental::DynamicView<T, P...>::HostMirror>
create_mirror_view(const flare::experimental::DynamicView<T, P...>& src,
...
template <class T, class... P, class... ViewCtorArgs,
          class = std::enable_if_t<
              detail::ViewCtorProp<ViewCtorArgs...>::has_memory_space>>
std::enable_if_t<detail::MirrorDynamicViewType<
                     typename detail::ViewCtorProp<ViewCtorArgs...>::memory_space,
                     T, P...>::is_same_memspace,
                 typename detail::MirrorDynamicViewType<
                     typename detail::ViewCtorProp<ViewCtorArgs...>::memory_space,
                     T, P...>::view_type>
create_mirror_view(const flare::experimental::DynamicView<T, P...>& src,
                   const detail::ViewCtorProp<ViewCtorArgs...>&) {
...
inline auto create_mirror_view(
    const typename flare::experimental::DynamicView<T, P...>& src) {
...
inline auto create_mirror_view(
    const Space&, const flare::experimental::DynamicView<T, P...>& src) {
  return detail::create_mirror_view(src,
...
inline void deep_copy(const flare::experimental::DynamicView<T, DP...>& dst,
                      const flare::experimental::DynamicView<T, SP...>& src) {
  using dst_type = flare::experimental::DynamicView<T, DP...>;
  using src_type = flare::experimental::DynamicView<T, SP...>;
  ...
  if (DstExecCanAccessSrc)
    flare::detail::ViewRemap<dst_type, src_type, dst_execution_space>(dst, src);
  else if (SrcExecCanAccessDst)
    flare::detail::ViewRemap<dst_type, src_type, src_execution_space>(dst, src);
  else
    src.impl_get_chunks().deep_copy_to(dst_execution_space{},
                                       dst.impl_get_chunks());
  flare::fence("flare::deep_copy(DynamicView)");
}

template <class ExecutionSpace, class T, class... DP, class... SP>
inline void deep_copy(const ExecutionSpace& exec,
                      const flare::experimental::DynamicView<T, DP...>& dst,
                      const flare::experimental::DynamicView<T, SP...>& src) {
  using dst_type = flare::experimental::DynamicView<T, DP...>;
  using src_type = flare::experimental::DynamicView<T, SP...>;
...
inline void deep_copy(const View<T, DP...>& dst,
  ...
  if (DstExecCanAccessSrc) {
    ...
    flare::detail::ViewRemap<dst_type, src_type>(dst, src);
    flare::fence("flare::deep_copy(DynamicView)");
  } else {
...
struct CommonSubview<flare::experimental::DynamicView<DP...>,
                     flare::experimental::DynamicView<SP...>, 1, Arg0> {
  using DstType          = flare::experimental::DynamicView<DP...>;
  using SrcType          = flare::experimental::DynamicView<SP...>;
...
struct CommonSubview<flare::experimental::DynamicView<DP...>, SrcType, 1,
                     Arg0> {
  using DstType          = flare::experimental::DynamicView<DP...>;
  using dst_subview_type = DstType;
...
struct CommonSubview<DstType, flare::experimental::DynamicView<SP...>, 1,
                     Arg0> {
  using SrcType          = flare::experimental::DynamicView<SP...>;
...
template <class... DP, class ViewTypeB, class Layout, class ExecSpace,
          typename iType>
struct ViewCopy<flare::experimental::DynamicView<DP...>, ViewTypeB, Layout,
                ExecSpace, 1, iType> {
  flare::experimental::DynamicView<DP...> a;
  ViewTypeB b;

  using policy_type = flare::RangePolicy<ExecSpace, flare::IndexType<iType>>;

  ViewCopy(const flare::experimental::DynamicView<DP...>& a_,
           const ViewTypeB& b_)
      : a(a_), b(b_) {
    flare::parallel_for("flare::ViewCopy-1D", policy_type(0, b.extent(0)),
                         *this);
  }
...
template <class... DP, class... SP, class Layout, class ExecSpace,
          typename iType>
struct ViewCopy<flare::experimental::DynamicView<DP...>,
                flare::experimental::DynamicView<SP...>, Layout, ExecSpace, 1,
                iType> {
  flare::experimental::DynamicView<DP...> a;
  flare::experimental::DynamicView<SP...> b;

  using policy_type = flare::RangePolicy<ExecSpace, flare::IndexType<iType>>;

  ViewCopy(const flare::experimental::DynamicView<DP...>& a_,
           const flare::experimental::DynamicView<SP...>& b_)
      : a(a_), b(b_) {
    const iType n = std::min(a.extent(0), b.extent(0));
    flare::parallel_for("flare::ViewCopy-1D", policy_type(0, n), *this);
  }
...
auto create_mirror_view_and_copy(
  ...
  using Mirror =
      typename detail::MirrorDynamicViewType<Space, T, P...>::view_type;
