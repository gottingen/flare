...
#ifndef FLARE_OFFSET_VIEW_H_
#define FLARE_OFFSET_VIEW_H_
...
FLARE_INLINE_FUNCTION bool offsetview_verify_operator_bounds(
...
FLARE_INLINE_FUNCTION void offsetview_verify_operator_bounds(
  ...
  if (!offsetview_verify_operator_bounds<0>(map, begins, args...)) {
    ...
    FLARE_IF_ON_DEVICE((
        ...
        } else { flare::abort("OffsetView bounds error"); }))
  }
}
...
inline void runtime_check_rank_host(const size_t rank_dynamic,
  ...
  bool isBad = false;
  std::string message =
      "flare::experimental::OffsetView ERROR: for OffsetView labeled '" +
      label + "':";
...
class OffsetView : public ViewTraits<DataType, Properties...> {
 ...
 private:
  ...
  using map_type   = flare::detail::ViewMapping<traits, void>;
 ...
 public:
  ...
  FLARE_FUNCTION
  const flare::detail::ViewMapping<traits, void>& implementation_map() const {
    return m_map;
  }
...
#define FLARE_IMPL_OFFSETVIEW_OPERATOR_VERIFY(ARG)                      \
  flare::detail::runtime_check_memory_access_violation<                   \
      typename traits::memory_space>(                                    \
      "flare::OffsetView ERROR: attempt to access inaccessible memory " \
      "space");                                                          \
  flare::experimental::detail::offsetview_verify_operator_bounds<         \
      typename traits::memory_space>                                     \
      ARG;
...
#define FLARE_IMPL_OFFSETVIEW_OPERATOR_VERIFY(ARG)                      \
 ...
 public:
  ...
  operator()(const I0& i0) const {
    FLARE_IMPL_OFFSETVIEW_OPERATOR_VERIFY((m_track, m_map, m_begins, i0))
  ...
  FLARE_FORCEINLINE_FUNCTION
    ...
    FLARE_IMPL_OFFSETVIEW_OPERATOR_VERIFY((m_track, m_map, m_begins, i0, i1))
    const size_t j0 = i0 - m_begins[0];
  ...
  FLARE_FORCEINLINE_FUNCTION
    ...
    FLARE_IMPL_OFFSETVIEW_OPERATOR_VERIFY(
...
#undef FLARE_IMPL_OFFSETVIEW_OPERATOR_VERIFY
 ...
 public:
  ...
  FLARE_FUNCTION OffsetView(const View<RT, RP...>& aview)
      : m_track(aview.impl_track()), m_map() {
    using SrcTraits = typename OffsetView<RT, RP...>::traits;
    using Mapping   = flare::detail::ViewMapping<traits, SrcTraits, void>;
  ...
  template <class RT, class... RP>
  FLARE_FUNCTION OffsetView(const OffsetView<RT, RP...>& rhs)
      : m_track(rhs.m_track, traits::is_managed),
        m_map(),
        m_begins(rhs.m_begins) {
    using SrcTraits = typename OffsetView<RT, RP...>::traits;
 ...
 private:
  ...
  static subtraction_failure runtime_check_begins_ends_host(const B& begins,
    ...
    if (!message.empty()) {
      message =
          "flare::experimental::OffsetView ERROR: for unmanaged OffsetView\n" +
          message;
  ...
  FLARE_FUNCTION static subtraction_failure runtime_check_begins_ends_device(
    ...
    if (begins.size() != Rank)
      flare::abort(
          "flare::experimental::OffsetView ERROR: for unmanaged "
  ...
  template <typename B, typename E>
  FLARE_FUNCTION OffsetView(const pointer_type& p, const B& begins_,
                             const E& ends_,
                             subtraction_failure)
      : m_track()  // no tracking
        ,
        m_map(flare::detail::ViewCtorProp<pointer_type>(p),
              typename traits::array_layout(
 ...
 public:
  ...
  template <class... P>
  explicit FLARE_FUNCTION OffsetView(
      const flare::detail::ViewCtorProp<P...>& arg_prop,
    ...
    static_assert(
        std::is_same<pointer_type, typename flare::detail::ViewCtorProp<
...

  {
    ...
    flare::detail::SharedAllocationRecord<>* record = m_map.allocate_shared(
        ...
        flare::detail::ViewCtorProp<P...>::has_execution_space);
...
FLARE_INLINE_FUNCTION constexpr unsigned rank(const OffsetView<D, P...>& V) {
  return V.Rank;
...
FLARE_INLINE_FUNCTION void map_arg_to_new_begin(
    const size_t i, flare::Array<int64_t, N>& subviewBegins,
...
FLARE_INLINE_FUNCTION
    typename flare::experimental::detail::GetOffsetViewTypeFromViewType<
        typename flare::detail::ViewMapping<void /* deduce subview type from
                                                   source view traits */
                                           ,
  ...
  constexpr size_t rank =
      flare::detail::ViewMapping<void /* deduce subview type from source view
                                        traits */
                                ,
                                ViewTraits<D, P...>, T>::type::rank;

  auto theSubview = flare::subview(theView, shiftedArg);

  flare::Array<int64_t, rank> subviewBegins;
  size_t counter = 0;
  flare::experimental::detail::map_arg_to_new_begin(0, subviewBegins, shiftedArg,
                                                   arg, begins, counter);

  typename flare::experimental::detail::GetOffsetViewTypeFromViewType<
      typename flare::detail::ViewMapping<void /* deduce subview type from source
                                                 view traits */
                                         ,
                                         ViewTraits<D, P...>, T>::type>::type
...
FLARE_INLINE_FUNCTION
    typename flare::experimental::detail::GetOffsetViewTypeFromViewType<
        typename flare::detail::ViewMapping<
            void /* deduce subview type from source view traits */
            ,
            ViewTraits<D, P...>, T0, T1>::type>::type
    subview_offset(const flare::experimental::OffsetView<D, P...>& src,
                   T0 arg0, T1 arg1) {
  auto theView = src.view();
  auto begins  = src.begins();
  ...
  auto theSubview = flare::subview(theView, shiftedArg0, shiftedArg1);
  constexpr size_t rank =
      flare::detail::ViewMapping<void /* deduce subview type from source view
                                        traits */
                                ,
...
FLARE_INLINE_FUNCTION
  ...
  auto theSubview =
      flare::subview(theView, shiftedArg0, shiftedArg1, shiftedArg2);
...
FLARE_INLINE_FUNCTION
  ...
  constexpr size_t rank = flare::detail::ViewMapping<
      void /* deduce subview type from source view traits */
      ,
...
FLARE_INLINE_FUNCTION
  ...
  return flare::experimental::detail::subview_offset(src, args...);
}
...
FLARE_INLINE_FUNCTION bool operator==(const OffsetView<LT, LP...>& lhs,
...
inline void deep_copy(
  ...
  auto dstView = dst.view();
  flare::deep_copy(dstView, value.view());
}
template <class DT, class... DP, class ST, class... SP>
inline void deep_copy(
    const experimental::OffsetView<DT, DP...>& dst,
...
inline void deep_copy(
  ...
  flare::deep_copy(dst, value.view());
}
...
struct MirrorOffsetViewType {
  ...
  using src_view_type = typename flare::experimental::OffsetView<T, P...>;
  ...
  using dest_view_type =
      flare::experimental::OffsetView<data_type, array_layout, Space>;
...
inline std::enable_if_t<
    ...
    typename flare::experimental::OffsetView<T, P...>::HostMirror>
create_mirror(const flare::experimental::OffsetView<T, P...>& src,
              const detail::ViewCtorProp<ViewCtorArgs...>& arg_prop) {
  return typename flare::experimental::OffsetView<T, P...>::HostMirror(
      flare::create_mirror(arg_prop, src.view()), src.begins());
}

template <class T, class... P, class... ViewCtorArgs,
          class = std::enable_if_t<
              detail::ViewCtorProp<ViewCtorArgs...>::has_memory_space>>
inline auto create_mirror(const flare::experimental::OffsetView<T, P...>& src,
                          const detail::ViewCtorProp<ViewCtorArgs...>& arg_prop) {
  using alloc_prop_input = detail::ViewCtorProp<ViewCtorArgs...>;
  using Space = typename detail::ViewCtorProp<ViewCtorArgs...>::memory_space;
  ...
  return typename flare::detail::MirrorOffsetType<Space, T, P...>::view_type(
...
inline auto create_mirror(
    const flare::experimental::OffsetView<T, P...>& src) {
  return detail::create_mirror(src, detail::ViewCtorProp<>{});
}
...
inline auto create_mirror(
    const Space&, const flare::experimental::OffsetView<T, P...>& src) {
  return detail::create_mirror(
      src, flare::view_alloc(typename Space::memory_space{}));
}

template <class Space, class T, class... P>
typename flare::detail::MirrorOffsetType<Space, T, P...>::view_type
...
inline std::enable_if_t<
    !detail::ViewCtorProp<ViewCtorArgs...>::has_memory_space &&
        (std::is_same<
             typename flare::experimental::OffsetView<T, P...>::memory_space,
             typename flare::experimental::OffsetView<
                 T, P...>::HostMirror::memory_space>::value &&
         std::is_same<
             typename flare::experimental::OffsetView<T, P...>::data_type,
             typename flare::experimental::OffsetView<
                 T, P...>::HostMirror::data_type>::value),
    typename flare::experimental::OffsetView<T, P...>::HostMirror>
create_mirror_view(const flare::experimental::OffsetView<T, P...>& src,
...
template <class T, class... P, class... ViewCtorArgs,
          class = std::enable_if_t<
              detail::ViewCtorProp<ViewCtorArgs...>::has_memory_space>>
std::enable_if_t<detail::MirrorOffsetViewType<
                     typename detail::ViewCtorProp<ViewCtorArgs...>::memory_space,
                     T, P...>::is_same_memspace,
                 typename detail::MirrorOffsetViewType<
                     typename detail::ViewCtorProp<ViewCtorArgs...>::memory_space,
                     T, P...>::view_type>
create_mirror_view(const flare::experimental::OffsetView<T, P...>& src,
                   const detail::ViewCtorProp<ViewCtorArgs...>&) {
...
inline auto create_mirror_view(
    const typename flare::experimental::OffsetView<T, P...>& src) {
  return detail::create_mirror_view(src, detail::ViewCtorProp<>{});
}
...
typename flare::detail::MirrorOffsetViewType<
...
template <class Space, class T, class... P>
typename flare::detail::MirrorOffsetViewType<Space, T, P...>::view_type
create_mirror_view_and_copy(
    const Space& space, const flare::experimental::OffsetView<T, P...>& src,
    std::string const& name = "") {
  return {create_mirror_view_and_copy(space, src.view(), name), src.begins()};
}
} /* namespace flare */

#endif  // FLARE_OFFSET_VIEW_H_
