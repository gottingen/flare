...
#ifndef FLARE_BACKEND_THREADS_THREADS_MDRANGE_POLICY_H_
#define FLARE_BACKEND_THREADS_THREADS_MDRANGE_POLICY_H_
...
#endif  // FLARE_BACKEND_THREADS_THREADS_MDRANGE_POLICY_H_
