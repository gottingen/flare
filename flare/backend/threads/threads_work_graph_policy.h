...
#ifndef FLARE_BACKEND_THREADS_THREADS_WORK_GRAPH_POLICY_H_
#define FLARE_BACKEND_THREADS_THREADS_WORK_GRAPH_POLICY_H_
...
class ParallelFor<FunctorType, flare::WorkGraphPolicy<Traits...>,
 ...
 private:
  ...
  using Self = ParallelFor<FunctorType, flare::WorkGraphPolicy<Traits...>,
                           flare::Threads>;
...
#endif  // FLARE_BACKEND_THREADS_THREADS_WORK_GRAPH_POLICY_H_
