...
#ifndef FLARE_BACKEND_OPENMP_OPENMP_TEAM_H_
#define FLARE_BACKEND_OPENMP_OPENMP_TEAM_H_
...
class TeamPolicyInternal<flare::OpenMP, Properties...>
 ...
 public:
  ...
  TeamPolicyInternal(
      const TeamPolicyInternal<flare::OpenMP, OtherProperties...>& p) {
 ...
 private:
  ...
  inline void init(const int league_size_request, const int team_size_request) {
    ...
    if (0 == team_size_grain) {
      flare::abort("flare::abort: Requested Team Size rounded up to 0!");
    }
 ...
 public:
  using member_type = detail::HostThreadTeamMember<flare::OpenMP>;
};
...
#endif
#endif  // FLARE_BACKEND_OPENMP_OPENMP_TEAM_H_
