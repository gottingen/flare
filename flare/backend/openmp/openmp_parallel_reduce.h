...
#ifndef FLARE_BACKEND_OPENMP_OPENMP_PARALLEL_REDUCE_H_
#define FLARE_BACKEND_OPENMP_OPENMP_PARALLEL_REDUCE_H_
...
class ParallelReduce<CombinedFunctorReducerType,
                     flare::MDRangePolicy<Traits...>, flare::OpenMP> {
 private:
...
class ParallelReduce<CombinedFunctorReducerType,
                     flare::TeamPolicy<Properties...>, flare::OpenMP> {
 private:
...
#endif  // FLARE_BACKEND_OPENMP_OPENMP_PARALLEL_REDUCE_H_
