...
#ifndef FLARE_BACKEND_CUDA_CUDA_BLOCK_SIZE_DEDUCTION_H_
#define FLARE_BACKEND_CUDA_CUDA_BLOCK_SIZE_DEDUCTION_H_
    ...
    int cuda_get_max_block_size(const CudaInternal *cuda_instance,
        ...
        auto const block_size_to_dynamic_shmem = [&f, vector_length, shmem_block,
            ...
            size_t const functor_shmem =
                    flare::detail::FunctorTeamShmemSize<FunctorType>::value(
...
#endif   // FLARE_BACKEND_CUDA_CUDA_BLOCK_SIZE_DEDUCTION_H_
