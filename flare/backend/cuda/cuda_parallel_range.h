...
#ifndef FLARE_BACKEND_CUDA_CUDA_PARALLEL_RANGE_H_
#define FLARE_BACKEND_CUDA_CUDA_PARALLEL_RANGE_H_
...
namespace flare::detail {
    ...
    class ParallelFor<FunctorType, flare::RangePolicy<Traits...>, flare::Cuda> {
    public:
    ...
    public:
        ...
        using word_size_type = std::conditional_t<
                sizeof(value_type) < sizeof(flare::Cuda::size_type),
                std::conditional_t<sizeof(value_type) == 2, int16_t, int8_t>,
                flare::Cuda::size_type>;
        ...
        // for tracking metadata in cuda_reduce_scan.h
                    ...
                    if (m_result_ptr) {
                        if (m_unified_space) {
                            m_policy.space().fence(
                                    "flare::detail::ParallelReduce<Cuda, RangePolicy>::execute: "
                                    "Result "
    ...
    template<class FunctorType, class... Traits>
    class ParallelScan<FunctorType, flare::RangePolicy<Traits...>, flare::Cuda> {
    public:
        using Policy = flare::RangePolicy<Traits...>;
    ...
    private:
        ...
        using Analysis = flare::detail::FunctorAnalysis<FunctorPatternInterface::SCAN,
...
//----------------------------------------------------------------------------
    ...
    private:
        ...
        using Analysis =
                flare::detail::FunctorAnalysis<FunctorPatternInterface::SCAN, Policy,
    ...
    public:
        ...
        inline void execute() {
            ...
            if (nwork) {
                enum {
                    GridMaxComputeCapability_2x = 0x0ffff
                };
...
#endif
#endif  // FLARE_BACKEND_CUDA_CUDA_PARALLEL_RANGE_H_
