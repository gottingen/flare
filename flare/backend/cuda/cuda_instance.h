...
#ifndef FLARE_BACKEND_CUDA_CUDA_INSTANCE_H_
#define FLARE_BACKEND_CUDA_CUDA_INSTANCE_H_
...
extern "C" void flare_impl_cuda_set_serial_execution(bool);
extern "C" bool flare_impl_cuda_use_serial_execution();
#endif
...
namespace flare::detail {
    ...
    struct CudaTraits {
        ...
        FLARE_INLINE_FUNCTION static CudaSpace::size_type warp_count(
                CudaSpace::size_type i) {
            return (i + WarpIndexMask) >> WarpIndexShift;
        }

        FLARE_INLINE_FUNCTION static CudaSpace::size_type warp_align(
                CudaSpace::size_type i) {
...
#ifdef FLARE_IMPL_DEBUG_CUDA_SERIAL_EXECUTION
        static bool flare_impl_cuda_use_serial_execution_v;
#endif
    ...
    public:
        ...
        CudaInternal()
                : m_scratchSpaceCount(0),
                  ...
                  m_stream(nullptr),
                  m_instance_id(
                          flare::Tools::experimental::detail::idForInstance<flare::Cuda>(
        ...
        void set_cuda_device() const {
            ...
            FLARE_IMPL_CUDA_SAFE_CALL(cudaSetDevice(m_cudaDev));
        }
...
#if (defined(FLARE_ENABLE_IMPL_CUDA_MALLOC_ASYNC) && CUDART_VERSION >= 11020)
...
namespace flare::experimental {
    ...
    std::vector<Cuda> partition_space(const Cuda &, Args...) {
        ...
        flare::detail::create_Cuda_instances(instances);
        return instances;
    }
...
#endif  // FLARE_BACKEND_CUDA_CUDA_INSTANCE_H_
