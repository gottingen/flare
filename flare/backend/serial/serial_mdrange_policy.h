...
#ifndef FLARE_BACKEND_SERIAL_SERIAL_MDRANGEPOLICY_H_
#define FLARE_BACKEND_SERIAL_SERIAL_MDRANGEPOLICY_H_
...
#endif  // FLARE_BACKEND_SERIAL_SERIAL_MDRANGEPOLICY_H_
