...
namespace flare::detail {
    ...
    class ParallelReduce<CombinedFunctorReducerType, flare::TeamPolicy<Properties...>, flare::Serial> {
    private:
        ...
        template<class TagType>
        inline std::enable_if_t<std::is_void<TagType>::value>
