...
from flare import backend, safe_call
from flare.algorithm import count
from flare.array import _get_indices, _in_display_dims_limit

from .device import PointerSource
from .dtypes import CShape, Dtype
from .dtypes import bool as fly_bool
from .dtypes import c_dim_t
from .dtypes import complex64 as fly_complex64
from .dtypes import complex128 as fly_complex128
from .dtypes import float32 as fly_float32
from .dtypes import float64 as fly_float64
from .dtypes import int64 as fly_int64
from .dtypes import supported_dtypes
from .dtypes import uint64 as fly_uint64
...
class Array:
    def __init__(
        ...
        if x is None:
            if not shape:  # shape is None or empty tuple
                safe_call(backend.get().fly_create_handle(
        ...
        if isinstance(x, Array):
            safe_call(backend.get().fly_retain_array(ctypes.pointer(self.arr), x.arr))
            return
        ...
        if not (offset or strides):
            if pointer_source == PointerSource.host:
                safe_call(backend.get().fly_create_array(
            ...
            safe_call(backend.get().fly_device_array(
                ctypes.pointer(self.arr), ctypes.c_void_p(_array_buffer.address), _cshape.original_shape,
                ctypes.pointer(_cshape.c_array), dtype.c_api_value))
            return
        ...
        safe_call(backend.get().fly_create_strided_array(
    ...
    def __add__(self, other: Union[int, float, Array], /) -> Array:
        ...
        """
        return _process_c_function(self, other, backend.get().fly_add)
    ...
    def __sub__(self, other: Union[int, float, Array], /) -> Array:
        ...
        out : Array
            ...
            by Type Promotion Rules.
        """
        return _process_c_function(self, other, backend.get().fly_sub)
    ...
    def __mul__(self, other: Union[int, float, Array], /) -> Array:
        ...
        out : Array
            ...
            by Type Promotion Rules.
        """
        return _process_c_function(self, other, backend.get().fly_mul)
    ...
    def __truediv__(self, other: Union[int, float, Array], /) -> Array:
        ...
        """
        return _process_c_function(self, other, backend.get().fly_div)
    ...
    def __mod__(self, other: Union[int, float, Array], /) -> Array:
        ...
        """
        return _process_c_function(self, other, backend.get().fly_mod)
    ...
    def __pow__(self, other: Union[int, float, Array], /) -> Array:
        ...
        out : Array
            ...
            by Type Promotion Rules.
        """
        return _process_c_function(self, other, backend.get().fly_pow)
    ...
    def __invert__(self) -> Array:
        ...
        """
        out = Array()
        safe_call(backend.get().fly_bitnot(ctypes.pointer(out.arr), self.arr))
        return out
    ...
    def __and__(self, other: Union[int, bool, Array], /) -> Array:
        ...
        out : Array
            ...
            by Type Promotion Rules.
        """
        return _process_c_function(self, other, backend.get().fly_bitand)
    ...
    def __or__(self, other: Union[int, bool, Array], /) -> Array:
        ...
        out : Array
            ...
            by Type Promotion Rules.
        """
        return _process_c_function(self, other, backend.get().fly_bitor)
    ...
    def __xor__(self, other: Union[int, bool, Array], /) -> Array:
        ...
        out : Array
            ...
            by Type Promotion Rules.
        """
        return _process_c_function(self, other, backend.get().fly_bitxor)
    ...
    def __lshift__(self, other: Union[int, Array], /) -> Array:
        ...
        out : Array
            An array containing the element-wise results. The returned array must have the same data type as self.
        """
        return _process_c_function(self, other, backend.get().fly_bitshiftl)
    ...
    def __rshift__(self, other: Union[int, Array], /) -> Array:
        ...
        out : Array
            An array containing the element-wise results. The returned array must have the same data type as self.
        """
        return _process_c_function(self, other, backend.get().fly_bitshiftr)
    ...
    def __lt__(self, other: Union[int, float, Array], /) -> Array:
        ...
        """
        return _process_c_function(self, other, backend.get().fly_lt)
    ...
    def __le__(self, other: Union[int, float, Array], /) -> Array:
        ...
        out : Array
            An array containing the element-wise results. The returned array must have a data type of bool.
        """
        return _process_c_function(self, other, backend.get().fly_le)
    ...
    def __gt__(self, other: Union[int, float, Array], /) -> Array:
        ...
        out : Array
            An array containing the element-wise results. The returned array must have a data type of bool.
        """
        return _process_c_function(self, other, backend.get().fly_gt)
    ...
    def __ge__(self, other: Union[int, float, Array], /) -> Array:
        ...
        out : Array
            An array containing the element-wise results. The returned array must have a data type of bool.
        """
        return _process_c_function(self, other, backend.get().fly_ge)
    ...
    def __eq__(self, other: Union[int, float, bool, Array], /) -> Array:  # type: ignore[override]  # FIXME
        ...
        out : Array
            An array containing the element-wise results. The returned array must have a data type of bool.
        """
        return _process_c_function(self, other, backend.get().fly_eq)
    ...
    def __ne__(self, other: Union[int, float, bool, Array], /) -> Array:  # type: ignore[override]  # FIXME
        ...
        out : Array
            An array containing the element-wise results. The returned array must have a data type of bool.
        """
        return _process_c_function(self, other, backend.get().fly_neq)
    ...
    def __radd__(self, other: Array, /) -> Array:
        ...
        Return other + self.
        """
        return _process_c_function(other, self, backend.get().fly_add)

    def __rsub__(self, other: Array, /) -> Array:
        """
        Return other - self.
        """
        return _process_c_function(other, self, backend.get().fly_sub)

    def __rmul__(self, other: Array, /) -> Array:
        """
        Return other * self.
        """
        return _process_c_function(other, self, backend.get().fly_mul)

    def __rtruediv__(self, other: Array, /) -> Array:
        """
        Return other / self.
        """
        return _process_c_function(other, self, backend.get().fly_div)
    ...
    def __rmod__(self, other: Array, /) -> Array:
        ...
        Return other % self.
        """
        return _process_c_function(other, self, backend.get().fly_mod)

    def __rpow__(self, other: Array, /) -> Array:
        """
        Return other ** self.
        """
        return _process_c_function(other, self, backend.get().fly_pow)
    ...
    def __rand__(self, other: Array, /) -> Array:
        ...
        Return other & self.
        """
        return _process_c_function(other, self, backend.get().fly_bitand)

    def __ror__(self, other: Array, /) -> Array:
        """
        Return other | self.
        """
        return _process_c_function(other, self, backend.get().fly_bitor)

    def __rxor__(self, other: Array, /) -> Array:
        """
        Return other ^ self.
        """
        return _process_c_function(other, self, backend.get().fly_bitxor)

    def __rlshift__(self, other: Array, /) -> Array:
        """
        Return other << self.
        """
        return _process_c_function(other, self, backend.get().fly_bitshiftl)

    def __rrshift__(self, other: Array, /) -> Array:
        """
        Return other >> self.
        """
        return _process_c_function(other, self, backend.get().fly_bitshiftr)
    ...
    def __getitem__(self, key: Union[int, slice, Tuple[Union[int, slice, ], ...], Array], /) -> Array:
        ...
        if isinstance(key, Array) and key == fly_bool.c_api_value:
            ndims = 1
            if count(key) == 0:
                return out

        safe_call(backend.get().fly_index_gen(
    ...
    def dtype(self) -> Dtype:
        ...
        """
        out = ctypes.c_int()
        safe_call(backend.get().fly_get_type(ctypes.pointer(out), self.arr))
    ...
    def T(self) -> Array:
        ...
        out = Array()
        safe_call(backend.get().fly_transpose(ctypes.pointer(out.arr), self.arr, False))
        return out
    ...
    def size(self) -> int:
        ...
        out = c_dim_t(0)
        safe_call(backend.get().fly_get_elements(ctypes.pointer(out), self.arr))
        return out.value
    ...
    def ndim(self) -> int:
        ...
        """
        out = ctypes.c_uint(0)
        safe_call(backend.get().fly_get_numdims(ctypes.pointer(out), self.arr))
        return out.value
    ...
    def shape(self) -> ShapeType:
        ...
        d2 = c_dim_t(0)
        d3 = c_dim_t(0)
        safe_call(backend.get().fly_get_dims(
    ...
    def scalar(self) -> Union[None, int, float, bool, complex]:
        ...
        safe_call(backend.get().fly_get_scalar(ctypes.pointer(out), self.arr))
    ...
    def is_empty(self) -> bool:
        ...
        # NOTE not a part of the array-api spec
        out = ctypes.c_bool()
        safe_call(backend.get().fly_is_empty(ctypes.pointer(out), self.arr))
        return out.value
...
def _get_ctypes_array(array: Array) -> ctypes.Array:
    ...
    safe_call(backend.get().fly_get_data_ptr(ctypes.pointer(ctypes_array), array.arr))
    return ctypes_array
...
def _reorder(array: Array) -> Array:
    ...
    safe_call(backend.get().fly_reorder(ctypes.pointer(out.arr), array.arr, *c_shape))
    return out
...
def _array_as_str(array: Array) -> str:
    ...
    safe_call(backend.get().fly_array_to_string(ctypes.pointer(arr_str), "", array.arr, 4, True))
    py_str = _to_str(arr_str)
    safe_call(backend.get().fly_free_host(arr_str))
    return py_str
...
def _implicit_dtype(value: Union[int, float], array_dtype: Dtype) -> Dtype:
    if isinstance(value, bool):
        value_dtype = fly_bool
    if isinstance(value, int):
        value_dtype = fly_int64
    elif isinstance(value, float):
        value_dtype = fly_float64
    ...
    if value_dtype == fly_float64:
        return fly_float32

    if value_dtype == fly_complex128:
        return fly_complex64
...
def _constant_array(value: Union[int, float], shape: CShape, dtype: Dtype) -> Array:
    ...
    if isinstance(value, complex):
        if dtype != fly_complex64 and dtype != fly_complex128:
            dtype = fly_complex64

        safe_call(backend.get().fly_constant_complex(
