...
def _arith_binary_func(lhs, rhs, c_func):
    ...
    if not (is_left_array or is_right_array):
        raise TypeError("Atleast one input needs to be of type flare.array")
...
def cast(a, dtype):
    ...
    """
    out=Array()
    safe_call(backend.get().fly_cast(c_pointer(out.arr), a.arr, dtype.value))
    return out
...
def clamp(val, low, high):
    ...
    safe_call(backend.get().fly_clamp(c_pointer(out.arr), val.arr, low_arr, high_arr, _bcast_var.get()))
...
def sin(a):
    ...
    """
    return _arith_unary_func(a, backend.get().fly_sin)
...
def cos(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_cos)
...
def tan(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_tan)
...
def asin(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_asin)
...
def acos(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_acos)
...
def atan(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_atan)
...
def cplx(lhs, rhs=None):
    ...
    if rhs is None:
        ...
        return _arith_binary_func(lhs, rhs, backend.get().fly_cplx2)
...
def real(a):
    ...
    """
    return _arith_unary_func(a, backend.get().fly_real)
...
def sinh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_sinh)
...
def cosh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_cosh)
...
def tanh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_tanh)
...
def asinh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_asinh)
...
def acosh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_acosh)
...
def atanh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_atanh)
...
def pow2(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_pow2)
...
def sigmoid(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_sigmoid)
...
def exp(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_exp)
...
def expm1(a):
    ...
    """
    return _arith_unary_func(a, backend.get().fly_expm1)
...
def erf(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_erf)
...
def erfc(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_erfc)
...
def log(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_log)
...
def log1p(a):
    ...
    - This function provides a more stable result for small values of `a`.
    """
    return _arith_unary_func(a, backend.get().fly_log1p)
...
def log10(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_log10)
...
def log2(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_log2)
...
def sqrt(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_sqrt)
...
def rsqrt(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_rsqrt)
...
def cbrt(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_cbrt)
...
def factorial(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_factorial)
...
def tgamma(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_tgamma)
...
def lgamma(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_lgamma)
...
def iszero(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_iszero)
...
def isinf(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_isinf)
...
def isnan(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().fly_isnan)
