...
/**
   ...
   \param[in]  method is the interpolation method to be used. The following types (defined in enum \ref fly_interp_type) are supported: nearest neighbor, linear, and cubic.
 ...
 */
FLY_API array approx1(const array &in, const array &pos,
...
/**
   ...
   \param[in]  method is the interpolation method to be used. All interpolation types defined in \ref fly_interp_type are supported.
   \param[in]  off_grid is the default value for any indices outside the valid range of indices.
   \returns    the interpolated array.
 ...
 */
FLY_API array approx2(const array &in, const array &pos0, const array &pos1,
                    const interpType method = FLY_INTERP_LINEAR, const float off_grid = 0.0f);
...
/**
   ...
   \ingroup signal_func_approx1
 */
FLY_API array approx1(const array &in,
...
/**
   ...
   \ingroup signal_func_approx2
 */
FLY_API array approx2(const array &in,
 ...
 */
FLY_API array fftNorm(const array& in, const double norm_factor, const dim_t odim0=0);
 ...
 */
FLY_API array fft2Norm(const array& in, const double norm_factor, const dim_t odim0=0, const dim_t odim1=0);
...
/**
   ...
   \ingroup signal_func_fft
 */
FLY_API array fft(const array& in, const dim_t odim0=0);
...
/**
   ...
   \ingroup signal_func_fft2
 */
FLY_API array fft2(const array& in, const dim_t odim0=0, const dim_t odim1=0);
...
/**
   ...
   \ingroup signal_func_fft3
 */
FLY_API array fft3(const array& in, const dim_t odim0=0, const dim_t odim1=0, const dim_t odim2=0);
...
/**
   ...
   \ingroup signal_func_fft
 */
FLY_API array dft(const array& in, const double norm_factor, const dim4 outDims);
...
/**
   ...
   \ingroup signal_func_fft
 */
FLY_API array dft(const array& in, const dim4 outDims);
...
/**
   ...
   \ingroup signal_func_fft
 */
FLY_API array dft(const array& in);
 ...
 */
FLY_API array ifftNorm(const array& in, const double norm_factor, const dim_t odim0=0);
 ...
 */
FLY_API array ifft2Norm(const array& in, const double norm_factor, const dim_t odim0=0, const dim_t odim1=0);
...
/**
   ...
   \ingroup signal_func_ifft
 */
FLY_API array ifft(const array& in, const dim_t odim0=0);
...
/**
   ...
   \ingroup signal_func_ifft2
 */
FLY_API array ifft2(const array& in, const dim_t odim0=0, const dim_t odim1=0);
...
/**
   ...
   \ingroup signal_func_ifft3
 */
FLY_API array ifft3(const array& in, const dim_t odim0=0, const dim_t odim1=0, const dim_t odim2=0);
...
/**
   ...
   \ingroup signal_func_fft
 */
FLY_API array idft(const array& in, const double norm_factor, const dim4 outDims);
...
/**
   ...
   \ingroup signal_func_fft
 */
FLY_API array idft(const array& in, const dim4 outDims);
...
/**
   ...
   \note The default parameter of \p domain, \ref FLY_CONV_AUTO, heuristically switches between frequency and spatial domain.

   \ingroup signal_func_convolve
 */
FLY_API array convolve(const array& signal, const array& filter, const convMode mode=FLY_CONV_DEFAULT, const convDomain domain=FLY_CONV_AUTO);
 ...
 */
FLY_API array convolve(const array& col_filter, const array& row_filter, const array& signal, const convMode mode=FLY_CONV_DEFAULT);
 ...
 */
FLY_API array convolve1(const array& signal, const array& filter, const convMode mode=FLY_CONV_DEFAULT, const convDomain domain=FLY_CONV_AUTO);
 ...
 */
FLY_API array convolve2(const array& signal, const array& filter, const convMode mode=FLY_CONV_DEFAULT, const convDomain domain=FLY_CONV_AUTO);
...
/**
   ...
   \ingroup signal_func_convolve2
 */
FLY_API array convolve2NN(const array& signal, const array& filter,
 ...
 */
FLY_API array convolve3(const array& signal, const array& filter, const convMode mode=FLY_CONV_DEFAULT, const convDomain domain=FLY_CONV_AUTO);
...
/**
   ...
   \ingroup signal_func_convolve
 */
FLY_API array fftConvolve(const array& signal, const array& filter, const convMode mode=FLY_CONV_DEFAULT);
...
/**
   ...
   \ingroup signal_func_convolve1
 */
FLY_API array fftConvolve1(const array& signal, const array& filter, const convMode mode=FLY_CONV_DEFAULT);
...
/**
   ...
   \ingroup signal_func_convolve2
 */
FLY_API array fftConvolve2(const array& signal, const array& filter, const convMode mode=FLY_CONV_DEFAULT);
...
/**
   ...
   \ingroup signal_func_convolve3
 */
FLY_API array fftConvolve3(const array& signal, const array& filter, const convMode mode=FLY_CONV_DEFAULT);
...
*/
FLY_API array fir(const array &b, const array &x);
...
*/
FLY_API array iir(const array &b, const array &a, const array &x);
...
/**
   ...
   \param[in]  method   is the interpolation method to be used. The following
                        types (defined in enum \ref fly_interp_type)
   ...
   \return \ref FLY_SUCCESS if the interpolation operation is successful,
...
/**
   ...
   \param[in]  method   is the interpolation method to be used. All
                        interpolation types defined in \ref fly_interp_type are
                        supported.
   ...
   \ingroup signal_func_approx2
 */
FLY_API fly_err fly_approx2(fly_array *out, const fly_array in,
...
/**
   ...
   \param[in]     pos1     positions of the interpolation points along the
                           second dimension.
   \param[in]     method   is the interpolation method to be used. All
                           interpolation types defined in \ref fly_interp_type
                           are supported.
   \param[in]     off_grid is the default value for any indices outside the
                           valid range of indices.
   ...
   \note \p out can either be a null or existing `fly_array` object. If it is a
         sub-array of an existing `fly_array`, only the corresponding portion of
         the `fly_array` will be overwritten
   \note Passing an `fly_array` to \p out that has not been initialized will
         cause undefined behavior.
...
/**
   ...
   fly_approx1_uniform() accepts the dimension to perform the interpolation along
   ...
   \param[in]  method     is the interpolation method to be used. The
                          ...
                          \ref fly_interp_type) are supported: nearest
   ...
   \ingroup signal_func_approx1
 */
FLY_API fly_err fly_approx1_uniform(fly_array *out, const fly_array in,
                                const fly_array pos, const int interp_dim,
                                const double idx_start, const double idx_step,
                                const fly_interp_type method,
                                const float off_grid);

/**
   C Interface for the version of \ref fly_approx1_uniform that accepts a
   ...
   \ingroup signal_func_approx1
 */
FLY_API fly_err fly_approx1_uniform_v2(fly_array *out, const fly_array in,
                                   const fly_array pos, const int interp_dim,
...
/**
   ...
   fly_approx2_uniform() accepts two dimensions to perform the interpolation
   ...
   \ingroup signal_func_approx2
 */
FLY_API fly_err fly_approx2_uniform(fly_array *out, const fly_array in,
                                const fly_array pos0, const int interp_dim0,
                                const double idx_start_dim0,
                                const double idx_step_dim0,
                                const fly_array pos1, const int interp_dim1,
...
/**
   C Interface for the version of \ref fly_approx2_uniform that accepts a
   preallocated output array
   ...
   \param[in]     method         is the interpolation method to be used. All
                                 ...
                                 \ref fly_interp_type are supported.
   ...
   \ingroup signal_func_approx2
 */
FLY_API fly_err fly_approx2_uniform_v2(fly_array *out, const fly_array in,
                                   const fly_array pos0, const int interp_dim0,
                                   const double idx_start_dim0,
                                   const double idx_step_dim0,
                                   const fly_array pos1, const int interp_dim1,
...
/**
   ...
   \param[in]  norm_factor is the normalization factor with which the input is scaled after the transformation is applied
   \param[in]  odim0 is the length of output signals - used to either truncate or pad the input signals
   \return     \ref FLY_SUCCESS if the fft transform is successful,
               otherwise an appropriate error code is returned.
...
/**
   ...
   \param[in]  norm_factor is the normalization factor with which the input is scaled after the transformation is applied
   \return     \ref FLY_SUCCESS if the ifft transform is successful,
               otherwise an appropriate error code is returned.
...
/**
   ...
   \param[in]  mode indicates if the convolution should be expanded or not(where output size equals input)
   \param[in]  domain specifies if the convolution should be performed in frequency os spatial domain
   \return     \ref FLY_SUCCESS if the convolution is successful,
               otherwise an appropriate error code is returned.
   ...
   \ingroup signal_func_convolve1
 */
FLY_API fly_err fly_convolve1(fly_array *out, const fly_array signal, const fly_array filter, const fly_conv_mode mode, fly_conv_domain domain);
...
/**
   ...
   \ingroup signal_func_convolve2
 */
FLY_API fly_err fly_convolve2(fly_array *out, const fly_array signal, const fly_array filter, const fly_conv_mode mode, fly_conv_domain domain);
...
/**
   ...
   \ingroup signal_func_convolve2
 */
FLY_API fly_err fly_convolve2_nn(fly_array *out, const fly_array signal, const fly_array filter,
...
/**
   ...
   \ingroup signal_func_convolve3
 */
FLY_API fly_err fly_convolve3(fly_array *out, const fly_array signal, const fly_array filter, const fly_conv_mode mode, fly_conv_domain domain);
...
/**
   ...
   \ingroup signal_func_convolve_sep
 */
FLY_API fly_err fly_convolve2_sep(fly_array *out, const fly_array col_filter, const fly_array row_filter, const fly_array signal, const fly_conv_mode mode);
...
/**
   ...
   \ingroup signal_func_convolve1
 */
FLY_API fly_err fly_fft_convolve1(fly_array *out, const fly_array signal, const fly_array filter, const fly_conv_mode mode);
...
/**
   ...
   \ingroup signal_func_convolve2
 */
FLY_API fly_err fly_fft_convolve2(fly_array *out, const fly_array signal, const fly_array filter, const fly_conv_mode mode);
...
/**
   ...
   \ingroup signal_func_convolve3
 */
FLY_API fly_err fly_fft_convolve3(fly_array *out, const fly_array signal, const fly_array filter, const fly_conv_mode mode);
...
/**
   ...
   \ingroup signal_func_fir
*/
FLY_API fly_err fly_fir(fly_array *y, const fly_array b, const fly_array x);
...
/**
   ...
   \ingroup signal_func_iir
*/
FLY_API fly_err fly_iir(fly_array *y, const fly_array b, const fly_array a, const fly_array x);
    ...
    /**
        ...
        \param[in]  edge_pad value will decide what happens to border when running
                    filter in their neighborhood. It takes one of the values [\ref FLY_PAD_ZERO | \ref FLY_PAD_SYM]
        \return     \ref FLY_SUCCESS if the median filter is applied successfully,
        otherwise an appropriate error code is returned.
