...
namespace fly
{
    ...
    */
    ...
    ///             Otherwise the functionallity is identical to fly::alloc.
    ...
    ///       previously locked.
    /// \deprecated Use fly::freeV2 instead. fly_alloc_device_v2 returns a
    ...
    */
    ...
    /**
       ...
       \returns FLY_SUCCESS if a pointer could be allocated. FLY_ERR_NO_MEM if
                there is no memory
       \deprecated Use fly_alloc_device_v2 instead. fly_alloc_device_v2 returns a
                   cl_mem object instead of the cl::Buffer object for the OpenCL
                   backend. Otherwise the functionallity is identical
    */
    FLY_DEPRECATED("Use fly_alloc_device_v2 instead")
    ...
    /**
       ...
       \deprecated Use fly_free_device_v2 instead. The new function handles the
                   new behavior of the fly_alloc_device_v2 function.
       \ingroup device_func_free
    */
    ...
    /**
       ...
       \ingroup device_func_alloc
    */
    FLY_API fly_err fly_alloc_device_v2(void **ptr, const dim_t bytes);
    ...
    /**
       ...
       \param[in] ptr The pointer allocated by fly_alloc_device_v2 to be freed
       \note this function will not work for pointers allocated using the
             fly_alloc_device function for all backends
       \ingroup device_func_free
    */
